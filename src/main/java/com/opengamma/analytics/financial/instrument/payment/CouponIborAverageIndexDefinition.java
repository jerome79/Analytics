...
public class CouponIborAverageIndexDefinition extends CouponFloatingDefinition {
  ...
  public CouponIborAverageIndexDefinition(final Currency currency, final ZonedDateTime paymentDate, final ZonedDateTime accrualStartDate, final ZonedDateTime accrualEndDate,
    ...
    ArgChecker.isTrue(currency.equals(index1.getCurrency()), "index1 currency different from payment currency");
    ArgChecker.isTrue(currency.equals(index2.getCurrency()), "index2 currency different from payment currency");
    _index1 = index1;
    _index2 = index2;
    _weight1 = weight1;
    _weight2 = weight2;
  ...
  public static CouponIborAverageIndexDefinition from(final CouponDefinition coupon, final ZonedDateTime fixingDate, final IborIndex index1, final IborIndex index2,
    ...
    ArgChecker.notNull(index1, "index1");
    ArgChecker.notNull(index2, "index1");
    ArgChecker.isTrue(index1.getCurrency().equals(index2.getCurrency()), "index1 currency different from index2 currency");
  ...
  public Coupon toDerivative(final ZonedDateTime dateTime) {
    ...
    ArgChecker.isTrue(!dayConversion.isAfter(getFixingDate().toLocalDate()), "Do not have any fixing data but are asking for a derivative at " + dateTime
