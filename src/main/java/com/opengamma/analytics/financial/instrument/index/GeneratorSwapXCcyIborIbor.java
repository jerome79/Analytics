...
public class GeneratorSwapXCcyIborIbor extends GeneratorInstrument<GeneratorAttributeFX> {
   ...
   */
  public GeneratorSwapXCcyIborIbor(final String name, final IborIndex iborIndex1, final IborIndex iborIndex2, final HolidayCalendar calendar1, final HolidayCalendar calendar2) {
    super(name);
    ArgChecker.notNull(iborIndex1, "ibor index");
    ArgChecker.notNull(iborIndex2, "ibor index");
    ArgChecker.notNull(calendar1, "calendar1");
    ArgChecker.notNull(calendar2, "calendar2");
  ...
  public SwapXCcyIborIborDefinition generateInstrument(final ZonedDateTime date, final double spread, final double notional, final GeneratorAttributeFX attribute) {
    ...
    final double fx = attribute.getFxMatrix().fxRate(_iborIndex1.getCurrency(), _iborIndex2.getCurrency());
  ...
  public boolean equals(final Object obj) {
    ...
    if (!Objects.equals(_iborIndex2, other._iborIndex2)) {
      return false;
    }
    if (!Objects.equals(_iborIndex1, other._iborIndex1)) {
      return false;
    }
    if (_spotLag != other._spotLag) {
      return false;
    }
    if (!Objects.equals(_calendar1, other._calendar1)) {
      return false;
    }
    if (!Objects.equals(_calendar2, other._calendar2)) {
      return false;
    }
    return true;
  }
