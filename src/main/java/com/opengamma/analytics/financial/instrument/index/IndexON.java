...
public class IndexON extends IndexDeposit {
  ...
  public IndexON(final String name, final Currency currency, final DayCount dayCount, final int publicationLag) {
    super(name, currency);
    ArgChecker.notNull(dayCount, "OIS index: day count");
    ArgChecker.isTrue(publicationLag == 0 || publicationLag == 1, "Attempted to construct an IndexON with publicationLag other than 0 or 1");
