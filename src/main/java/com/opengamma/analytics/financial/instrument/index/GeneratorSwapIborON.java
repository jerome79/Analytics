...
public class GeneratorSwapIborON extends GeneratorInstrument<GeneratorAttributeIR> {
  ...
  public GeneratorSwapIborON(final String name, final IborIndex indexIbor, final IndexON indexON, final BusinessDayConvention businessDayConvention,
    ...
    ArgChecker.notNull(iborCalendar, "ibor calendar");
    ArgChecker.notNull(overnightCalendar, "overnight calendar");
  ...
  public boolean equals(final Object obj) {
    ...
    if (!Objects.equals(_indexIbor, other._indexIbor)) {
      return false;
    }
    if (!Objects.equals(_indexON, other._indexON)) {
      return false;
    }
    ...
    if (!Objects.equals(_iborCalendar, other._iborCalendar)) {
      return false;
    }
    if (!Objects.equals(_overnightCalendar, other._overnightCalendar)) {
      return false;
    }
    return true;
  }
