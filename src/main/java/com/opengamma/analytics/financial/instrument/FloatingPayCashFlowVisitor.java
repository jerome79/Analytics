 ...
 */
public final class FloatingPayCashFlowVisitor extends InstrumentDefinitionVisitorAdapter<Object, Map<LocalDate, MultiCurrencyAmount>> {
  ...
  public Map<LocalDate, MultiCurrencyAmount> visitForwardRateAgreementDefinition(final ForwardRateAgreementDefinition forwardRateAgreement) {
    ...
    return Collections.singletonMap(endDate, MultiCurrencyAmount.of(CurrencyAmount.of(forwardRateAgreement.getCurrency(), amount)));
  }
