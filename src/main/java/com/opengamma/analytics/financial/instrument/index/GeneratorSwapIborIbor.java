...
public class GeneratorSwapIborIbor extends GeneratorInstrument<GeneratorAttributeIR> {
  ...
  public GeneratorSwapIborIbor(final String name, final IborIndex iborIndex1, final IborIndex iborIndex2, final HolidayCalendar calendar1, final HolidayCalendar calendar2) {
    ...
    ArgChecker.notNull(calendar1, "calendar 1");
    ArgChecker.notNull(calendar2, "calendar 2");
    ArgChecker.isTrue(iborIndex1.getCurrency().equals(iborIndex2.getCurrency()), "Currencies of both index should be identical");
