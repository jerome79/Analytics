...
public class GeneratorSwapSingleCurrency extends GeneratorInstrument<GeneratorAttributeIR> {
  ...
  public GeneratorSwapSingleCurrency(String name, GeneratorLeg leg1, GeneratorLeg leg2) {
    super(name);
    ArgChecker.notNull(leg1, "first leg");
    ArgChecker.notNull(leg2, "second leg");
    ArgChecker.isTrue(leg1.getCurrency().equals(leg2.getCurrency()), "Both legs should be in the same currency");
    _leg1 = leg1;
    _leg2 = leg2;
  }
