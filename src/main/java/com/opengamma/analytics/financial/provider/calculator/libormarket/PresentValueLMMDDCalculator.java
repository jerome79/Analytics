 ...
 */
public final class PresentValueLMMDDCalculator extends InstrumentDerivativeVisitorAdapter<LiborMarketModelDisplacedDiffusionProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitSwaptionPhysicalFixedIbor(final SwaptionPhysicalFixedIbor swaption, final LiborMarketModelDisplacedDiffusionProviderInterface lmm) {
