 ...
 */
public final class PresentValueIssuerCalculator extends InstrumentDerivativeVisitorDelegate<ParameterIssuerProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitDepositCounterpart(final DepositCounterpart deposit, final ParameterIssuerProviderInterface issuercurves) {
  ...
  @Override
  public MultiCurrencyAmount visitBillSecurity(final BillSecurity bill, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BILL_SEC.presentValue(bill, issuercurves.getIssuerProvider());
  }

  @Override
  public MultiCurrencyAmount visitBillTransaction(final BillTransaction bill, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BILL_TR.presentValue(bill, issuercurves.getIssuerProvider());
  }

  @Override
  public MultiCurrencyAmount visitBondFixedSecurity(final BondFixedSecurity bond, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BOND_SEC.presentValue(bond, issuercurves.getIssuerProvider());
  }

  @Override
  public MultiCurrencyAmount visitBondIborSecurity(final BondIborSecurity bond, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BOND_SEC.presentValue(bond, issuercurves.getIssuerProvider());
  }

  @Override
  public MultiCurrencyAmount visitBondFixedTransaction(final BondFixedTransaction bond, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BOND_TR.presentValue(bond, issuercurves.getIssuerProvider());
  }

  @Override
  public MultiCurrencyAmount visitBondIborTransaction(final BondIborTransaction bond, final ParameterIssuerProviderInterface issuercurves) {
    return METHOD_BOND_TR.presentValue(bond, issuercurves.getIssuerProvider());
  }
  ...
  @Override
  public MultiCurrencyAmount visitBondFuturesTransaction(final BondFuturesTransaction futures, final ParameterIssuerProviderInterface issuercurves) {
  ...
  @Override
  public MultiCurrencyAmount visitBondTotalReturnSwap(final BondTotalReturnSwap trs, final ParameterIssuerProviderInterface issuercurves) {
  ...
  @Override
  public MultiCurrencyAmount visitBillTotalReturnSwap(final BillTotalReturnSwap trs, final ParameterIssuerProviderInterface issuercurves) {
