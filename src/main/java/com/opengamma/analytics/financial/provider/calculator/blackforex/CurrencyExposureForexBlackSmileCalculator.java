 ...
 */
public final class CurrencyExposureForexBlackSmileCalculator extends InstrumentDerivativeVisitorSameMethodAdapter<BlackForexSmileProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visit(final InstrumentDerivative derivative, final BlackForexSmileProviderInterface blackSmile) {
  ...
  @Override
  public MultiCurrencyAmount visitForexOptionVanilla(final ForexOptionVanilla option, final BlackForexSmileProviderInterface blackSmile) {
    return METHOD_FX_VAN.currencyExposure(option, blackSmile);
  }

  @Override
  public MultiCurrencyAmount visitForexNonDeliverableOption(final ForexNonDeliverableOption option, final BlackForexSmileProviderInterface blackSmile) {
    return METHOD_NDO.currencyExposure(option, blackSmile);
  }

  @Override
  public MultiCurrencyAmount visitForexOptionDigital(final ForexOptionDigital option, final BlackForexSmileProviderInterface blackSmile) {
    return METHOD_DIG.currencyExposure(option, blackSmile);
  }

  @Override
  public MultiCurrencyAmount visitForexOptionSingleBarrier(final ForexOptionSingleBarrier option, final BlackForexSmileProviderInterface blackSmile) {
