 ...
 */
public final class PresentValueSABRSwaptionRightExtrapolationCalculator extends InstrumentDerivativeVisitorSameMethodAdapter<SABRSwaptionProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visit(final InstrumentDerivative derivative, final SABRSwaptionProviderInterface sabr) {
  ...
  @Override
  public MultiCurrencyAmount visitCouponCMS(final CouponCMS payment, final SABRSwaptionProviderInterface sabr) {
    return _methodExtraCMSCpn.presentValue(payment, sabr);
  }

  @Override
  public MultiCurrencyAmount visitCapFloorCMS(final CapFloorCMS payment, final SABRSwaptionProviderInterface sabr) {
    return _methodExtraCMSCap.presentValue(payment, sabr);
  }

  @Override
  public MultiCurrencyAmount visitCapFloorCMSSpread(final CapFloorCMSSpread payment, final SABRSwaptionProviderInterface sabr) {
  ...
  @Override
  public MultiCurrencyAmount visitGenericAnnuity(final Annuity<? extends Payment> annuity, final SABRSwaptionProviderInterface sabr) {
    ArgChecker.notNull(annuity, "Annuity");
    MultiCurrencyAmount pv = visit(annuity.getNthPayment(0), sabr);
  ...
  @Override
  public MultiCurrencyAmount visitSwaptionPhysicalFixedIbor(final SwaptionPhysicalFixedIbor swaption, final SABRSwaptionProviderInterface sabr) {
    return _methodSwptPhys.presentValue(swaption, sabr);
  }

  @Override
  public MultiCurrencyAmount visitSwaptionCashFixedIbor(final SwaptionCashFixedIbor swaption, final SABRSwaptionProviderInterface sabr) {
