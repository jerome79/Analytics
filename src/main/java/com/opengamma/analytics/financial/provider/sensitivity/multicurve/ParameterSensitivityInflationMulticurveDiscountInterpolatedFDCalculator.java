...
public class ParameterSensitivityInflationMulticurveDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<InflationProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityInflationMulticurveDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<InflationProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final InflationProviderDiscount multicurve) {
    ...
    for (final IndexPrice index : indexPrice) {
      ...
      ArgChecker.isTrue(curve instanceof PriceIndexCurveSimple, "PriceIndexCurve should be of type PriceIndexCurveSimple");
