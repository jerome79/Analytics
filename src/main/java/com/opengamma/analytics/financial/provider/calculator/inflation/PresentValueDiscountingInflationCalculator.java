...
public final class PresentValueDiscountingInflationCalculator extends 
  ...
  @Override
  public MultiCurrencyAmount visitCouponInflationZeroCouponMonthly(final CouponInflationZeroCouponMonthly coupon, final ParameterInflationProviderInterface market) {
    return METHOD_ZC_MONTHLY.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationZeroCouponInterpolation(final CouponInflationZeroCouponInterpolation coupon, final ParameterInflationProviderInterface market) {
    return METHOD_ZC_INTERPOLATION.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationZeroCouponMonthlyGearing(final CouponInflationZeroCouponMonthlyGearing coupon, final ParameterInflationProviderInterface market) {
    return METHOD_ZC_MONTHLY_GEARING.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationZeroCouponInterpolationGearing(final CouponInflationZeroCouponInterpolationGearing coupon, final ParameterInflationProviderInterface market) {
    return METHOD_ZC_INTERPOLATION_GEARING.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationYearOnYearMonthly(final CouponInflationYearOnYearMonthly coupon, final ParameterInflationProviderInterface market) {
    return METHOD_YEAR_ON_YEAR_MONTHLY.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationYearOnYearInterpolation(final CouponInflationYearOnYearInterpolation coupon, final ParameterInflationProviderInterface market) {
    return METHOD_YEAR_ON_YEAR_INTERPOLATION.presentValue(coupon, market.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationYearOnYearMonthlyWithMargin(final CouponInflationYearOnYearMonthlyWithMargin coupon, final ParameterInflationProviderInterface inflation) {
    return METHOD_YEAR_ON_YEAR_MONTHLY_WITH_MARGIN.presentValue(coupon, inflation.getInflationProvider());
  }

  @Override
  public MultiCurrencyAmount visitCouponInflationYearOnYearInterpolationWithMargin(final CouponInflationYearOnYearInterpolationWithMargin coupon,
  ...
  @Override
  public MultiCurrencyAmount visitGenericAnnuity(final Annuity<? extends Payment> annuity, final ParameterInflationProviderInterface market) {
    ArgChecker.notNull(annuity, "Annuity");
    ArgChecker.notNull(market, "market");
    MultiCurrencyAmount pv = annuity.getNthPayment(0).accept(this, market);
  ...
  @Override
  public MultiCurrencyAmount visitFixedCouponAnnuity(final AnnuityCouponFixed annuity, final ParameterInflationProviderInterface multicurve) {
  ...
  @Override
  public MultiCurrencyAmount visitSwap(final Swap<?, ?> swap, final ParameterInflationProviderInterface market) {
    final MultiCurrencyAmount pv1 = swap.getFirstLeg().accept(this, market);
    final MultiCurrencyAmount pv2 = swap.getSecondLeg().accept(this, market);
    return pv1.plus(pv2);
  }

  @Override
  public MultiCurrencyAmount visitFixedCouponSwap(final SwapFixedCoupon<?> swap, final ParameterInflationProviderInterface market) {
