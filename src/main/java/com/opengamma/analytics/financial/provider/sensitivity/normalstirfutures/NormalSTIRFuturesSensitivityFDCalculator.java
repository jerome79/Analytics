...
public class NormalSTIRFuturesSensitivityFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<NormalSTIRFuturesProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
  ...
  public NormalSTIRFuturesSensitivityFDCalculator(
      final InstrumentDerivativeVisitor<NormalSTIRFuturesProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
