 ...
 */
public final class PresentValueBlackSmileCapCalculator extends InstrumentDerivativeVisitorAdapter<BlackSmileCapProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitCapFloorIbor(final CapFloorIbor cap, final BlackSmileCapProviderInterface black) {
