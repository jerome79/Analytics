 ...
 */
public final class PresentValueG2ppCalculator extends InstrumentDerivativeVisitorAdapter<G2ppProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitSwaptionPhysicalFixedIbor(final SwaptionPhysicalFixedIbor swaption, final G2ppProviderInterface g2) {
    return METHOD_SWT_PHYS.presentValue(swaption, g2);
  }

  @Override
  public MultiCurrencyAmount visitSwaptionCashFixedIbor(final SwaptionCashFixedIbor swaption, final G2ppProviderInterface g2) {
