 ...
 */
public final class PresentValueForexForwardPointsCalculator extends InstrumentDerivativeVisitorAdapter<MulticurveForwardPointsProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitForex(final Forex fx, final MulticurveForwardPointsProviderInterface multicurvePoints) {
