...
public class ParameterSensitivitySABRCapDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<SABRCapProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivitySABRCapDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<SABRCapProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
