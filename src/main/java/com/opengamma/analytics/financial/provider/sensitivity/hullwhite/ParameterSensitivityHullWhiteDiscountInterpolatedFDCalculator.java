...
public class ParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityHullWhiteDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<HullWhiteOneFactorProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final HullWhiteOneFactorProviderDiscount hullWhite) {
    ...
    final MultiCurrencyAmount pvInit = instrument.accept(_valueCalculator, hullWhite);
