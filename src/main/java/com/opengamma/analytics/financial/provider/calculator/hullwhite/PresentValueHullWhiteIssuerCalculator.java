 ...
 */
public final class PresentValueHullWhiteIssuerCalculator extends InstrumentDerivativeVisitorAdapter<HullWhiteIssuerProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitBondFuturesTransaction(final BondFuturesTransaction futures, final HullWhiteIssuerProviderInterface hullWhite) {
