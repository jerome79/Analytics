...
public class ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<BlackSmileCapProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityBlackSmileCapDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<BlackSmileCapProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
