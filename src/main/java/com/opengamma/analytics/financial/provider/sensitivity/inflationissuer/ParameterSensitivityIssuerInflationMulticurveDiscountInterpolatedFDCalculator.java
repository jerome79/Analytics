...
public class ParameterSensitivityIssuerInflationMulticurveDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<ParameterInflationIssuerProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
  ...
  public ParameterSensitivityIssuerInflationMulticurveDiscountInterpolatedFDCalculator(
      final InstrumentDerivativeVisitor<ParameterInflationIssuerProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final InflationIssuerProviderDiscount inflationIssuer) {
    ...
    final MultiCurrencyAmount pvInit = instrument.accept(_valueCalculator, inflationIssuer);
