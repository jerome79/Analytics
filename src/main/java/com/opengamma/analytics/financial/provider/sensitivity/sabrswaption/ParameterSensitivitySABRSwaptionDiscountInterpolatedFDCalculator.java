...
public class ParameterSensitivitySABRSwaptionDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<SABRSwaptionProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivitySABRSwaptionDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<SABRSwaptionProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
