...
public class ParameterSensitivityBlackSwaptionDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<BlackSwaptionFlatProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityBlackSwaptionDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<BlackSwaptionFlatProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
