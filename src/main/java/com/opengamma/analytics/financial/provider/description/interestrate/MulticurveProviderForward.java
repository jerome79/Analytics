...
public class MulticurveProviderForward implements MulticurveProviderInterface {
  ...
  public MulticurveProviderForward copy() {
    ...
    return new MulticurveProviderForward(discountingCurves, forwardIborCurves, forwardONCurves, _fxMatrix);
  }
  ...
  public double[] parameterSensitivity(final String name, final List<DoublesPair> pointSensitivity) {
    ...
    ArgChecker.isTrue(curveObject instanceof YieldAndDiscountCurve, "Curve not a YieldAndDiscountCurve, can not compute sensitivity");
  ...
  public double[] parameterForwardSensitivity(final String name, final List<ForwardSensitivity> pointSensitivity) {
    ...
    ArgChecker.isTrue(curveObject instanceof DoublesCurve, "Curve not a DoublesCurve, can not computed sensitivity");
  ...
  public Integer getNumberOfParameters(final String name) {
    ...
    ArgChecker.isTrue(curveObject instanceof DoublesCurve, "Curve not a DoublesCurve; cannot get number of parameters");
  ...
  public List<String> getUnderlyingCurvesNames(final String name) {
    ...
    ArgChecker.isTrue(curveObject instanceof DoublesCurve, "Curve not a DoublesCurve");
  ...
  public double getSimplyCompoundForwardRate(final IndexON index, final double startTime, final double endTime) {
    ArgChecker.isFalse(startTime == endTime, "sart time should be different from end time");
    if (_forwardONCurves.containsKey(index)) {
