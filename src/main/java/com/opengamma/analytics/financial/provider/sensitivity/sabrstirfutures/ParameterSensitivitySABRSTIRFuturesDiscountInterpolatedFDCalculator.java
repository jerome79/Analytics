...
public class ParameterSensitivitySABRSTIRFuturesDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<SABRSTIRFuturesProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivitySABRSTIRFuturesDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<SABRSTIRFuturesProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final SABRSTIRFuturesProviderDiscount sabr) {
    ...
    final MultiCurrencyAmount pvInit = instrument.accept(_valueCalculator, sabr);
