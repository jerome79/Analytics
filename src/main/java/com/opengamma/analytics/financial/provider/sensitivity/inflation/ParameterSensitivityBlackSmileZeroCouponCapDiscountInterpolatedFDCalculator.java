...
public class ParameterSensitivityBlackSmileZeroCouponCapDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<BlackSmileCapInflationZeroCouponProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
  ...
  public ParameterSensitivityBlackSmileZeroCouponCapDiscountInterpolatedFDCalculator(
      final InstrumentDerivativeVisitor<BlackSmileCapInflationZeroCouponProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
