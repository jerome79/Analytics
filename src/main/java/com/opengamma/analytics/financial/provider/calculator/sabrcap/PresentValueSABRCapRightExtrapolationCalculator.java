 ...
 */
public final class PresentValueSABRCapRightExtrapolationCalculator extends InstrumentDerivativeVisitorSameMethodAdapter<SABRCapProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visit(final InstrumentDerivative derivative, final SABRCapProviderInterface sabr) {
  ...
  @Override
  public MultiCurrencyAmount visitCapFloorIbor(final CapFloorIbor cap, final SABRCapProviderInterface sabr) {
  ...
  @Override
  public MultiCurrencyAmount visitGenericAnnuity(final Annuity<? extends Payment> annuity, final SABRCapProviderInterface sabr) {
