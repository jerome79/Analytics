 ...
 */
public final class PresentValueSABRHullWhiteMonteCarloCalculator extends InstrumentDerivativeVisitorAdapter<SABRSwaptionProviderInterface, MultiCurrencyAmount> {
   ...
   */
  public MultiCurrencyAmount visitSwaptionPhysicalFixedIbor(final SwaptionPhysicalFixedIbor swaption, final SABRSwaptionProviderInterface sabrData) {
