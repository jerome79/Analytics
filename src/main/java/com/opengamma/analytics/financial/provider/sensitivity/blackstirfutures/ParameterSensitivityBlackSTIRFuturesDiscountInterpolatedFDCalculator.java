...
public class ParameterSensitivityBlackSTIRFuturesDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<BlackSTIRFuturesProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityBlackSTIRFuturesDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<BlackSTIRFuturesProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
