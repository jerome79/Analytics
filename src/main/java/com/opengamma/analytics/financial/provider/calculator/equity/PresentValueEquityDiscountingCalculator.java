 ...
 */
public final class PresentValueEquityDiscountingCalculator extends InstrumentDerivativeVisitorAdapter<EquityTrsDataBundle, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitEquityTotalReturnSwap(final EquityTotalReturnSwap trs, final EquityTrsDataBundle multicurve) {
