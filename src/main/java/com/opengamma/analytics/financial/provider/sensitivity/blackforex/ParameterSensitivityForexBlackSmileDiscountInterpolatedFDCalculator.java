...
public class ParameterSensitivityForexBlackSmileDiscountInterpolatedFDCalculator {
   ...
   */
  private final InstrumentDerivativeVisitor<BlackForexSmileProviderInterface, MultiCurrencyAmount> _valueCalculator;
  /**
   ...
   */
  public ParameterSensitivityForexBlackSmileDiscountInterpolatedFDCalculator(final InstrumentDerivativeVisitor<BlackForexSmileProviderInterface, MultiCurrencyAmount> valueCalculator,
      final double shift) {
  ...
  public MultipleCurrencyParameterSensitivity calculateSensitivity(final InstrumentDerivative instrument, final BlackForexSmileProviderDiscount data) {
    ...
    final MultiCurrencyAmount pvInit = instrument.accept(_valueCalculator, data);
    final int nbCcy = pvInit.size();
    final List<Currency> ccyList = new ArrayList<>(pvInit.getCurrencies());
    // Discounting
