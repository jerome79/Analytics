 ...
 */
public final class PresentValueBlackSmileShiftCapCalculator extends InstrumentDerivativeVisitorAdapter<BlackSmileShiftCapProviderInterface, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitCapFloorIbor(final CapFloorIbor cap, final BlackSmileShiftCapProviderInterface black) {
