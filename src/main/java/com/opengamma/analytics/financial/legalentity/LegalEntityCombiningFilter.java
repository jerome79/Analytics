...
public class LegalEntityCombiningFilter implements LegalEntityFilter<LegalEntity>, Bean {
  ...
  private Set<LegalEntityFilter<LegalEntity>> filtersToUse;
  ...
  public Object getFilteredData(final LegalEntity legalEntity) {
    ...
    for (final LegalEntityFilter<LegalEntity> filter : filtersToUse) {
  ...
  public Type getFilteredDataType() {
    if (filtersToUse.isEmpty()) {
      ...
      Type setMember = null;
      for (LegalEntityFilter<LegalEntity> filter : filtersToUse) {
  ...
  public static class Meta extends DirectMetaBean {
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((LegalEntityCombiningFilter) bean).filtersToUse, "filtersToUse");
    }
