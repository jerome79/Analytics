...
public class LegalEntitySector implements LegalEntityFilter<LegalEntity>, Bean {
   ...
   */
  @PropertyDefinition
  private boolean useSectorName;

  /**
   * True if the classification name is to be used as a filter.
   */
  @PropertyDefinition
  private boolean useClassificationName;
   ...
   */
  @PropertyDefinition
  private Set<? extends Type> classificationValueTypes;
  ...
  public Object getFilteredData(final LegalEntity legalEntity) {
    ...
    if (!(useSectorName || useClassificationName)) {
    ...
    if (useClassificationName) {
      ...
      for (final Map.Entry<String, Object> entry : classifications.entrySet()) {
        if (this.classifications.contains(entry.getKey())) {
          selections.add(entry.getValue());
          classificationCount++;
        }
      }
    }
    if (classificationCount != classifications.size()) {
      throw new IllegalStateException("Classifications " + sector.getClassifications() + " do not contain matches for " + classifications);
    }
    return selections;
  }
  ...
  /**
   * Sets the agencies with which to filter ratings. This also sets the {@link LegalEntitySector#useClassificationName} field to true.
   * 
  ...
  public void setUseSectorName(boolean useSectorName) {
    this.useSectorName = useSectorName;
  }
  ...
  public void setUseClassificationName(boolean useClassificationName) {
    this.useClassificationName = useClassificationName;
  }
  ...
  public void setClassificationValueTypes(Set<? extends Type> classificationValueTypes) {
    this.classificationValueTypes = classificationValueTypes;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((LegalEntitySector) bean).classifications, "classifications");
    }
