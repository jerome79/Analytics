...
public final class Sector implements Bean, Serializable {
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private FlexiBean classifications;
  ...
  private Sector(final String name, final FlexiBean classifications) {
    ...
    ArgChecker.notNull(classifications, "classifications");
    this.name = name;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((Sector) bean).name, "name");
      JodaBeanUtils.notNull(((Sector) bean).classifications, "classifications");
    }
