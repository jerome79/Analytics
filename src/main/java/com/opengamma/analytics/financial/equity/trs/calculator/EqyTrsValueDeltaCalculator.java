 ...
 */
public final class EqyTrsValueDeltaCalculator extends InstrumentDerivativeVisitorAdapter<EquityTrsDataBundle, MultiCurrencyAmount> {
  ...
  @Override
  public MultiCurrencyAmount visitEquityTotalReturnSwap(final EquityTotalReturnSwap equityTrs, final EquityTrsDataBundle data) {
