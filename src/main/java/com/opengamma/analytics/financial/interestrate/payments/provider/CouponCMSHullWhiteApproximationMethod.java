...
public final class CouponCMSHullWhiteApproximationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponCMS cms, final HullWhiteOneFactorProviderInterface multicurvesHW) {
    ArgChecker.notNull(cms, "CMS");
    ArgChecker.notNull(multicurvesHW, "Hull-White provider");
