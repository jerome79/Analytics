...
public final class SwaptionPhysicalFixedIborHullWhiteMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final HullWhiteOneFactorProviderInterface hullWhite) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final AnnuityPaymentFixed cfe, final HullWhiteOneFactorProviderInterface hullWhite) {
    ArgChecker.notNull(swaption, "Swaption");
    ArgChecker.notNull(hullWhite, "Hull-White provider");
    ...
    return MultiCurrencyAmount.of(swaption.getUnderlyingSwap().getFirstLeg().getCurrency(), pv * (swaption.isLong() ? 1.0 : -1.0));
  }
