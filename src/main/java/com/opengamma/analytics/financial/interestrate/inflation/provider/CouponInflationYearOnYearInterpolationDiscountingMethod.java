...
public class CouponInflationYearOnYearInterpolationDiscountingMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearInterpolation coupon, final InflationProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearInterpolation coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
