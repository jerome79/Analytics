...
public final class PaymentFixedDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final PaymentFixed payment, final MulticurveProviderInterface multicurves) {
    ...
    return MultiCurrencyAmount.of(payment.getCurrency(), pv);
  }
