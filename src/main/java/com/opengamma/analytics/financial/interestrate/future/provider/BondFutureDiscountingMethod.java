...
public final class BondFutureDiscountingMethod extends BondFutureMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final BondFuture future, final IssuerProviderInterface issuerMulticurves) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromNetBasis(final BondFuture future, final IssuerProviderInterface issuerMulticurves, final double netBasis) {
  ...
  public double[] grossBasisFromPrices(final BondFuture future, final double[] cleanPrices, final double futurePrice) {
    ...
    ArgChecker.isTrue(cleanPrices.length == nbBasket, "Number of clean prices");
