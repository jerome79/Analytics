...
public final class CapFloorInflationYearOnYearMonthlyBlackNormalSmileMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationYearOnYearMonthly cap, final BlackSmileCapInflationYearOnYearProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationYearOnYearMonthly cap, final BlackSmileCapInflationYearOnYearProviderInterface black) {
