...
public class SwaptionCashFixedIborG2ppNumericalIntegrationMethod {
  ...
  public MultiCurrencyAmount presentValue(final SwaptionCashFixedIbor swaption, final G2ppProviderInterface g2Data) {
    ...
    return MultiCurrencyAmount.of(swaption.getCurrency(), dft0 * pv * (swaption.isLong() ? 1.0 : -1.0));
  }
