...
public final class SwaptionPhysicalFixedIborG2ppApproximationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final G2ppProviderInterface g2Data) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final AnnuityPaymentFixed cfe, final G2ppProviderInterface g2Data) {
    ...
    return MultiCurrencyAmount.of(swaption.getCurrency(), price);
  }
