...
public final class CapFloorInflationYearOnYearInterpolationBlackNormalSmileMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationYearOnYearInterpolation cap, final BlackSmileCapInflationYearOnYearProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationYearOnYearInterpolation cap, final BlackSmileCapInflationYearOnYearProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final InstrumentDerivative instrument, final BlackSmileCapInflationYearOnYearProviderInterface black) {
