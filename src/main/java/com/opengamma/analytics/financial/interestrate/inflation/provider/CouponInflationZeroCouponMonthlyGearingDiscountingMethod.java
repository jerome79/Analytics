...
public class CouponInflationZeroCouponMonthlyGearingDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CouponInflationZeroCouponMonthlyGearing coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
    ...
    return MultiCurrencyAmount.of(coupon.getCurrency(), netAmount);
  }
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationZeroCouponMonthlyGearing coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
  ...
  public double indexEstimation(final CouponInflationZeroCouponMonthlyGearing coupon, final InflationProviderInterface inflation) {
    return inflation.getPriceIndex(coupon.getPriceIndex(), coupon.getReferenceEndTime());
  }
