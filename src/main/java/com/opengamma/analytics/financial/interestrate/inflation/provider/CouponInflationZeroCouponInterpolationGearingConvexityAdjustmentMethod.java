...
public class CouponInflationZeroCouponInterpolationGearingConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CouponInflationZeroCouponInterpolationGearing coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationZeroCouponInterpolationGearing coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
