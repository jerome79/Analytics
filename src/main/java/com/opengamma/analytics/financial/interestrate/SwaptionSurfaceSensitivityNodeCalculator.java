...
public class SwaptionSurfaceSensitivityNodeCalculator {
  ...
  public PresentValueSwaptionSurfaceSensitivity calculateNodeSensitivities(
    ...
    ArgChecker.notNull(sensitivities, "Black swaption sensitivities");
    ArgChecker.notNull(parameters, "Black swaption parameters");
    ArgChecker.isTrue(parameters.getGeneratorSwap().equals(sensitivities.getGeneratorSwap()),
