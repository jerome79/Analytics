...
public class CouponInflationZeroCouponMonthlyDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CouponInflationZeroCouponMonthly coupon, final InflationProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationZeroCouponMonthly coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
