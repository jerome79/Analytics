...
public class CouponInflationYearOnYearMonthlyConvexityAdjustmentMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
