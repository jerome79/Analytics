...
public final class CapFloorCMSHullWhiteApproximationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CapFloorCMS cms, final HullWhiteOneFactorProviderInterface hwMulticurves) {
    ArgChecker.notNull(cms, "CMS");
    ArgChecker.notNull(hwMulticurves, "Hull-White provider");
    ...
    return MultiCurrencyAmount.of(cms.getCurrency(), pv);
  }
