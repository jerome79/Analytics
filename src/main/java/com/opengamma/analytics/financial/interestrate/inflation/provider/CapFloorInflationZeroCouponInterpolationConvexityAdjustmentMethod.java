...
public final class CapFloorInflationZeroCouponInterpolationConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationZeroCouponInterpolation cap, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationZeroCouponInterpolation cap, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final InstrumentDerivative instrument, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
    ArgChecker.isTrue(instrument instanceof CapFloorInflationZeroCouponInterpolation, "Inflation Zero Coupon  Cap/floor");
