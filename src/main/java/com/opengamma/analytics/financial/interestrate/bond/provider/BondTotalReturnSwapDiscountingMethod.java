...
public final class BondTotalReturnSwapDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final BondTotalReturnSwap trs, final IssuerProviderInterface issuerMulticurves) {
    ArgChecker.notNull(trs, "bond TRS");
    ArgChecker.notNull(issuerMulticurves, "issuer and multi-curve provider");
    final MultiCurrencyAmount fundingLegPV = trs.getFundingLeg().accept(PVIC, issuerMulticurves);
    final MultiCurrencyAmount bondPV = trs.getAsset().accept(PVIC, issuerMulticurves).multipliedBy(trs.getQuantity());
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueAssetLeg(final BondTotalReturnSwap trs, final IssuerProviderInterface issuerMulticurves) {
    ArgChecker.notNull(trs, "bond TRS");
    ArgChecker.notNull(issuerMulticurves, "issuer and multi-curve provider");
    final MultiCurrencyAmount bondPV = trs.getAsset().accept(PVIC, issuerMulticurves).multipliedBy(trs.getQuantity());
    return bondPV;
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueAssetLeg(final BillTotalReturnSwap trs, final IssuerProviderInterface issuerMulticurves) {
    ArgChecker.notNull(trs, "bill TRS");
    ArgChecker.notNull(issuerMulticurves, "issuer and multi-curve provider");
    final MultiCurrencyAmount billPV = trs.getAsset().accept(PVIC, issuerMulticurves).multipliedBy(trs.getQuantity());
    return billPV;
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFundingLeg(final BondTotalReturnSwap trs, final IssuerProviderInterface issuerMulticurves) {
    ArgChecker.notNull(trs, "bond TRS");
    ArgChecker.notNull(issuerMulticurves, "issuer and multi-curve provider");
    final MultiCurrencyAmount fundingLegPV = trs.getFundingLeg().accept(PresentValueIssuerCalculator.getInstance(), issuerMulticurves);
    return fundingLegPV;
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFundingLeg(final BillTotalReturnSwap trs, final IssuerProviderInterface issuerMulticurves) {
    ArgChecker.notNull(trs, "bill TRS");
    ArgChecker.notNull(issuerMulticurves, "issuer and multi-curve provider");
    final MultiCurrencyAmount fundingLegPV = trs.getFundingLeg().accept(PresentValueIssuerCalculator.getInstance(), issuerMulticurves);
    return fundingLegPV;
