...
public final class SwaptionPhysicalFixedIborLMMDDMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final LiborMarketModelDisplacedDiffusionProviderInterface lmmData) {
    ArgChecker.notNull(swaption, "Swaption");
    ArgChecker.notNull(lmmData, "LMM provider");
