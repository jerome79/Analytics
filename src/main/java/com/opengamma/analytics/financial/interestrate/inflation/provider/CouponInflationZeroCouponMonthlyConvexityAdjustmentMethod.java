...
public class CouponInflationZeroCouponMonthlyConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CouponInflationZeroCouponMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationZeroCouponMonthly coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
