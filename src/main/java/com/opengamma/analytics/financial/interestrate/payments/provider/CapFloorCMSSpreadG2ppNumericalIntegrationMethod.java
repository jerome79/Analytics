...
public final class CapFloorCMSSpreadG2ppNumericalIntegrationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CapFloorCMSSpread cmsSpread, final G2ppProviderInterface g2Data) {
    ...
    ArgChecker.isTrue(g2Data.getG2ppCurrency().equals(ccy), "CMS spread currency incompatible with data");
    ...
    return MultiCurrencyAmount.of(cmsSpread.getCurrency(), dftp * pv * cmsSpread.getNotional() * cmsSpread.getPaymentYearFraction());
  }
