...
public class CouponInflationYearOnYearInterpolationWithMarginConvexityAdjustmentMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearInterpolationWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ...
    return MultiCurrencyAmount.of(coupon.getCurrency(), na);
  }
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearInterpolationWithMargin coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
