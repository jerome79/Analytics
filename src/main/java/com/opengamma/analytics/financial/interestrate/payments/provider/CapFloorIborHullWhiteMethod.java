...
public final class CapFloorIborHullWhiteMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CapFloorIbor cap, final HullWhiteOneFactorProviderInterface hullWhite) {
    ArgChecker.notNull(cap, "The cap/floor shoud not be null");
    ArgChecker.notNull(hullWhite, "The Hull-White data shoud not be null");
    ...
    pv *= cap.getNotional();
    return MultiCurrencyAmount.of(ccy, pv);
  }
