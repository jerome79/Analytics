...
public class CouponCMSSABRReplicationGenericMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponCMS cmsCoupon, final SABRSwaptionProviderInterface sabrData) {
    final CapFloorCMS cap0 = CapFloorCMS.from(cmsCoupon, 0.0, true);
    final MultiCurrencyAmount priceCMSCoupon = _capFloorMethod.presentValue(cap0, sabrData);
