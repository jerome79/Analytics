...
public final class BondFuturesTransactionDiscountingMethod extends FuturesTransactionIssuerMethod {
   ...
   */
  public MultiCurrencyAmount presentValueFromNetBasis(final BondFuturesTransaction futures, final IssuerProviderInterface issuerMulticurves, final double netBasis) {
