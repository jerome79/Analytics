...
public class SwaptionPhysicalFixedIborSABRLMMExactMethod {
  ...
  public MultiCurrencyAmount presentValue(final SwaptionPhysicalFixedIbor swaption, final SABRSwaptionProviderInterface sabrData) {
    ...
    return MultiCurrencyAmount.of(METHOD_SWAPTION_LMM.presentValue(swaption, lmm).getAmount(ccy));
  }
  ...
  public List<Object> presentValueCurveSABRSensitivity(final SwaptionPhysicalFixedIbor swaption, final SABRSwaptionProviderInterface sabrData) {
    ...
    results.add(METHOD_SWAPTION_LMM.presentValue(swaption, lmm).getAmount(ccy));
    results.add(pvcs);
    results.add(pvss);
    return results;
  }
