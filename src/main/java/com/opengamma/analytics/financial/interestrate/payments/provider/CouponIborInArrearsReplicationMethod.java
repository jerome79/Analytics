...
public class CouponIborInArrearsReplicationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponIbor coupon, final SABRCapProviderInterface sabr) {
    ArgChecker.notNull(coupon, "The coupon shoud not be null");
