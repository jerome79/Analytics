...
public final class CapFloorInflationYearOnYearInterpolationConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationYearOnYearInterpolation cap, final BlackSmileCapInflationYearOnYearWithConvexityProviderInterface black) {
    ArgChecker.notNull(cap, "The cap/floor shoud not be null");
    ArgChecker.notNull(black, "Black provider");
    ...
    return MultiCurrencyAmount.of(cap.getCurrency(), price);
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationYearOnYearInterpolation cap, final BlackSmileCapInflationYearOnYearWithConvexityProviderInterface black) {
    final MultiCurrencyAmount nonDiscountedPresentValue = netAmount(cap, black);
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final InstrumentDerivative instrument, final BlackSmileCapInflationYearOnYearWithConvexityProviderInterface black) {
    ArgChecker.isTrue(instrument instanceof CapFloorInflationYearOnYearInterpolation, "Inflation Year on Year Cap/floor");
  ...
  public MultipleCurrencyInflationSensitivity presentValueCurveSensitivity(final CapFloorInflationYearOnYearInterpolation cap,
    ...
    ArgChecker.notNull(cap, "The cap/floor should not be null");
    ArgChecker.notNull(black, "Black provider");
