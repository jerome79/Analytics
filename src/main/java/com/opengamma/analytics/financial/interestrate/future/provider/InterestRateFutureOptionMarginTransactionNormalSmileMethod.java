...
public final class InterestRateFutureOptionMarginTransactionNormalSmileMethod extends
   ...
   */
  public MultiCurrencyAmount presentValueFromFuturePrice(
    ...
    ArgChecker.notNull(normalData, "Normal / multi-curves provider");
  ...
  public MultipleCurrencyMulticurveSensitivity presentValueCurveSensitivityFromPrice(
      ...
      double priceFuture) {
    ArgChecker.notNull(transaction, "Transaction on option on STIR futures");
    ArgChecker.notNull(normalData, "data provider");
  ...
  public double presentValueGamma(InterestRateFutureOptionMarginTransaction transaction,
    ...
    ArgChecker.notNull(transaction, "Transaction on option on STIR futures");
    ArgChecker.notNull(normalData, "normal volatility / multi-curves provider");
