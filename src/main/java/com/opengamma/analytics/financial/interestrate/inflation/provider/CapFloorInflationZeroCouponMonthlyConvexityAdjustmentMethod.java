...
public final class CapFloorInflationZeroCouponMonthlyConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationZeroCouponMonthly cap, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationZeroCouponMonthly cap, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
  ...
  public MultiCurrencyAmount presentValue(final InstrumentDerivative instrument, final BlackSmileCapInflationZeroCouponWithConvexityProviderInterface black) {
    ArgChecker.isTrue(instrument instanceof CapFloorInflationZeroCouponMonthly, "Inflation Zero Coupon  Cap/floor");
