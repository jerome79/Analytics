...
public class CouponInflationYearOnYearMonthlyWithMarginDiscountingMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearMonthlyWithMargin coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
