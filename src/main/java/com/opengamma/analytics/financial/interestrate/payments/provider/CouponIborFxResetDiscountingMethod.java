...
public final class CouponIborFxResetDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponIborFxReset coupon,
    ...
    return MultiCurrencyAmount.of(ccyPayment, value);
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount currencyExposure(final CouponIborFxReset coupon,
      final MulticurveProviderInterface multicurves) {
    ArgChecker.notNull(coupon, "coupon");
    ArgChecker.notNull(multicurves, "multicurves");
    double forward = multicurves.getSimplyCompoundForwardRate(coupon.getIndex(),
    ...
    return MultiCurrencyAmount.of(ccyReference, pvRef);
  }
}
