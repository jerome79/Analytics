...
public abstract class FuturesTransactionMethod {
   ...
   */
  public MultiCurrencyAmount presentValueFromPrice(final FuturesTransaction<?> futures, final double quotedPrice) {
    ...
    return MultiCurrencyAmount.of(futures.getUnderlyingSecurity().getCurrency(), pv);
  }
