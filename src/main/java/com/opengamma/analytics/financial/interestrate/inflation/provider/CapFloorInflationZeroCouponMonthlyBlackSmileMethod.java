...
public final class CapFloorInflationZeroCouponMonthlyBlackSmileMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CapFloorInflationZeroCouponMonthly cap, final BlackSmileCapInflationZeroCouponProviderInterface black) {
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValue(final CapFloorInflationZeroCouponMonthly cap, final BlackSmileCapInflationZeroCouponProviderInterface black) {
