...
public final class BillSecurityDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final BillSecurity bill, final IssuerProviderInterface issuer) {
    ...
    return MultiCurrencyAmount.of(bill.getCurrency(), pvBill);
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromYield(final BillSecurity bill, final double yield, final IssuerProviderInterface issuer) {
    ArgChecker.notNull(bill, "Bill");
    ArgChecker.notNull(issuer, "Issuer and multi-curves provider");
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromPrice(final BillSecurity bill, final double price, final IssuerProviderInterface issuer) {
    ArgChecker.notNull(bill, "Bill");
    ArgChecker.notNull(issuer, "Issuer and multi-curves provider");
