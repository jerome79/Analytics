...
public final class ForwardRateAgreementDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForwardRateAgreement fra, final MulticurveProviderInterface multicurve) {
    ...
    return MultiCurrencyAmount.of(fra.getCurrency(), presentValue);
  }
