...
public final class SwaptionCashFixedIborHullWhiteApproximationMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final SwaptionCashFixedIbor swaption, final HullWhiteOneFactorProviderInterface hullWhite) {
    ...
    return MultiCurrencyAmount.of(swaption.getCurrency(), pv * notional * dfIbor[0] * (swaption.isLong() ? 1.0 : -1.0));
  }
