...
public class CouponInflationYearOnYearInterpolationWithMarginDiscountingMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearInterpolationWithMargin coupon, final InflationProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearInterpolationWithMargin coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
