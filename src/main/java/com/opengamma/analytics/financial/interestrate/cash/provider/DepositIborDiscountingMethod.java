...
public final class DepositIborDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final DepositIbor deposit, final MulticurveProviderInterface multicurves) {
  ...
  public MulticurveSensitivity parSpreadCurveSensitivity(final DepositIbor deposit, final MulticurveProviderInterface multicurve) {
    ArgChecker.notNull(deposit, "Deposit");
    ArgChecker.notNull(multicurve, "Multicurves");
    final Map<String, List<ForwardSensitivity>> mapFwd = new HashMap<>();
    final List<ForwardSensitivity> listForward = new ArrayList<>();
