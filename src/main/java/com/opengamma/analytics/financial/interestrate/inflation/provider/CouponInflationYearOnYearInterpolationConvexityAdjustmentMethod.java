...
public class CouponInflationYearOnYearInterpolationConvexityAdjustmentMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearInterpolation coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearInterpolation coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
