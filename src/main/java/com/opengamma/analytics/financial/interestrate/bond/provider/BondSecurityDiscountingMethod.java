...
public final class BondSecurityDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final BondSecurity<? extends Payment, ? extends Coupon> bond, final IssuerProviderInterface issuerMulticurves) {
    ...
    final MultiCurrencyAmount pvNominal = bond.getNominal().accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = bond.getCoupon().accept(PVDC, multicurvesDecorated);
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromCleanPrice(final BondSecurity<? extends Payment, ? extends Coupon> bond, final MulticurveProviderInterface multicurves, final double cleanPrice) {
    ArgChecker.isTrue(bond instanceof BondFixedSecurity, "Present value from clean price available only for fixed coupon bond");
    ...
    return MultiCurrencyAmount.of(bond.getCurrency(), pvPrice);
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromYield(final BondSecurity<? extends Payment, ? extends Coupon> bond, final MulticurveProviderInterface multicurves, final double yield) {
    ArgChecker.isTrue(bond instanceof BondFixedSecurity, "Present value from clean price available only for fixed coupon bond");
    final BondFixedSecurity bondFixed = (BondFixedSecurity) bond;
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromZSpread(final BondSecurity<? extends Payment, ? extends Coupon> bond,
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueFromZSpread(BondSecurity<? extends Payment, ? extends Coupon> bond,
  ...
  public double dirtyPriceFromCurves(final BondFixedSecurity bond, final IssuerProviderInterface issuerMulticurves) {
    ...
    final MultiCurrencyAmount pv = presentValue(bond, issuerMulticurves);
    ...
    return pv.getAmount(bond.getCurrency()).getAmount() / df / notional;
  }
  ...
  public MulticurveSensitivity dirtyPriceCurveSensitivity(final BondFixedSecurity bond, final IssuerProviderInterface issuerMulticurves) {
    ...
    result = result.multipliedBy(pv.getAmount(ccy).getAmount() / notional);
   ...
   * @return The z-spread.
   */
  public double zSpreadFromCurvesAndPV(final BondSecurity<? extends Payment, ? extends Coupon> bond, final IssuerProviderInterface issuerMulticurves, final MultiCurrencyAmount pv) {
    ArgChecker.notNull(bond, "Bond");
    ArgChecker.notNull(issuerMulticurves, "Issuer and multi-curves provider");
    final Currency ccy = bond.getCurrency();
    ...
    final Function1D<Double, Double> residual = new Function1D<Double, Double>() {
      ...
      public Double evaluate(final Double z) {
        return presentValueFromZSpread(bond, issuerMulticurves, z).getAmount(ccy).getAmount() - pv.getAmount(ccy).getAmount();
      }
    };
  ...
  public double zSpreadFromCurvesAndPV(final BondSecurity<? extends Payment, ? extends Coupon> bond,
      final IssuerProviderInterface issuerMulticurves, final MultiCurrencyAmount pv, final boolean periodic,
    ...
    final Function1D<Double, Double> residual = new Function1D<Double, Double>() {
      @Override
      public Double evaluate(final Double z) {
        return presentValueFromZSpread(bond, issuerMulticurves, z, periodic, periodPerYear).getAmount(ccy).getAmount() -
