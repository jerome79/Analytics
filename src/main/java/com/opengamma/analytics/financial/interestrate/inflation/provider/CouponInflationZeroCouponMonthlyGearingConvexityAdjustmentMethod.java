...
public class CouponInflationZeroCouponMonthlyGearingConvexityAdjustmentMethod {
   ...
   */
  public MultiCurrencyAmount netAmount(final CouponInflationZeroCouponMonthlyGearing coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationZeroCouponMonthlyGearing coupon, final InflationConvexityAdjustmentProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
