...
public final class CouponIborSpreadDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponIborSpread coupon, final MulticurveProviderInterface multicurves) {
  ...
  public MultiCurrencyAmount presentValue(
    ...
    ArgChecker.notNull(forwardRateProvider, "forwardRateProvider");
    ...
    return MultiCurrencyAmount.of(coupon.getCurrency(), value);
  }
   ...
   * @return The present value.
   */
  public MultiCurrencyAmount presentValueNoSpreadPositiveNotional(final CouponIborSpread coupon, final MulticurveProviderInterface multicurves) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(multicurves, "Multi-curves");
