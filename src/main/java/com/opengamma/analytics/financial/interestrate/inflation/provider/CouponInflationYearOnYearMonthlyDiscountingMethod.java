...
public class CouponInflationYearOnYearMonthlyDiscountingMethod {
  ...
  public MultiCurrencyAmount netAmount(final CouponInflationYearOnYearMonthly coupon, final InflationProviderInterface inflation) {
   ...
   */
  public MultiCurrencyAmount presentValue(final CouponInflationYearOnYearMonthly coupon, final InflationProviderInterface inflation) {
    ArgChecker.notNull(coupon, "Coupon");
    ArgChecker.notNull(inflation, "Inflation");
