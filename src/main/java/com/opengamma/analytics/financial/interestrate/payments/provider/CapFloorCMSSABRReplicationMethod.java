...
public class CapFloorCMSSABRReplicationMethod extends CapFloorCMSSABRReplicationAbstractMethod {
   ...
   */
  @Override
  public MultiCurrencyAmount presentValue(final CapFloorCMS cmsCapFloor, final SABRSwaptionProviderInterface sabrData) {
    ArgChecker.notNull(cmsCapFloor, "CMA cap/floor");
    ...
    return MultiCurrencyAmount.of(cmsCapFloor.getCurrency(), priceCMS);
  }
