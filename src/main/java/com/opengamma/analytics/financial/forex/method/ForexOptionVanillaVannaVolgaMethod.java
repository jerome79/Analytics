...
public final class ForexOptionVanillaVannaVolgaMethod implements ForexPricingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForexOptionVanilla optionForex, final SmileDeltaTermStructureVannaVolgaDataBundle smile) {
    ...
    return MultiCurrencyAmount.of(pvCurrency);
  }
  ...
  public MultiCurrencyAmount presentValue(final InstrumentDerivative instrument, final YieldCurveBundle curves) {
    ...
    ArgChecker.isTrue(curves instanceof SmileDeltaTermStructureVannaVolgaDataBundle, "Smile delta data bundle required");
   ...
   */
  public MultiCurrencyAmount currencyExposure(final ForexOptionVanilla optionForex, final SmileDeltaTermStructureVannaVolgaDataBundle smile) {
    ArgChecker.notNull(optionForex, "Forex option");
    ArgChecker.notNull(smile, "Smile");
    ArgChecker.isTrue(smile.checkCurrencies(optionForex.getCurrency1(), optionForex.getCurrency2()), "Option currencies not compatible with smile data");
    final double dfDomestic = smile.getCurve(optionForex.getUnderlyingForex().getPaymentCurrency2().getFundingCurveName()).getDiscountFactor(optionForex.getUnderlyingForex().getPaymentTime());
