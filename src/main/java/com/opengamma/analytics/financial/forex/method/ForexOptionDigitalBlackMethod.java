...
public final class ForexOptionDigitalBlackMethod implements ForexPricingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForexOptionDigital optionForex, final SmileDeltaTermStructureDataBundle smile) {
    ...
    final double spot = smile.getFxRates().getRate(foreignCcy, domesticCcy);
   ...
   */
  public MultiCurrencyAmount currencyExposure(final ForexOptionDigital optionForex, final SmileDeltaTermStructureDataBundle smile) {
    ArgChecker.notNull(optionForex, "Forex option");
    ArgChecker.notNull(smile, "Smile");
    ArgChecker.isTrue(smile.checkCurrencies(optionForex.getCurrency1(), optionForex.getCurrency2()), "Option currencies not compatible with smile data");
    final double expiry = optionForex.getExpirationTime();
