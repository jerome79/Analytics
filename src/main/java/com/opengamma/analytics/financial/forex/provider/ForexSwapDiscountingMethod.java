...
public final class ForexSwapDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForexSwap fx, final MulticurveProviderInterface multicurves) {
    ArgChecker.notNull(fx, "Forex swap");
    ArgChecker.notNull(multicurves, "Multi-curves provider");
    final MultiCurrencyAmount pv = METHOD_FX.presentValue(fx.getNearLeg(), multicurves);
  ...
  public MultiCurrencyAmount currencyExposure(final ForexSwap fx, final MulticurveProviderInterface multicurves) {
