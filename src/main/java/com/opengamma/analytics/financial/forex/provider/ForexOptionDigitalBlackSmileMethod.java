...
public final class ForexOptionDigitalBlackSmileMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForexOptionDigital optionForex, final BlackForexSmileProviderInterface smileMulticurves) {
   ...
   */
  public MultiCurrencyAmount currencyExposure(final ForexOptionDigital optionForex, final BlackForexSmileProviderInterface smileMulticurves) {
    ArgChecker.notNull(optionForex, "Forex option");
    ArgChecker.notNull(smileMulticurves, "Smile");
    ArgChecker.isTrue(smileMulticurves.checkCurrencies(optionForex.getCurrency1(), optionForex.getCurrency2()), "Option currencies not compatible with smile data");
    final MulticurveProviderInterface multicurves = smileMulticurves.getMulticurveProvider();
