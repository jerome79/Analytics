...
public final class ForexNonDeliverableForwardDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final ForexNonDeliverableForward ndf, final MulticurveProviderInterface multicurves) {
    ArgChecker.notNull(ndf, "Non deliverable forward");
   ...
   */
  public MultiCurrencyAmount currencyExposure(final ForexNonDeliverableForward ndf, final MulticurveProviderInterface multicurves) {
    ArgChecker.notNull(ndf, "Non deliverable forward");
    ArgChecker.notNull(multicurves, "Multi-curves provider");
    final double df2 = multicurves.getDiscountFactor(ndf.getCurrency2(), ndf.getPaymentTime());
    final double df1 = multicurves.getDiscountFactor(ndf.getCurrency1(), ndf.getPaymentTime());
