...
public final class ForexDiscountingMethod implements ForexPricingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final Forex fx, final YieldCurveBundle curves) {
  ...
  @Override
  public MultiCurrencyAmount presentValue(final InstrumentDerivative derivative, final YieldCurveBundle curves) {
    ArgChecker.isTrue(derivative instanceof Forex, "Derivative should be Forex");
  ...
  public double forwardForexRate(final Forex fx, final YieldCurveBundle curves) {
    ...
    final double spot = curves.getFxRates().getRate(fx.getCurrency1(), fx.getCurrency2());
  ...
  public MultipleCurrencyInterestRateCurveSensitivity presentValueCurveSensitivity(final InstrumentDerivative instrument, final YieldCurveBundle curves) {
    ArgChecker.isTrue(instrument instanceof Forex, "Forex");
