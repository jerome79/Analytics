...
public final class ForexDiscountingMethod {
   ...
   */
  public MultiCurrencyAmount presentValue(final Forex fx, final MulticurveProviderInterface multicurves) {
    final MultiCurrencyAmount pv1 = METHOD_PAY.presentValue(fx.getPaymentCurrency1(), multicurves);
    final MultiCurrencyAmount pv2 = METHOD_PAY.presentValue(fx.getPaymentCurrency2(), multicurves);
    return pv1.plus(pv2);
  }
   ...
   * @return The multi-currency present value.
   */
  public MultiCurrencyAmount currencyExposure(final Forex fx, final MulticurveProviderInterface multicurves) {
