...
public class ISDAPremiumLegSchedule {
  ...
  public static LocalDate[] getUnadjustedDates(final LocalDate startDate, final LocalDate endDate, final Period step, final StubType stubType) {
    ...
    ArgChecker.isFalse(stubType == StubType.NONE, "NONE is not allowed as a stubType");
  ...
  private ISDAPremiumLegSchedule(final LocalDate[] nominalPaymentDates, final LocalDate[] paymentDates, final LocalDate[] accStartDates, final LocalDate[] accEndDates, final int index) {
    ...
    _nPayments = n - index;
    ArgChecker.isTrue(n == nominalPaymentDates.length, "nominalPaymentDates length of {} does not match paymentDates length of {}", nominalPaymentDates.length, _nPayments);
    ArgChecker.isTrue(n == accStartDates.length, "accStartDates length of {} does not match paymentDates length of {}", accStartDates.length, _nPayments);
    ArgChecker.isTrue(n == accEndDates.length, "accEndDates length of {} does not match paymentDates length of {}", accEndDates.length, _nPayments);
