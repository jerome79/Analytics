...
public class TrinomialTreeOptionPricingModel extends TreeOptionPricingModel {
  ...
  public double getPrice(LatticeSpecification lattice, OptionFunctionProvider1D function, double spot, double volatility, double interestRate, double dividend) {
    ArgChecker.notNull(lattice, "lattice");
    ArgChecker.notNull(function, "function");
    ArgChecker.isTrue(spot > 0., "Spot should be positive");
    ArgChecker.isTrue(Doubles.isFinite(spot), "Spot should be finite");
    ArgChecker.isTrue(volatility > 0., "volatility should be positive");
    ArgChecker.isTrue(Doubles.isFinite(volatility), "volatility should be finite");
    ArgChecker.isTrue(Doubles.isFinite(interestRate), "interestRate should be finite");
    ArgChecker.isTrue(Doubles.isFinite(dividend), "dividend should be finite");
    ...
    ArgChecker.isTrue(upProbability > 0., "upProbability should be greater than 0.");
    ArgChecker.isTrue(upProbability < 1., "upProbability should be smaller than 1.");
    ArgChecker.isTrue(middleProbability > 0., "middleProbability should be greater than 0.");
    ArgChecker.isTrue(middleProbability < 1., "middleProbability should be smaller than 1.");
    ArgChecker.isTrue(downProbability > 0., "downProbability should be greater than 0.");
  ...
  public double getPrice(OptionFunctionProvider1D function, double spot, double[] volatility, double[] interestRate, double[] dividend) {
    ...
    ArgChecker.notNull(interestRate, "interestRate");
    ArgChecker.notNull(dividend, "dividend");
    ...
    ArgChecker.isTrue(nSteps == interestRate.length, "Wrong interestRate length");
    ArgChecker.isTrue(nSteps == volatility.length, "Wrong volatility length");
    ArgChecker.isTrue(nSteps == dividend.length, "Wrong dividend length");

    for (int i = 0; i < nSteps; ++i) {
      ArgChecker.isTrue(volatility[i] > 0., "volatility should be positive");
      ArgChecker.isTrue(Doubles.isFinite(volatility[i]), "volatility should be finite");
      ArgChecker.isTrue(Doubles.isFinite(interestRate[i]), "interestRate should be finite");
      ArgChecker.isTrue(Doubles.isFinite(dividend[i]), "dividend should be finite");
    }
    ...
    for (int i = 0; i < nSteps; ++i) {
      ...
      ArgChecker.isTrue(upProbability[i] > 0., "upProbability should be greater than 0.");
      ArgChecker.isTrue(upProbability[i] < 1., "upProbability should be smaller than 1.");
      ArgChecker.isTrue(middleProbability[i] > 0., "middleProbability should be greater than 0.");
      ArgChecker.isTrue(middleProbability[i] < 1., "middleProbability should be smaller than 1.");
      ArgChecker.isTrue(downProbability[i] > 0., "downProbability should be greater than 0.");
    }
  ...
  public double getPrice(LatticeSpecification lattice, OptionFunctionProvider1D function, double spot, double volatility, double interestRate, DividendFunctionProvider dividend) {
    ...
    final double dt = timeToExpiry / nSteps;
    ArgChecker.isTrue(dividend.checkTimeSteps(dt), "Number of steps is too small");
    ArgChecker.isTrue(dividend.checkDividendBeforeExpiry(timeToExpiry), "Dividend is paid after expiry");
  ...
  public double getPrice(OptionFunctionProvider2D function, double spot1, double spot2, double volatility1, double volatility2, double correlation, double interestRate, double dividend1,
    ...
    ArgChecker.isTrue(spot1 > 0., "spot1 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(spot1), "spot1 should be finite");
    ArgChecker.isTrue(spot2 > 0., "spot2 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(spot2), "spot2 should be finite");
    ArgChecker.isTrue(volatility1 > 0., "volatility1 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(volatility1), "volatility1 should be finite");
    ArgChecker.isTrue(volatility2 > 0., "volatility2 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(volatility2), "volatility2 should be finite");
    ArgChecker.isTrue(correlation >= -1. && correlation <= 1., "correlation should be -1. <= rho <= 1.");
    ArgChecker.isTrue(Doubles.isFinite(interestRate), "interestRate should be finite");
    ArgChecker.isTrue(Doubles.isFinite(dividend1), "dividend1 should be finite");
    ArgChecker.isTrue(Doubles.isFinite(dividend2), "dividend2 should be finite");
