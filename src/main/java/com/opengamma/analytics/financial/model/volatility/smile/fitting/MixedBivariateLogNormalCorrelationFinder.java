...
public class MixedBivariateLogNormalCorrelationFinder {
  ...
  public void doFit(final double[] rhosGuess, final double[] dataStrikes, final double[] dataVolatilities, final double timeToExpiry, final double[] weights, final double[] sigmasX,
    ...
    ArgChecker.notNull(rhosGuess, "rhosGuess");
    ArgChecker.notNull(dataStrikes, "dataStrikes");
    ArgChecker.notNull(dataVolatilities, "dataVolatilities");
    ArgChecker.notNull(weights, "weights");
    ArgChecker.notNull(sigmasX, "sigmasX");
    ArgChecker.notNull(sigmasY, "sigmasY");
    ArgChecker.notNull(relativePartialForwardsX, "relativePartialForwardsX");
    ArgChecker.notNull(relativePartialForwardsY, "relativePartialForwardsY");

    final int nNormals = rhosGuess.length;
    final int nData = dataStrikes.length;

    ArgChecker.isTrue(dataStrikes.length == dataVolatilities.length, "dataStrikes not the same length as dataVols");
    ArgChecker.isTrue(weights.length == sigmasX.length, "weights not the same length as sigmasX");
    ArgChecker.isTrue(weights.length == sigmasY.length, "weights not the same length as sigmasY");
    ArgChecker.isTrue(weights.length == relativePartialForwardsX.length, "weights not the same length as relativePartialForwardsX");
    ArgChecker.isTrue(weights.length == relativePartialForwardsY.length, "weights not the same length as relativePartialForwardsY");

    for (int i = 0; i < nData; ++i) {
      ArgChecker.isFalse(Double.isNaN(dataStrikes[i]), "dataStrikes containing NaN");
      ArgChecker.isFalse(Double.isInfinite(dataStrikes[i]), "dataStrikes containing Infinity");
      ArgChecker.isFalse(Double.isNaN(dataVolatilities[i]), "dataVolatilities containing NaN");
      ArgChecker.isFalse(Double.isInfinite(dataVolatilities[i]), "dataVolatilities containing Infinity");
    }
    for (int i = 0; i < nNormals; ++i) {
      ArgChecker.isFalse(Double.isNaN(rhosGuess[i]), "rhosGuess containing NaN");
      ArgChecker.isFalse(Double.isInfinite(rhosGuess[i]), "rhosGuess containing Infinity");
      ArgChecker.isFalse(Double.isNaN(weights[i]), "weights containing NaN");
      ArgChecker.isFalse(Double.isInfinite(weights[i]), "weights containing Infinity");
      ArgChecker.isFalse(Double.isNaN(sigmasX[i]), "sigmasX containing NaN");
      ArgChecker.isFalse(Double.isInfinite(sigmasX[i]), "sigmasX containing Infinity");
      ArgChecker.isFalse(Double.isNaN(sigmasY[i]), "sigmasY containing NaN");
      ArgChecker.isFalse(Double.isInfinite(sigmasY[i]), "sigmasY containing Infinity");
      ArgChecker.isFalse(Double.isNaN(relativePartialForwardsX[i]), "relativePartialForwardsX containing NaN");
      ArgChecker.isFalse(Double.isInfinite(relativePartialForwardsX[i]), "relativePartialForwardsX containing Infinity");
      ArgChecker.isFalse(Double.isNaN(relativePartialForwardsY[i]), "relativePartialForwardsY containing NaN");
      ArgChecker.isFalse(Double.isInfinite(relativePartialForwardsY[i]), "relativePartialForwardsY containing Infinity");
    }
    ArgChecker.isFalse(Double.isNaN(timeToExpiry), "timeToExpiry containing NaN");
    ArgChecker.isFalse(Double.isInfinite(timeToExpiry), "timeToExpiry containing Infinity");
    ArgChecker.isFalse(Double.isNaN(forwardX), "forwardX containing NaN");
    ArgChecker.isFalse(Double.isInfinite(forwardX), "forwardX containing Infinity");
    ArgChecker.isFalse(Double.isNaN(forwardY), "forwardY containing NaN");
    ArgChecker.isFalse(Double.isInfinite(forwardY), "forwardY containing Infinity");

    ArgChecker.isTrue(timeToExpiry > 0, "timeToExpiry should be positive");
    ArgChecker.isTrue(forwardX > 0, "forwardX should be positive");
    ArgChecker.isTrue(forwardY > 0, "forwardY should be positive");
