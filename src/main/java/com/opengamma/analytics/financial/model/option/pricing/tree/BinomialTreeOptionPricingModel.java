...
public class BinomialTreeOptionPricingModel extends TreeOptionPricingModel {
  ...
  public double getPrice(final OptionFunctionProvider2D function, final double spot1, final double spot2, final double volatility1, final double volatility2, final double correlation,
    ...
    ArgChecker.isTrue(uuProbability > 0. && uuProbability < 1., "uuProbability should be 0 < p < 1.");
    ArgChecker.isTrue(udProbability > 0. && udProbability < 1., "udProbability should be 0 < p < 1.");
    ArgChecker.isTrue(duProbability > 0. && duProbability < 1., "duProbability should be 0 < p < 1.");
    ArgChecker.isTrue(ddProbability > 0. && ddProbability < 1., "ddProbability should be 0 < p < 1.");
