...
public class BenaimDodgsonKainthExtrapolationFunctionProvider extends SmileExtrapolationFunctionSABRProvider {
  ...
  public BenaimDodgsonKainthExtrapolationFunctionProvider(final double muLow, final double muHigh) {
    ArgChecker.isTrue(muLow > 0.0, "muLow should be positive");
    ArgChecker.isTrue(muHigh > 0.0, "muHigh should be positive");
    _muLow = muLow;
    _muHigh = muHigh;
  }
  ...
  public Function1D<Double, Double> getExtrapolationFunction(final SABRFormulaData sabrDataLow,
    ...
    ArgChecker.notNull(sabrDataLow, "sabrDataLow");
    ArgChecker.notNull(sabrDataHigh, "sabrDataHigh");
    ArgChecker.notNull(volatilityFunction, "volatilityFunction");
    ArgChecker.isTrue(0.0 < cutOffStrikeLow, "cutOffStrikeLow should be positive");
    ArgChecker.isTrue(cutOffStrikeLow < cutOffStrikeHigh, "cutOffStrikeLow < cutOffStrikeHigh should be satisfied");
