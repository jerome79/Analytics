...
public class MixedBivariateLogNormalFitter {
  ...
  public void doFit(final double[] paramsGuess, final double[] dataStrikes, final double[] dataVolatilities, final double timeToExpiry, final double forwardX, final double forwardY,
    ...
    ArgChecker.notNull(paramsGuess, "paramsGuess");
    ...
    ArgChecker.isTrue(nDataX < nData, "(dataX length) < (dataX length + dataY length)");
    ArgChecker.isTrue(dataStrikes.length == dataVolatilities.length, "dataStrikes not the same length as dataVols");
    ArgChecker.isTrue(nParams == 5 * nNormals - 3, "5 * N -3 free parameters");
    ...
    for (int i = 0; i < nParams; ++i) {
      ArgChecker.isFalse(Double.isNaN(paramsGuess[i]), "paramsGuess containing NaN");
      ArgChecker.isFalse(Double.isInfinite(paramsGuess[i]), "paramsGuess containing Infinity");
    }
    ...
    ArgChecker.isFalse(Double.isNaN(paramsGuessCorrection), "paramsGuessCorrection containing NaN");
    ArgChecker.isFalse(Double.isInfinite(paramsGuessCorrection), "paramsGuessCorrection containing Infinity");
    ...
    ArgChecker.isTrue(paramsGuessCorrection > 0, "paramsGuessCorrection should be positive");
