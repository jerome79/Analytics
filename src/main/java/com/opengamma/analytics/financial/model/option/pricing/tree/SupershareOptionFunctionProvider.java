...
public class SupershareOptionFunctionProvider extends OptionFunctionProvider1D {
  ...
  public SupershareOptionFunctionProvider(final double timeToExpiry, final double lowerBound, final double upperBound, final int steps) {
    ...
    ArgChecker.isTrue(upperBound > 0., "upperBound should be positive");
    ArgChecker.isTrue(Doubles.isFinite(upperBound), "upperBound should be finite");
    ArgChecker.isTrue(upperBound > lowerBound, "upperBound should be larger than lowerBound");
