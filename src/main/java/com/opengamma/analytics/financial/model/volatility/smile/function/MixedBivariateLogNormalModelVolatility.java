...
public class MixedBivariateLogNormalModelVolatility {
  ...
  public MixedBivariateLogNormalModelVolatility(final double[] weights, final double[] sigmasX, final double[] sigmasY, final double[] rhos) {
    ArgChecker.notNull(weights, "weights is Null");
    ArgChecker.notNull(sigmasX, "sigmasX is Null");
    ArgChecker.notNull(sigmasY, "sigmasY is Null");
    ArgChecker.notNull(rhos, "rhos is Null");

    ArgChecker.isTrue(sigmasX.length == sigmasY.length, "sigmasX must be the same length as sigmasY");
    ArgChecker.isTrue(sigmasX.length == rhos.length, "sigmasX must be the same length as rhos");
    ArgChecker.isTrue(sigmasX.length == weights.length, "sigmasX must be the same length as weights");
    ...
    for (int i = 0; i < nNormals; ++i) {
      ...
      ArgChecker.isFalse(Double.isNaN(rhos[i]), "rhos containing NaN");
      ArgChecker.isFalse(Double.isInfinite(rhos[i]), "rhos containing Infinity");
    }
  ...
  public MixedBivariateLogNormalModelVolatility(final double[] weights, final double[] sigmasX, final double[] sigmasY, final double[] relativePartialForwardsX,
    ...
    ArgChecker.notNull(sigmasX, "sigmasX is Null");
    ArgChecker.notNull(sigmasY, "sigmasY is Null");
    ArgChecker.notNull(relativePartialForwardsX, "relativePartialForwardsX is Null");
    ArgChecker.notNull(relativePartialForwardsY, "relativePartialForwardsY is Null");
    ArgChecker.notNull(rhos, "rhos is Null");

    ArgChecker.isTrue(sigmasX.length == sigmasY.length, "sigmasX must be the same length as sigmasY");
    ArgChecker.isTrue(sigmasX.length == rhos.length, "sigmasX must be the same length as rhos");
    ArgChecker.isTrue(sigmasX.length == weights.length, "sigmasX must be the same length as weights");
    ArgChecker.isTrue(sigmasX.length == relativePartialForwardsX.length, "sigmasX must be the same length as relativePartialForwardsX");
    ArgChecker.isTrue(sigmasX.length == relativePartialForwardsY.length, "sigmasX must be the same length as relativePartialForwardsY");
