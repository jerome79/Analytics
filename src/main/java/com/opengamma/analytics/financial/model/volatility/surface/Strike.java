...
public class Strike implements StrikeType, ImmutableBean, Serializable {
  ...
  ///CLOVER:OFF
  /**
   * The meta-bean for {@code Strike}.
   * @return the meta-bean, not null
   */
  public static Strike.Meta meta() {
    return Strike.Meta.INSTANCE;
  }
  ...
  public static class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Double> _value = DirectMetaProperty.ofImmutable(
        this, "value", Strike.class, Double.TYPE);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public BeanBuilder<? extends Strike> builder() {
      return new Strike.Builder();
    }

    @Override
    public Class<? extends Strike> beanType() {
      return Strike.class;
    }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code Strike}.
   */
  private static class Builder extends DirectFieldsBeanBuilder<Strike> {
