...
public class SmileInterpolatorSABRWithExtrapolation extends SmileInterpolatorSABR {
  ...
  public SmileInterpolatorSABRWithExtrapolation(
    ...
    ArgChecker.notNull(extrapolationFunctionProvider, "extrapolationFunctionProvider");
  ...
  public Function1D<Double, Double> getVolatilityFunction(final double forward, final double[] strikes,
    ...
    ArgChecker.notNull(impliedVols, "impliedVols");
    ArgChecker.isTrue(strikes.length == impliedVols.length, "strikes and impliedVols should have the same length");
