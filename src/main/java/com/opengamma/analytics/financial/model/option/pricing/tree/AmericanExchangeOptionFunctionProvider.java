...
public class AmericanExchangeOptionFunctionProvider extends OptionFunctionProvider2D {
  ...
  public AmericanExchangeOptionFunctionProvider(final double timeToExpiry, final int steps, final double quantity1, final double quantity2) {
    ...
    ArgChecker.isTrue(quantity1 > 0., "quantity1 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(quantity1), "quantity1 should be finite");
    ArgChecker.isTrue(quantity2 > 0., "quantity2 should be positive");
    ArgChecker.isTrue(Doubles.isFinite(quantity2), "quantity2 should be finite");
