...
public abstract class OptionFunctionProvider1D {
  ...
  public OptionFunctionProvider1D(final double strike, final double timeToExpiry, final int steps, final boolean isCall) {
    ArgChecker.isTrue(strike > 0., "strike should be positive");
    ArgChecker.isTrue(Doubles.isFinite(strike), "strike should be finite");
    ...
    ArgChecker.isTrue(steps > 2, "The number of steps should be greater than 2");
