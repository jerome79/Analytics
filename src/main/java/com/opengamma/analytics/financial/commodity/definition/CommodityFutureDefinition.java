...
public abstract class CommodityFutureDefinition<T extends InstrumentDerivative> implements InstrumentDefinitionWithData<T, Double> {
   ...
   */
  public CommodityFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public CommodityFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
