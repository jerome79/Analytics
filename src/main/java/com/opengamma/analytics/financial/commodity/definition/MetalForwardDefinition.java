...
public class MetalForwardDefinition extends CommodityForwardDefinition<MetalForward> {
   ...
   */
  public MetalForwardDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public MetalForwardDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName, final double referencePrice,
   ...
   * @return the forward
   */
  public static MetalForwardDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the forward
   */
  public static MetalForwardDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount,
