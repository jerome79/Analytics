...
public class MetalFutureDefinition extends CommodityFutureDefinition<MetalFuture> {
   ...
   */
  public MetalFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public MetalFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName, final double referencePrice,
   ...
   * @return the forward
   */
  public static MetalFutureDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the forward
   */
  public static MetalFutureDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount,
