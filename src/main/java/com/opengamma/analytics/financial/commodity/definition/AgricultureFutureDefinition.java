...
public class AgricultureFutureDefinition extends CommodityFutureDefinition<AgricultureFuture> {
   ...
   */
  public AgricultureFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate, final ZonedDateTime lastDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public AgricultureFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount,
   ...
   * @param settlementDate settlement date
   */
  public static AgricultureFutureDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
      final double referencePrice, final Currency currency, final ZonedDateTime settlementDate) {
   ...
   * @return the forward
   */
  public static AgricultureFutureDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount,
