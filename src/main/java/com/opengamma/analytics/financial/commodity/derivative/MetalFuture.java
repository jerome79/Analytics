...
public class MetalFuture extends CommodityFuture {
   ...
   */
  public MetalFuture(final double expiry, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate, final ZonedDateTime lastDeliveryDate,
