...
public class EnergyFutureDefinition extends CommodityFutureDefinition<EnergyFuture> {
   ...
   */
  public EnergyFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public EnergyFutureDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName, final double referencePrice,
   ...
   * @return the future
   */
  public static EnergyFutureDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the future
   */
  public static EnergyFutureDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount,
