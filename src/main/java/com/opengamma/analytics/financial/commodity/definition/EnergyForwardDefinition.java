...
public class EnergyForwardDefinition extends CommodityForwardDefinition<EnergyForward> {
   ...
   */
  public EnergyForwardDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
   ...
   * @param settlementDate settlement date
   */
  public EnergyForwardDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the forward
   */
  public static EnergyForwardDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
      final double referencePrice, final Currency currency, final ZonedDateTime settlementDate) {
   ...
   * @return the forward
   */
  public static EnergyForwardDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount,
