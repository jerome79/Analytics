...
public class AgricultureForwardDefinition extends CommodityForwardDefinition<AgricultureForward> {
   ...
   * @param settlementDate settlement date
   */
  public AgricultureForwardDefinition(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the forward
   */
  public static AgricultureForwardDefinition withCashSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final double amount, final String unitName,
   ...
   * @return the forward
   */
  public static AgricultureForwardDefinition withPhysicalSettlement(final ZonedDateTime expiryDate, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate,
