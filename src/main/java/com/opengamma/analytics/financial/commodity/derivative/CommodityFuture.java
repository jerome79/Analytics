...
public abstract class CommodityFuture implements InstrumentDerivative {
   ...
   */
  public CommodityFuture(final double expiry, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate, final ZonedDateTime lastDeliveryDate,
