...
public class MetalForward extends CommodityForward {
   ...
   */
  public MetalForward(final double expiry, final StandardId underlying, final double unitAmount, final ZonedDateTime firstDeliveryDate, final ZonedDateTime lastDeliveryDate,
