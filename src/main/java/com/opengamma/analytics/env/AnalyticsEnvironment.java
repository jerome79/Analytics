...
public final class AnalyticsEnvironment implements ImmutableBean {
  ...
  private final DayCount modelDayCount;
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final FixedAnnuityDefinitionBuilder fixedAnnuityDefinitionBuilder;
   ...
   */
  @PropertyDefinition(validate = "notNull")
  private final FloatingAnnuityDefinitionBuilder floatingAnnuityDefinitionBuilder;
  ...
  public static void setInstance(final AnalyticsEnvironment analyticsEnvironment) {
    ArgChecker.notNull(analyticsEnvironment, "analyticsEnvironment");
  ...
  private AnalyticsEnvironment(
    ...
    this.modelDayCount = modelDayCount;
    this.fixedAnnuityDefinitionBuilder = fixedAnnuityDefinitionBuilder;
    this.floatingAnnuityDefinitionBuilder = floatingAnnuityDefinitionBuilder;
  }
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<AnalyticsEnvironment> {
    ...
    private DayCount modelDayCount;
    private FixedAnnuityDefinitionBuilder fixedAnnuityDefinitionBuilder;
    private FloatingAnnuityDefinitionBuilder floatingAnnuityDefinitionBuilder;
    ...
    private Builder(AnalyticsEnvironment beanToCopy) {
      this.modelDayCount = beanToCopy.getModelDayCount();
      this.fixedAnnuityDefinitionBuilder = beanToCopy.getFixedAnnuityDefinitionBuilder();
      this.floatingAnnuityDefinitionBuilder = beanToCopy.getFloatingAnnuityDefinitionBuilder();
    }
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case 1885988124:  // modelDayCount
          this.modelDayCount = (DayCount) newValue;
          break;
        case -2010322942:  // fixedAnnuityDefinitionBuilder
          this.fixedAnnuityDefinitionBuilder = (FixedAnnuityDefinitionBuilder) newValue;
          break;
        case -1269173612:  // floatingAnnuityDefinitionBuilder
          this.floatingAnnuityDefinitionBuilder = (FloatingAnnuityDefinitionBuilder) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    public String toString() {
      ...
      buf.append("modelDayCount").append('=').append(JodaBeanUtils.toString(modelDayCount)).append(',').append(' ');
      buf.append("fixedAnnuityDefinitionBuilder").append('=').append(JodaBeanUtils.toString(fixedAnnuityDefinitionBuilder)).append(',').append(' ');
      buf.append("floatingAnnuityDefinitionBuilder").append('=').append(JodaBeanUtils.toString(floatingAnnuityDefinitionBuilder));
      buf.append('}');
      return buf.toString();
    }
