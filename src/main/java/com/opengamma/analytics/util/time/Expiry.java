...
public final class Expiry implements ImmutableBean, Serializable {
   ...
   */
  @PropertyDefinition(get = "manual", validate = "notNull")
  private final ExpiryAccuracy accuracy;
  ...
  @Override
  public int hashCode() {
    return (accuracy != null ? accuracy.hashCode() : 0) ^ expiry.hashCode();
  }

  @Override
  public String toString() {
    if (accuracy != null) {
      return "Expiry[" + expiry + " accuracy " + accuracy + "]";
    } else {
  ...
  private static final class Builder extends DirectFieldsBeanBuilder<Expiry> {
    ...
    private ExpiryAccuracy accuracy;
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -1289159373:  // expiry
          ...
          break;
        case -2131707655:  // accuracy
          this.accuracy = (ExpiryAccuracy) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    public String toString() {
      ...
      buf.append("accuracy").append('=').append(JodaBeanUtils.toString(accuracy));
      buf.append('}');
      return buf.toString();
    }
