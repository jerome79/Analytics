 ...
 */
package com.opengamma.analytics.util.timeseries;
...
public interface PreciseDoubleTimeSeries<T>
   ...
   */
  PreciseDoubleTimeSeries<T> operate(DoubleUnaryOperator operator);
   ...
   * @return a copy of this series with the operator applied, not null
   */
  PreciseDoubleTimeSeries<T> operate(double other, DoubleBinaryOperator operator);
   ...
   * @return a copy of this series with the operator applied, not null
   */
  PreciseDoubleTimeSeries<T> operate(PreciseDoubleTimeSeries<?> otherTimeSeries, DoubleBinaryOperator operator);
   ...
   * @return a copy of this series with the operator applied, not null
   */
  PreciseDoubleTimeSeries<T> unionOperate(PreciseDoubleTimeSeries<?> otherTimeSeries, DoubleBinaryOperator operator);
