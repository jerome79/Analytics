...
public class Diff {
  ...
  public static double[] values(final double[] v, final int t) {
    ArgChecker.notNull(v, "v");
    ArgChecker.isTrue((t > -1), "Invalid number of differences requested, t must be positive or 0. The given t was: " + t);
    ArgChecker.isTrue((t < v.length), "Invalid number of differences requested, 't' is greater than the number of elements in 'v'. The given 't' was: " + t + " and 'v' contains " +
        v.length + " elements.");
    double[] tmp;
