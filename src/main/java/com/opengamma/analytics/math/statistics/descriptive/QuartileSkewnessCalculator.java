 ...
 */
public class QuartileSkewnessCalculator implements Function<double[], Double> {
  ...
  public Double apply(final double[] x) {
    ...
    final double q1 = MEDIAN.apply(lower);
    final double q2 = MEDIAN.apply(x);
    final double q3 = MEDIAN.apply(upper);
