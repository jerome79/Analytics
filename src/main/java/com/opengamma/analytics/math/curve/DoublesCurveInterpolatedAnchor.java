...
public final class DoublesCurveInterpolatedAnchor extends InterpolatedDoublesCurve {
  ...
  public static DoublesCurveInterpolatedAnchor from(double[] xData, double[] yData, double anchor, Interpolator1D interpolator, String name) {
    ...
    ArgChecker.isTrue(xLength == yData.length, "Data of incorrect length.");
  ...
  public Double[] getYValueParameterSensitivity(Double x) {
    ...
    System.arraycopy(sensitivityWithAnchor, 0, sensitivity, 0, anchorIndex);
    System.arraycopy(sensitivityWithAnchor, anchorIndex + 1, sensitivity, anchorIndex, sensitivityWithAnchor.length - anchorIndex - 1);
    return sensitivity;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (anchorIndex != other.anchorIndex) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    ...
    result = prime * result + anchorIndex;
    return result;
  }
