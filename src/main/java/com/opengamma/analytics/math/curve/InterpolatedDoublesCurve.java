...
public class InterpolatedDoublesCurve extends ArraysDoublesCurve {
  ...
  private Interpolator1DDataBundle dataBundle;
  /**
   * The interpolator.
   */
  @PropertyDefinition(validate = "notNull", get = "manual", set = "private")
  ...
  public int hashCode() {
    ...
    result = prime * result + dataBundle.hashCode();
  ...
  public static class Meta extends ArraysDoublesCurve.Meta {
    ...
    protected void validate(Bean bean) {
      JodaBeanUtils.notNull(((InterpolatedDoublesCurve) bean).dataBundle, "dataBundle");
      JodaBeanUtils.notNull(((InterpolatedDoublesCurve) bean).interpolator, "interpolator");
      super.validate(bean);
    }
