...
public class ReferenceAmountTest {
  ...
  private static final Pair<String, Currency> STR1_USD = Pair.of(STR1, USD);
  private static final Pair<String, Currency> STR1_EUR = Pair.of(STR1, EUR);
  private static final Pair<String, Currency> STR2_USD = Pair.of(STR2, USD);
  private static final Pair<String, Currency> STR2_EUR = Pair.of(STR2, EUR);
