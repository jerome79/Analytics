...
public class PV01CurveParametersCalculatorTest {
  ...
  /** The PV calculator */
  private static final InstrumentDerivativeVisitor<ParameterProviderInterface, MultiCurrencyAmount> PV = PresentValueDiscountingCalculator.getInstance();
  /** The PV01 calculator */
  ...
  public void testApproximation() {
    ...
    MultiCurrencyAmount pv = SWAP_FIXED_IBOR.accept(PV, MULTICURVES);
    MultiCurrencyAmount pvUp = SWAP_FIXED_IBOR.accept(PV, SHIFTED);
    double expectedPV01 = pvUp.getAmount(Currency.USD).getAmount() - pv.getAmount(Currency.USD).getAmount();
    ...
    expectedPV01 = pvUp.getAmount(Currency.USD).getAmount() - pv.getAmount(Currency.USD).getAmount();
    assertEquals(0, (expectedPV01 - pv01) / expectedPV01, EPS_FIRST);
