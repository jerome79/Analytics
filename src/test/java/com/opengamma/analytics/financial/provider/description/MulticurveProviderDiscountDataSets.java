...
public class MulticurveProviderDiscountDataSets {
  ...
  private static final IndexPrice PRICE_INDEX_EUR = new IndexPrice(NAME_EUR_PRICE_INDEX, EUR);
  ...
  private static final IndexPrice PRICE_INDEX_GBP = new IndexPrice(NAME_GBP_PRICE_INDEX, GBP);
  ...
  private static final IndexPrice PRICE_INDEX_USD = new IndexPrice(NAME_USD_PRICE_INDEX, USD);
  ...
  private static final Pair<Object, LegalEntityFilter<LegalEntity>> ISSUER_UK_GOVT = Pair.of("UK GOVT", META);
  private static final Pair<Object, LegalEntityFilter<LegalEntity>> ISSUER_US_GOVT = Pair.of("US GOVT", META);
  private static final Pair<Object, LegalEntityFilter<LegalEntity>> ISSUER_AUD_GOVT = Pair.of("AUD GOVT", META);
  ...
  static {
    ...
    MARKET_1.setCurve(USD, USD_RATE_DSC);
    MARKET_1.setCurve(EUR, EUR_DSC);
    MARKET_1.setCurve(GBP, CURVE_GBP_35);
  ...
  static {
    SINGLECURVES_YIELD_USD.setCurve(USD, USD_RATE_DSC);
  ...
  static {
    SINGLECURVES_DF_USD.setCurve(USD, USD_DF_DSC);
  ...
  static {
    SINGLECURVES_PERF_USD.setCurve(USD, USD_PERF_DSC);
  ...
  static {
    ...
    MULTICURVES_EUR_USD.setCurve(USD, USD_RATE_DSC);
    MULTICURVES_EUR_USD.setCurve(FEDFUND, USD_RATE_DSC);
    MULTICURVES_EUR_USD.setCurve(EUR, EUR_DSC);
  ...
  static {
    MULTICURVES_GBP_USD.setCurve(USD, USD_RATE_DSC);
    ...
    MULTICURVES_GBP_USD.setCurve(GBP, CURVE_GBP_30);
  ...
  static {
    SINGLECURVES_GBP.setCurve(GBP, GBP_SINGLE);
  ...
  static {
    ISSUER_CURVES.put(Pair.of(ISSUER_NAME, META), EUR_ISSUER);
  }
  ...
  public static InflationIssuerProviderDiscount createMarket1(final ZonedDateTime pricingDate) {
    ...
    market.setCurve(USD, USD_RATE_DSC);
    market.setCurve(EUR, EUR_DSC);
    market.setCurve(GBP, CURVE_GBP_35);
  ...
  */
  ...
  public static MulticurveProviderDiscount createMulticurveEUR() {
    ...
    provideurEUR.setCurve(EUR, EUR_DSC);
