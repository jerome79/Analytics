...
public class MulticurveProviderDiscountTest {
  ...
  public void testAddingDifferentForwardIborCurveWithSameIndexFails() {
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.IBOR_INDEX_1, mockCurve("test"));
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.IBOR_INDEX_1, mockCurve("test2"));
  }

  @Test
  public void testAddingSameForwardIborCurveWithSameIndexSucceeds() {
    YieldAndDiscountCurve test = mockCurve("test");
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.IBOR_INDEX_1, test);
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.IBOR_INDEX_1, test);
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testAddingDifferentForwardONCurveWithSameIndexFails() {
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.INDEX_ON, mockCurve("test"));
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.INDEX_ON, mockCurve("test2"));
  }

  @Test
  public void testAddingSameForwardONCurveWithSameIndexSucceeds() {
    YieldAndDiscountCurve test = mockCurve("test");
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.INDEX_ON, test);
    _provider.setCurve(TestInstrumentDefinitionsAndDerivatives.INDEX_ON, test);
  }
