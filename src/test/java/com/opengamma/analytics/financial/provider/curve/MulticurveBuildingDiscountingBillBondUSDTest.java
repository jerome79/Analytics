...
public class MulticurveBuildingDiscountingBillBondUSDTest {
  ...
  private static final IssuerProviderDiscount KNOWN_DATA = new IssuerProviderDiscount(KNOWN_MULTICURVES, new HashMap<>());
  ...
  static {
    ...
    DSC_ISS_MAP.put(CURVE_NAME_GOVTUS_USD, Pair.of(NAME_COUNTERPART, new LegalEntityShortName()));
  }
