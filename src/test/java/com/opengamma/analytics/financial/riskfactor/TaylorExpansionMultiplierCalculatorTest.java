...
public class TaylorExpansionMultiplierCalculatorTest {
  ...
  static {
    ...
    X = ImmutableZonedDateTimeDoubleTimeSeries.of(T, X_DATA, UTC);
    Y = ImmutableZonedDateTimeDoubleTimeSeries.of(T, Y_DATA, UTC);
  ...
  public void testWrongTSTimes() {
    ...
    final DoubleTimeSeries<?> ts = ImmutableZonedDateTimeDoubleTimeSeries.of(t, z, UTC);
    final Map<UnderlyingType, DoubleTimeSeries<?>> m = new HashMap<>();
    m.put(UnderlyingType.SPOT_PRICE, X);
  ...
  public void test() {
    ...
    assertTimeSeriesEquals((PreciseDoubleTimeSeries<?>) getTimeSeries(UNDERLYING_DATA, SECOND_ORDER), ImmutableZonedDateTimeDoubleTimeSeries.of(T, x2, UTC));
    assertTimeSeriesEquals((PreciseDoubleTimeSeries<?>) getTimeSeries(UNDERLYING_DATA, THIRD_ORDER), ImmutableZonedDateTimeDoubleTimeSeries.of(T, x3, UTC));
    assertTimeSeriesEquals((PreciseDoubleTimeSeries<?>) getTimeSeries(UNDERLYING_DATA, FOURTH_ORDER), ImmutableZonedDateTimeDoubleTimeSeries.of(T, x4, UTC));
    assertTimeSeriesEquals((PreciseDoubleTimeSeries<?>) getTimeSeries(UNDERLYING_DATA, FIFTH_ORDER), ImmutableZonedDateTimeDoubleTimeSeries.of(T, x5, UTC));
    assertTimeSeriesEquals((PreciseDoubleTimeSeries<?>) getTimeSeries(UNDERLYING_DATA, MIXED_ORDER), ImmutableZonedDateTimeDoubleTimeSeries.of(T, x6, UTC));
  }
