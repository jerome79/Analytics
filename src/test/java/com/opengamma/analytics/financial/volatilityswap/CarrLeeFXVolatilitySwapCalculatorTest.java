...
public class CarrLeeFXVolatilitySwapCalculatorTest {
  ...
  public void flatVolSmileTest() {
    ...
    try {
      final FxMatrix fxMatrixNegativeSpot = FxMatrix.builder().addRate(base, counter, -spot).build();
      ...
      final CarrLeeFXData dataNegativeSpot = new CarrLeeFXData(Pair.of(base, counter), smile, curvesNegativeSpot, realizedVar);
