...
public class JarrowRuddSkewnessKurtosisModelTest {
  ...
  static {
    SKEW = new LognormalSkewnessFromVolatilityCalculator().applyAsDouble(SIGMA, T);
    KURTOSIS = new LognormalFisherKurtosisFromVolatilityCalculator().applyAsDouble(SIGMA, T) + 3;
