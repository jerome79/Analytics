...
public class DayPeriodPreCalculatedDiscountCurveTest {
  ...
  public void testWithSwap() {
    ...
    final MultiCurrencyAmount pvCalcCpn3_WITH_PRECALCULATED_DISCOUNT = CPN_IBOR_3.accept(PVDC, MULTICURVES_WITH_PRECALCULATED_DISCOUNT);
    final MultiCurrencyAmount pvMethCpn3_WITH_PRECALCULATED_DISCOUNT = METHOD_CPN_IBOR.presentValue(CPN_IBOR_3, MULTICURVES_WITH_PRECALCULATED_DISCOUNT);
    final MultiCurrencyAmount pvCalcCpn6_WITH_PRECALCULATED_DISCOUNT = CPN_IBOR_6.accept(PVDC, MULTICURVES_WITH_PRECALCULATED_DISCOUNT);
    final MultiCurrencyAmount pvMethCpn6_WITH_PRECALCULATED_DISCOUNT = METHOD_CPN_IBOR.presentValue(CPN_IBOR_6, MULTICURVES_WITH_PRECALCULATED_DISCOUNT);
