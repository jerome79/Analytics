...
/**
 * Test {@link CashOrNothingOptionPriceFunction}.
 */
@Test
public class CashOrNothingOptionPriceFunctionTest {

  private static final CashOrNothingOptionPriceFunction PRICER = new CashOrNothingOptionPriceFunction();
  ...
  public void test_price() {
    ...
    double d2 = (Math.log(FORWARD1 / STRIKE) - 0.5 * VOLATILITY * VOLATILITY * TIME) / VOLATILITY / Math.sqrt(TIME);
    double callExpected = NORMAL.getCDF(d2);
    ...
    double putExpected = NORMAL.getCDF(-d2);
  ...
  public void test_delta() {
    ...
    double expiryComputed = PRICER.delta(FORWARD1, STRIKE, 0d, VOLATILITY, true);
