...
public class BlackDermanToyYieldOnlyInterestRateModelTest {
  ...
  public void test() {
    ...
    expected[0][0] = Triple.of(0.05, 0.9524, 1.0);
    expected[1][0] = Triple.of(0.045, 0.9569, 0.4762);
    expected[1][1] = Triple.of(0.055, 0.9479, 0.4762);
    expected[2][0] = Triple.of(0.0406, 0.9610, 0.2278);
    expected[2][1] = Triple.of(0.0496, 0.9528, 0.4535);
    expected[2][2] = Triple.of(0.0605, 0.9430, 0.2257);
    expected[3][0] = Triple.of(0.0366, 0.9647, 0.1095);
    expected[3][1] = Triple.of(0.0447, 0.9572, 0.3255);
    expected[3][2] = Triple.of(0.0546, 0.9482, 0.3224);
    expected[3][3] = Triple.of(0.0667, 0.9375, 0.1064);
