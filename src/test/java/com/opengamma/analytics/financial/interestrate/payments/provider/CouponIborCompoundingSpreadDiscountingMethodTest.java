...
public class CouponIborCompoundingSpreadDiscountingMethodTest {
  ...
  public void presentValueBeforeFirstFixing() {
    ...
    assertEquals("CouponIborCompoundedDiscounting: Present value", pvExpected, pvComputed.getAmount(CAD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("CouponIborCompoundedDiscounting: Present value", pvMethod.getAmount(CAD).getAmount(), pvCalculator.getAmount(CADCDOR3M.getCurrency()).getAmount(), TOLERANCE_PV);
