...
public class CapFloorInflationZeroCouponInterpolationBlackSmileMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pv = METHOD.presentValue(ZERO_COUPON_CAP, BLACK_INFLATION);
    ...
    assertEquals("Zero-coupon inflation DiscountingMethod: Present value", pvExpected, pv.getAmount(ZERO_COUPON_CAP.getCurrency()).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD.presentValue(ZERO_COUPON_CAP, BLACK_INFLATION);
    final MultiCurrencyAmount pvCalculator = ZERO_COUPON_CAP.accept(PVIC, BLACK_INFLATION);
  ...
  public void presentValueSeasonality() {
    ...
    final MultiCurrencyAmount pvInflation = METHOD.presentValue(capZeroCouponUsd, blackInflation);
