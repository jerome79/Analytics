...
public class SwapInflationZeroCouponDiscountingMethodE2ETest {
  ...
  public void presentValue() {
    // Present Value
    final MultiCurrencyAmount pvComputed = SWAP.accept(PVDIC, INFLATION_MULTICURVE_STD);
    final MultiCurrencyAmount pvExpected = MultiCurrencyAmount.of(Currency.GBP, -21922.072817862267);
    assertEquals("ForwardRateAgreementDiscountingMethod: present value from standard curves", pvExpected.getAmount(CUR).getAmount(), pvComputed.getAmount(CUR).getAmount(), 5.00);
  }
