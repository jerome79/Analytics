...
public class SwapCrossCurrencyUsdGbpE2ETest {  
  ...
  public void BucketedPV01Irs1Usd() {
    ...
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USD), USD), new DoubleMatrix1D(deltaDsc));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USDLIBOR3M), USD), new DoubleMatrix1D(deltaFwd3));
  ...
  public void BucketedPV01XCcyGbpUsd() {
    ...
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USD), USD), new DoubleMatrix1D(deltaDscUsdUsd));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USDLIBOR3M), USD), new DoubleMatrix1D(deltaFwd3UsdUsd));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USD), GBP), new DoubleMatrix1D(deltaDscUsdGbp));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(USDLIBOR3M), GBP), new DoubleMatrix1D(deltaFwd3UsdGbp));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(GBP), GBP), new DoubleMatrix1D(deltaDscGbpGbp));
    sensitivity.put(Pair.of(MULTICURVE_FFCOL.getName(GBPLIBOR3M), GBP), new DoubleMatrix1D(deltaFwd3GbpGbp));
