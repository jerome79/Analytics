...
public class CouponONTest {
  ...
  private static final double PAYMENT_YEAR_FRACTION = DayCountUtils.yearFraction(EUR_DAY_COUNT, START_ACCRUAL_DATE, END_ACCRUAL_DATE);
  ...
  private static final double FIXING_YEAR_FRACTION_2 = DayCountUtils.yearFraction(EUR_DAY_COUNT, NEXT_FIXING_DATE_2, END_ACCRUAL_DATE);
