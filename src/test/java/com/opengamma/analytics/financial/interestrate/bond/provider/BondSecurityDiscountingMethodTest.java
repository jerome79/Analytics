...
public class BondSecurityDiscountingMethodTest {
  ...
  public void presentValueFixedMiddleIssuer() {
    ...
    final MultiCurrencyAmount pvNominal = nominal.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = coupon.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvNominal.getAmount(CUR).getAmount() + pvCoupon.getAmount(CUR).getAmount(), pv.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFixedMiddleCountry() {
    ...
    final MultiCurrencyAmount pvNominal = nominal.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = coupon.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1, COUNTRY_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvNominal.getAmount(CUR).getAmount() + pvCoupon.getAmount(CUR).getAmount(), pv.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFixedMiddleCurrency() {
    ...
    final MultiCurrencyAmount pvNominal = nominal.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = coupon.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1, CURRENCY_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvNominal.getAmount(CUR).getAmount() + pvCoupon.getAmount(CUR).getAmount(), pv.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFixedMiddleCountryRating() {
    ...
    final MultiCurrencyAmount pvNominal = nominal.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = coupon.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1, COUNTRY_RATING_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvNominal.getAmount(CUR).getAmount() + pvCoupon.getAmount(CUR).getAmount(), pv.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFixedOnCoupon() {
    ...
    final MultiCurrencyAmount pvNominal = nominal.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pvCoupon = coupon.accept(PVDC, multicurvesDecorated);
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_2, ISSUER_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvNominal.getAmount(CUR).getAmount() + pvCoupon.getAmount(CUR).getAmount(), pv.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValueFixedMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = BOND_FIXED_SECURITY_NO_ENTITY_1.accept(PVIC, ISSUER_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value Method vs Calculator", pvMethod.getAmount(CUR).getAmount(), pvCalculator.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFromZSpread() {
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES);
    double zSpread = 0.0;
    MultiCurrencyAmount pvZ = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpread);
    assertEquals("Fixed coupon bond security: present value from z-spread", pv.getAmount(CUR).getAmount(), pvZ.getAmount(CUR).getAmount(), TOLERANCE_PV);
    ...
    MultiCurrencyAmount pvZExpected = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_NO_ENTITY_1, issuerShifted);
    assertEquals("Fixed coupon bond security: present value from z-spread", pvZExpected.getAmount(CUR).getAmount(), pvZ.getAmount(CUR).getAmount(), TOLERANCE_PV);
  ...
  public void presentValueZSpreadSensitivity() {
    ...
    final MultiCurrencyAmount pvZUp = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpread + shift);
    final MultiCurrencyAmount pvZDown = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpread - shift);
    assertEquals("Fixed coupon bond security: present value z-spread sensitivity", (pvZUp.getAmount(CUR).getAmount() - pvZDown.getAmount(CUR).getAmount()) / (2 * shift), pvzs, TOLERANCE_PV_DELTA);
  }
  ...
  public void presentValueFromCleanPrice() {
    ...
    final MultiCurrencyAmount pvClean = METHOD_BOND_SECURITY.presentValueFromCleanPrice(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES.getMulticurveProvider(), cleanPrice);
    final MultiCurrencyAmount pvCleanExpected = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES);
    assertEquals("Fixed coupon bond security: present value", pvCleanExpected.getAmount(CUR).getAmount(), pvClean.getAmount(CUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void zSpreadFromPresentValue() {
    ...
    final MultiCurrencyAmount pvZSpread = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpreadExpected);
    ...
    final MultiCurrencyAmount pvZSpread3 = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpreadExpected3);
  ...
  public void zSpreadSensitivityFromPresentValue() {
    ...
    final MultiCurrencyAmount pvZSpread = METHOD_BOND_SECURITY.presentValueFromZSpread(BOND_FIXED_SECURITY_NO_ENTITY_1, ISSUER_SPECIFIC_MULTICURVES, zSpread);
  ...
  public void dirtyPriceFixed() {
    ...
    assertEquals("Fixed coupon bond security: dirty price from curves", pv.getAmount(CUR).getAmount() / df / BOND_FIXED_SECURITY_NO_ENTITY_1.getCoupon().getNthPayment(0).getNotional(), dirty);
  ...
  public void dirtyPriceCurveSensitivity() {
    ...
    assertEquals("Fixed coupon bond security: dirty price curve sensitivity: repo curve", BOND_FIXED_SECURITY_NO_ENTITY_1.getCoupon().getNthPayment(0).getPaymentTime(), sensi
        ...
        .get(ISS_CURVE_NAME).get(0).getFirst(), TOLERANCE_PV_DELTA);
    assertEquals("Fixed coupon bond security: dirty price curve sensitivity: repo curve", -BOND_FIXED_SECURITY_NO_ENTITY_1.getCoupon().getNthPayment(0).getPaymentTime()
        * BOND_FIXED_SECURITY_NO_ENTITY_1.getCoupon().getNthPayment(0).getAmount() * dfCpn0 / dfSettle / NOTIONAL, sensi.getYieldDiscountingSensitivities().get(ISS_CURVE_NAME).get(0).getSecond(),
        TOLERANCE_PV_DELTA);
  }
  ...
  public void presentValueFixedExDividend() {
    final MultiCurrencyAmount pv = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_UK, ISSUER_SPECIFIC_MULTICURVES);
    ...
    final MultiCurrencyAmount pvNoEx = METHOD_BOND_SECURITY.presentValue(BondNoEx, ISSUER_SPECIFIC_MULTICURVES);
    ...
    final MultiCurrencyAmount pvCpn = couponDefinitionEx.toDerivative(REFERENCE_DATE_3).accept(PVDC, multicurvesDecorated);
    assertEquals("Fixed coupon bond security: present value ex dividend", pvNoEx.getAmount(GBP).getAmount() - pvCpn.getAmount(GBP).getAmount(), pv.getAmount(GBP).getAmount(), TOLERANCE_PV);
  }
  ...
  public void dirtyPriceFixedExDividend() {
    ...
    assertEquals("Fixed coupon bond security: dirty price from curves", pv.getAmount(GBP).getAmount() / df / BOND_FIXED_SECURITY_UK.getCoupon().getNthPayment(0).getNotional(), dirty);
    assertTrue("Fixed coupon bond security: dirty price is relative price", (0.50 < dirty) & (dirty < 2.0));
  }
  ...
  public void annualyCompoundedRateTest() {
    ...
    issuerProvider.setCurve(Pair.of((Object) ISSUER.getShortName(), filter), baseIssuerCurve);
    issuerProvider.setCurve(CUR, baseDiscountCurve);

    /* PV */
    MultiCurrencyAmount pvAnnual = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1,
        issuerProvider);
    MultiCurrencyAmount pvContinuous = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1,
    ...
    assertRelative("annualyCompoundedRateTest", pvContinuous.getAmount(CUR).getAmount(), pvAnnual.getAmount(CUR).getAmount(), REL_TOL);

    /* PV via calculator */
    PresentValueIssuerCalculator calc = PresentValueIssuerCalculator.getInstance();
    MultiCurrencyAmount pvAnnualVisit = BOND_FIXED_SECURITY_FULL_ENTITY_1.accept(calc, issuerProvider);
    assertRelative("annualyCompoundedRateTest", pvAnnual.getAmount(CUR).getAmount(), pvAnnualVisit.getAmount(CUR).getAmount(), REL_TOL_ID);
    ...
    MultiCurrencyAmount pvAnnualSpread1 = METHOD_BOND_SECURITY.presentValue(BOND_FIXED_SECURITY_FULL_ENTITY_1,
        issuerSpread);
    MultiCurrencyAmount pvAnnualSpread2 = METHOD_BOND_SECURITY.presentValueFromZSpread(
        BOND_FIXED_SECURITY_FULL_ENTITY_1, issuerProvider, spread, true, 1);
    assertRelative("annualyCompoundedRateTest", pvAnnualSpread1.getAmount(CUR).getAmount(), pvAnnualSpread2.getAmount(CUR).getAmount(),
        REL_TOL_ID);
    ...
    AssertSensitivityObjects.assertEquals("annualyCompoundedRateTest", senseZeroSpread, senseTinySpread,
        pvAnnual.getAmount(CUR).getAmount() * REL_TOL);
    ...
    double dirtyAnnual = METHOD_BOND_SECURITY.dirtyPriceFromCurves(BOND_FIXED_SECURITY_FULL_ENTITY_1,
        issuerProvider);
    double factorSpread = pvAnnualSpread1.getAmount(CUR).getAmount() / dirtySpread1;
    double factorNoSpread = pvAnnual.getAmount(CUR).getAmount() / dirtyAnnual;
