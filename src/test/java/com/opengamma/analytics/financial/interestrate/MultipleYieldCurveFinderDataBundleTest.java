...
public class MultipleYieldCurveFinderDataBundleTest {
  ...
  static {
    ...
    for (int i = 0; i < n; i++) {
      ...
      DERIVATIVES.add(new Cash(AUD, 0, t1, 1, Math.random(), t1, CURVE_NAME1));
      DERIVATIVES.add(new Cash(AUD, 0, t2, 1, Math.random(), t2, CURVE_NAME2));
      TIMES1[i] = t1;
      TIMES2[i] = t2;
      PAR_RATES[i] = 0.05;
      PAR_RATES[n + i] = 0.05;
  ...
  public void testEqualsAndHashCode() {
    ...
    derivatives.set(0, new Cash(AUD, 0, 1000, 1, 0.05, 1000, CURVE_NAME1));
