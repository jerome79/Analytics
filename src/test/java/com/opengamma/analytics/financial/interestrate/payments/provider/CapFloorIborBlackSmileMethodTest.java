...
public class CapFloorIborBlackSmileMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount methodPrice = METHOD_CAP_BLACK.presentValue(CAP_LONG, BLACK_MULTICURVES);
  ...
  public void presentValueParity() {
    final double priceCapLong = METHOD_CAP_BLACK.presentValue(CAP_LONG, BLACK_MULTICURVES).getAmount(EUR).getAmount();
    final double priceCapShort = METHOD_CAP_BLACK.presentValue(CAP_SHORT, BLACK_MULTICURVES).getAmount(EUR).getAmount();
    assertEquals("Cap/floor - SABR pricing: long/short parity", -priceCapLong, priceCapShort, TOLERANCE_PV);
    final double priceFloorShort = METHOD_CAP_BLACK.presentValue(FLOOR_SHORT, BLACK_MULTICURVES).getAmount(EUR).getAmount();
