...
public class CouponFixedCompoundingDiscountingMethodTest {
  ...
  public void presentValueMarketDiscount() {
    final MultiCurrencyAmount pvComputed = METHOD_COUPON.presentValue(COUPON, MULTICURVES);
    ...
    assertEquals("CouponIborDiscountingMarketMethod: present value", pvExpected, pvComputed.getAmount(COUPON.getCurrency()).getAmount(), TOLERANCE_PV);
  }
