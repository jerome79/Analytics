...
public class CapFloorIborSABRMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount methodPrice = METHOD_CAP_SABR.presentValue(CAP_LONG, SABR_MULTICURVES);
    ...
    assertEquals("Cap/floor: SABR pricing", expectedPrice, methodPrice.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    final double expectedPv = METHOD_CAP_SABR.presentValue(CAP_LONG, SABR_MULTICURVES).getAmount(EUR).getAmount();
    final double pv = CAP_LONG.accept(PVSCC, SABR_MULTICURVES).getAmount(EUR).getAmount();
  ...
  public void presentValueParity() {
    final double priceCapLong = METHOD_CAP_SABR.presentValue(CAP_LONG, SABR_MULTICURVES).getAmount(EUR).getAmount();
    final double priceCapShort = METHOD_CAP_SABR.presentValue(CAP_SHORT, SABR_MULTICURVES).getAmount(EUR).getAmount();
    assertEquals("Cap/floor - SABR pricing: long/short parity", -priceCapLong, priceCapShort, TOLERANCE_PV);
    final double priceFloorShort = METHOD_CAP_SABR.presentValue(FLOOR_SHORT, SABR_MULTICURVES).getAmount(EUR).getAmount();
    final double priceIbor = COUPON_IBOR.accept(PVC, MULTICURVES).getAmount(EUR).getAmount();
    final double priceStrike = COUPON_STRIKE.accept(PVC, MULTICURVES).getAmount(EUR).getAmount();
  ...
  public void presentValueSABRSensitivity() {
    final double pv = METHOD_CAP_SABR.presentValue(CAP_LONG, SABR_MULTICURVES).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerAlphaBumped = METHOD_CAP_SABR.presentValue(CAP_LONG, sabrBundleAlphaBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerRhoBumped = METHOD_CAP_SABR.presentValue(CAP_LONG, sabrBundleRhoBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerNuBumped = METHOD_CAP_SABR.presentValue(CAP_LONG, sabrBundleNuBumped).getAmount(EUR).getAmount();
