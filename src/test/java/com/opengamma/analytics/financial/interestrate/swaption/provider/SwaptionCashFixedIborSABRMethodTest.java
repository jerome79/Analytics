...
public class SwaptionCashFixedIborSABRMethodTest {
  ...
  public void presentValue() {
    ...
    final MultiCurrencyAmount priceShortPayer = SWAPTION_SHORT_PAYER.accept(PVSSC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiver = SWAPTION_LONG_RECEIVER.accept(PVSSC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortReceiver = SWAPTION_SHORT_RECEIVER.accept(PVSSC, SABR_MULTICURVES);
    // From previous run
    final double expectedPriceLongPayer = 2419978.690;
    assertEquals("SwaptionCashFixedIborSABRMethod: presentValue", expectedPriceLongPayer, priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    ...
    assertEquals("SwaptionCashFixedIborSABRMethod: presentValue", expectedPrice, priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    // Long/Short parity
    assertEquals("SwaptionCashFixedIborSABRMethod: presentValue", priceLongPayer.getAmount(EUR).getAmount(), -priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("SwaptionCashFixedIborSABRMethod: presentValue", priceLongReceiver.getAmount(EUR).getAmount(), -priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
  ...
  public void presentValueWithPremium() {
    ...
    final MultiCurrencyAmount pvPremium = premium.accept(PVDC, MULTICURVES);
    final MultiCurrencyAmount swaptionPV = SWAPTION_LONG_PAYER.accept(PVSSC, SABR_MULTICURVES);
    assertEquals("swaption present value with premium", -expectedPriceLongPayer, pvPremium.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("swaption present value with premium", expectedPriceLongPayer, swaptionPV.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueSABRSensitivity() {
    ...
    final double pvLongPayer = METHOD_SWPT_CASH.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerAlphaBumped = METHOD_SWPT_CASH.presentValue(SWAPTION_LONG_PAYER, sabrBundleAlphaBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerRhoBumped = METHOD_SWPT_CASH.presentValue(SWAPTION_LONG_PAYER, sabrBundleRhoBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerNuBumped = METHOD_SWPT_CASH.presentValue(SWAPTION_LONG_PAYER, sabrBundleNuBumped).getAmount(EUR).getAmount();
