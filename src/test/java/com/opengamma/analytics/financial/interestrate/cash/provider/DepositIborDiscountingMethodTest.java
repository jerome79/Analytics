...
public class DepositIborDiscountingMethodTest {
  ...
  public void presentValueTrade() {
    ...
    final MultiCurrencyAmount pvComputed = METHOD_DEPOSIT.presentValue(deposit, PROVIDER_MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final ZonedDateTime referenceDate = DateUtils.getUTCDate(2011, 12, 12);
    final DepositIbor deposit = DEPOSIT_IBOR_DEFINITION.toDerivative(referenceDate);
    final MultiCurrencyAmount pvMethod = METHOD_DEPOSIT.presentValue(deposit, PROVIDER_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = deposit.accept(PVC, PROVIDER_MULTICURVES);
  ...
  public void parSpreadBeforeStart() {
    ...
    final MultiCurrencyAmount pv0 = METHOD_DEPOSIT.presentValue(deposit0, PROVIDER_MULTICURVES);
