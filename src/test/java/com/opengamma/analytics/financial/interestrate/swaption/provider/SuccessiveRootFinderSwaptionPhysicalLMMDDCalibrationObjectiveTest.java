...
public class SuccessiveRootFinderSwaptionPhysicalLMMDDCalibrationObjectiveTest {
  ...
  public void calibration() {
    ...
    final MultiCurrencyAmount[] pvSabr = new MultiCurrencyAmount[SWAP_TENOR_YEAR.length];
    final MultiCurrencyAmount[] pvLmm = new MultiCurrencyAmount[SWAP_TENOR_YEAR.length];
    for (int loopexp = 0; loopexp < SWAP_TENOR_YEAR.length; loopexp++) {
