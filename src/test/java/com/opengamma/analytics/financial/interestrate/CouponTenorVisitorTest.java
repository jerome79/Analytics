...
public class CouponTenorVisitorTest {
  ...
  private static final InstrumentDefinitionVisitor<Void, Set<ComparableTenor>> INSTANCE = CouponTenorVisitor.getInstance();
  ...
  public void testCouponIborDefinition() {
    assertEquals("Expected index tenor",
                 ComparableTenor.of(USD_LIBOR_3M.getTenor()),
  ...
  public void testCouponIborAverageIndexDefinition() {
    ...
    assertEquals("Expected two tenors", Sets.newHashSet(ComparableTenor.of(USD_LIBOR_3M.getTenor()),
                                                        ComparableTenor.of(USD_LIBOR_6M.getTenor())),
  ...
  public void testCouponONDefinition() {
    ...
    assertEquals("Expected ON tenor", ComparableTenor.ON, Iterables.getOnlyElement(coupon.accept(INSTANCE)));
  }
