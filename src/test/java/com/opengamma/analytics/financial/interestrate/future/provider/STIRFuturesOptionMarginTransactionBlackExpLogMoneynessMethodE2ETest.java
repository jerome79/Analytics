...
public class STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethodE2ETest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvComputed1 = CALL_ERZ4_099_TRA_1.accept(PVBFOC, MULTICURVE_BLACK);
    double pvExpected1 = -390258.6663437139;
    assertEquals("STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethodE2ETest",
        pvComputed1.getAmount(EUR).getAmount(), pvExpected1, TOLERANCE_PV);
    final MultiCurrencyAmount pvComputed2 = CALL_ERZ4_099_TRA_2.accept(PVBFOC, MULTICURVE_BLACK);
    double pvExpected2 = -82758.66634371383;
    assertEquals("STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethodE2ETest",
        pvComputed2.getAmount(EUR).getAmount(), pvExpected2, TOLERANCE_PV);
    final MultiCurrencyAmount pvComputed3 = PUT_ERZ4_099_TRA_1.accept(PVBFOC, MULTICURVE_BLACK);
    double pvExpected3 = -307492.22924060293;
    assertEquals("STIRFuturesOptionMarginTransactionBlackExpLogMoneynessMethodE2ETest",
        pvComputed3.getAmount(EUR).getAmount(), pvExpected3, TOLERANCE_PV);
  }
