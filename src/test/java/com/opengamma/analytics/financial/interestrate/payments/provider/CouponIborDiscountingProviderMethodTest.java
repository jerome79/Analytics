...
public class CouponIborDiscountingProviderMethodTest {
  ...
  public void presentValueMarketDiscount() {
    final MultiCurrencyAmount pvComputed = METHOD_CPN_IBOR.presentValue(CPN_IBOR, MULTICURVES);
    ...
    assertEquals("CouponIborDiscountingMarketMethod: present value", pvExpected, pvComputed.getAmount(EURIBOR3M.getCurrency()).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_CPN_IBOR.presentValue(CPN_IBOR, MULTICURVES);
    final MultiCurrencyAmount pvCalculator = CPN_IBOR.accept(PVDC, MULTICURVES);
