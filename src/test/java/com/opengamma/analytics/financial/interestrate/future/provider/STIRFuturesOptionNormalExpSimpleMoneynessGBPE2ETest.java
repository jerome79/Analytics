...
public class STIRFuturesOptionNormalExpSimpleMoneynessGBPE2ETest {
  ...
  public void testGBP() {
    ...
    MultiCurrencyAmount pvQ = TRANSACTION_Q.accept(PVC, NORMAL_MULTICURVES);
    ...
    MultiCurrencyAmount pvS = TRANSACTION_S.accept(PVC, NORMAL_MULTICURVES);
    ...
    MultiCurrencyAmount pvM = TRANSACTION_M.accept(PVC, NORMAL_MULTICURVES);
    ...
    assertRelative("testGBP, Quarterly, PV", 214.25427339090714, pvQ.getAmount(GBP).getAmount(), TOL);
    ...
    assertRelative("testGBP, Quarterly, pv01", 0.062310348981574545,
        pv01Q.getMap().get(Pair.of(MULTICURVES.getName(GBPLIBOR3M), GBP)), TOL);
    ...
    assertRelative("testGBP, Serial, PV", 225.09363304335017, pvS.getAmount(GBP).getAmount(), TOL);
    ...
    assertRelative("testGBP, Serial, pv01", -0.07153961703735841,
        pv01S.getMap().get(Pair.of(MULTICURVES.getName(GBPLIBOR3M), GBP)), TOL);
    ...
    assertRelative("testGBP, Mid-curve, PV", 265.11704997391985, pvM.getAmount(GBP).getAmount(), TOL);
    ...
    assertRelative("testGBP, Mid-curve, pv01", 0.06258534070755618,
        pv01M.getMap().get(Pair.of(MULTICURVES.getName(GBPLIBOR3M), GBP)), TOL);
  ...
  public void withRoundingTest() {
    ...
    MultiCurrencyAmount pvQ = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(TRANSACTION_Q,
        NORMAL_MULTICURVES, futurePriceQ);
    double pvQRounded = rounding(pvQ.getAmount(GBP).getAmount());
    ...
    MultiCurrencyAmount pvS = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(TRANSACTION_S,
        NORMAL_MULTICURVES, futurePriceS);
    double pvSRounded = rounding(pvS.getAmount(GBP).getAmount());
    ...
    MultiCurrencyAmount pvM = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(TRANSACTION_M,
        NORMAL_MULTICURVES, futurePriceM);
    double pvMRounded = rounding(pvM.getAmount(GBP).getAmount());
  ...
  public void negativeRateStrikeTest() {
    ...
    // PV
    MultiCurrencyAmount pvQ = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(transacQrtNegativeQ,
        NORMAL_MULTICURVES, futurePriceQ);
    assertRelative("negativeRateStrikeTest", 281.8594750733523, pvQ.getAmount(GBP).getAmount(), TOL);
    // Option Greeks
    ...
    // PV
    MultiCurrencyAmount pvS = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(transacSrtNegativeS,
        NORMAL_MULTICURVES, futurePriceS);
    assertRelative("negativeRateStrikeTest", 259.25014992599927, pvS.getAmount(GBP).getAmount(), TOL);
    // Option Greeks
  ...
  public void negativeRateFutureTest() {
    ...
    assertRelative("negativeRateStrikeTest", 192.2634655333998, pvQ.getAmount(GBP).getAmount(), TOL);
    // Option Greeks
    ...
    assertRelative("negativeRateFutureTest", 0.06137873256222647,
        pv01Q.getMap().get(Pair.of(multiCurve.getName(GBPLIBOR3M), GBP)), TOL);
    ...
    assertRelative("negativeRateStrikeTest", 234.12073717113458, pvS.getAmount(GBP).getAmount(), TOL);
    // Option Greeks
    ...
    assertRelative("negativeRateFutureTest", -0.07386328636832172,
        pv01S.getMap().get(Pair.of(multiCurve.getName(GBPLIBOR3M), GBP)), TOL);
  ...
  public void underlyingMethodTest() {
    ...
    MultiCurrencyAmount pvQ = TRANSACTION_Q.accept(PVC, NORMAL_MULTICURVES);
    MultiCurrencyAmount pvQRe = METHOD_OPTION_MARGIN_TRANSA.presentValueFromFuturePrice(TRANSACTION_Q,
        NORMAL_MULTICURVES, futurePrice);
    assertRelative("underlyingMethodTest", pvQ.getAmount(GBP).getAmount(), pvQRe.getAmount(GBP).getAmount(), localTol);
    ...
    assertRelative("underlyingMethodTest", pv01Q.getMap().get(Pair.of(MULTICURVES.getName(GBPLIBOR3M), GBP)), pv01QRe
        .getMap().get(Pair.of(MULTICURVES.getName(GBPLIBOR3M), GBP)), localTol);
  }
