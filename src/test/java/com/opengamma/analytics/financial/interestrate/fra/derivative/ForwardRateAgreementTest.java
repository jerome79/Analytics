...
public class ForwardRateAgreementTest {
  ...
  private static final double ACCRUAL_FACTOR_FIXING = DayCountUtils.yearFraction(DAY_COUNT_INDEX, FIXING_START_DATE, FIXING_END_DATE);
  ...
  private static final double FIXING_PERIOD_START_TIME = DayCountUtils.yearFraction(ACT_ACT, REFERENCE_DATE_ZONED, FIXING_START_DATE);
  private static final double FIXING_PERIOD_END_TIME = DayCountUtils.yearFraction(ACT_ACT, REFERENCE_DATE_ZONED, FIXING_END_DATE);
