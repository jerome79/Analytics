...
public class StandardDataSetsBondCurveGBP {
  ...
  private static final IssuerProviderDiscount KNOWN_DATA =
      new IssuerProviderDiscount(KNOWN_MULTICURVES, new HashMap<>());
  ...
  static {
    ...
    DSC_ISS_MAP.put(CURVE_NAME_GOVTUK_GBP, Pair.of(GOVT_UK_ISSUER_NAME, (LegalEntityFilter<LegalEntity>) new LegalEntityShortName()));
  }
