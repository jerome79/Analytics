...
public class CouponONDiscountingMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvComputed = METHOD_CPN_OIS.presentValue(CPN_OIS, MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_CPN_OIS.presentValue(CPN_OIS, MULTICURVES);
