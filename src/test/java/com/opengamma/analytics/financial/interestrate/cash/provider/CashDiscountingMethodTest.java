...
public class CashDiscountingMethodTest {
  ...
  public void presentValueTrade() {
    ...
    final MultiCurrencyAmount pvComputed = METHOD_DEPOSIT.presentValue(deposit, PROVIDER);
    ...
    assertEquals("DepositDefinition: present value", pvExpected, pvComputed.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void parRateBeforeStart() {
    ...
    final MultiCurrencyAmount pv0 = METHOD_DEPOSIT.presentValue(deposit0, PROVIDER);
    assertEquals("DepositDefinition: par rate", 0, pv0.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void parSpreadBeforeStart() {
    ...
    final Cash deposit0 = deposit0Definition.toDerivative(referenceDate);
    final MultiCurrencyAmount pv0 = METHOD_DEPOSIT.presentValue(deposit0, PROVIDER);
    assertEquals("DepositDefinition: par spread", 0, pv0.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
