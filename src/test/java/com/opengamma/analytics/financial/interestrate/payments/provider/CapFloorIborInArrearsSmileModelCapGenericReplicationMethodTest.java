...
public class CapFloorIborInArrearsSmileModelCapGenericReplicationMethodTest {
  ...
  public void consistencyTest() {
    ...
    for (final CapFloorIbor derivative : derivatives) {
      ...
      CapFloorIborInArrearsSABRCapGenericReplicationMethod methodSabrExtrap = new CapFloorIborInArrearsSABRCapGenericReplicationMethod(
          oldMethod);
      MultiCurrencyAmount res1Extrap = methodSabrExtrap.presentValue(derivative, SABR_MULTICURVES);
      ...
      CapFloorIborInArrearsSmileModelCapGenericReplicationMethod methodSabrGeneralExtrap = new CapFloorIborInArrearsSmileModelCapGenericReplicationMethod(
          smileFunctionExtrap);
      MultiCurrencyAmount res2Extrap = methodSabrGeneralExtrap.presentValue(derivative, MULTICURVES);

      double refExtrap = res1Extrap.getAmount(derivative.getCurrency()).getAmount();
      assertEquals(refExtrap, res2Extrap.getAmount(derivative.getCurrency()).getAmount(), Math.abs(refExtrap) * 1.e-6);
    }
    ...
    MultiCurrencyAmount res1Extrap = methodSabrExtrap.presentValue(COUPON_IBOR, SABR_MULTICURVES);
    ...
    CouponIborInArrearsSmileModelReplicationMethod methodSabrGeneralExtrap = new CouponIborInArrearsSmileModelReplicationMethod(
        smileFunctionExtrap);
    MultiCurrencyAmount res2Extrap = methodSabrGeneralExtrap.presentValue(COUPON_IBOR, MULTICURVES);

    double refExtrap = res1Extrap.getAmount(COUPON_IBOR.getCurrency()).getAmount();
    assertEquals(refExtrap, res2Extrap.getAmount(COUPON_IBOR.getCurrency()).getAmount(), Math.abs(refExtrap) * 1.e-6);
  ...
  public void ComparisonTest() {
    ...
    for (final CapFloorIbor derivative : derivatives) {
      ...
      MultiCurrencyAmount res2Extrap2 = methodSabrGeneralExtrap2.presentValue(derivative, MULTICURVES);
      ...
      MultiCurrencyAmount res2Extrap2Log = methodSabrGeneralExtrap2Log.presentValue(derivative, MULTICURVES);
      ...
      CapFloorIborInArrearsSmileModelCapGenericReplicationMethod methodSpline = new CapFloorIborInArrearsSmileModelCapGenericReplicationMethod(
          smileFunctionSpline);
      MultiCurrencyAmount resSpline = methodSpline.presentValue(derivative, MULTICURVES);

      double ref = res2Extrap2.getAmount(EUR).getAmount();
      assertEquals(ref, res2Extrap2Log.getAmount(EUR).getAmount(), Math.abs(ref) * 1.e-3);
      assertEquals(ref, resSpline.getAmount(EUR).getAmount(), Math.abs(ref) * 1.e-3);
    }
    ...
    CouponIborInArrearsSmileModelReplicationMethod methodSabrGeneralExtrap2 = new CouponIborInArrearsSmileModelReplicationMethod(
        smileFunctionExtrap2);
    MultiCurrencyAmount res2Extrap2 = methodSabrGeneralExtrap2.presentValue(COUPON_IBOR, MULTICURVES);
    ...
    CouponIborInArrearsSmileModelReplicationMethod methodSabrGeneralExtrap2Log = new CouponIborInArrearsSmileModelReplicationMethod(
        smileFunctionExtrap2Log);
    MultiCurrencyAmount res2Extrap2Log = methodSabrGeneralExtrap2Log.presentValue(COUPON_IBOR, MULTICURVES);
    ...
    CouponIborInArrearsSmileModelReplicationMethod methodSpline = new CouponIborInArrearsSmileModelReplicationMethod(
        smileFunctionSpline);
    MultiCurrencyAmount resSpline = methodSpline.presentValue(COUPON_IBOR, MULTICURVES);

    double ref = res2Extrap2.getAmount(EUR).getAmount();
    assertEquals(ref, res2Extrap2Log.getAmount(EUR).getAmount(), Math.abs(ref) * 1.e-2);
    assertEquals(ref, resSpline.getAmount(EUR).getAmount(), Math.abs(ref) * 1.e-2);
  }
  ...
  public void persentValueSABRExtrapolationParity() {
    ...
    for (int i = 0; i < 2; ++i) {
      ...
      MultiCurrencyAmount priceCapLong = methodSabrGeneralExtrap.presentValue(CAP_LONG, MULTICURVES);
      MultiCurrencyAmount priceCapShort = methodSabrGeneralExtrap.presentValue(CAP_SHORT, MULTICURVES);
      assertEquals(priceCapLong.getAmount(EUR).getAmount(), -priceCapShort.getAmount(EUR).getAmount(),
          Math.abs(priceCapLong.getAmount(EUR).getAmount()) * 1.0e-10);
      ...
      CouponIborInArrearsSmileModelReplicationMethod methodSabrGeneralExtrap2 = new CouponIborInArrearsSmileModelReplicationMethod(
          smileFunctionExtrap2);
      MultiCurrencyAmount priceIbor = methodSabrGeneralExtrap2.presentValue(COUPON_IBOR, MULTICURVES);
      ...
      final MultiCurrencyAmount priceCap0 = methodSabrGeneralExtrap.presentValue(cap0, MULTICURVES);
      assertEquals(priceCap0.getAmount(EUR).getAmount(), priceIbor.getAmount(EUR).getAmount(), Math.abs(priceCap0.getAmount(EUR).getAmount()) * 1.0e-10);
    ...
    for (final CapFloorIbor derivative : derivatives) {
      ...
      for (int i = 0; i < nMu; ++i) {
        ...
        CapFloorIborInArrearsSmileModelCapGenericReplicationMethod methodSabrGeneralExtrap2 = new CapFloorIborInArrearsSmileModelCapGenericReplicationMethod(
            smileFunctionExtrap2);
        MultiCurrencyAmount res2Extrap2 = methodSabrGeneralExtrap2.presentValue(derivative, MULTICURVES);
        pres = Math.abs(res2Extrap2.getAmount(EUR).getAmount());
