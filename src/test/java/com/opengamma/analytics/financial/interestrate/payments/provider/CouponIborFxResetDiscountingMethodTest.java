...
public class CouponIborFxResetDiscountingMethodTest {
  ...
  public void presentValue() {
    ...
    MultiCurrencyAmount pvComputed = METHOD_CPN_IBOR_FX.presentValue(CPN, MULTICURVE);
  ...
  public void currencyExposure() {
    MultiCurrencyAmount pvComputed = METHOD_CPN_IBOR_FX.presentValue(CPN, MULTICURVE);
    MultiCurrencyAmount ceComputed = METHOD_CPN_IBOR_FX.currencyExposure(CPN, MULTICURVE);
  ...
  public void currencyExposureCalculatorVsMethod() {
    MultiCurrencyAmount ceMethod = METHOD_CPN_IBOR_FX.currencyExposure(CPN, MULTICURVE);
  ...
  public void presentValueCalculatorVsMethod() {
    MultiCurrencyAmount pvMethod = METHOD_CPN_IBOR_FX.presentValue(CPN, MULTICURVE);
  ...
  public void presentValueSwap() {
    MultiCurrencyAmount pvComputed = SWAP_1.accept(PVDC, MULTICURVE);
