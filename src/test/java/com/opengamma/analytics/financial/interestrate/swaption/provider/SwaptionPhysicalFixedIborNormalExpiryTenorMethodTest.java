...
public class SwaptionPhysicalFixedIborNormalExpiryTenorMethodTest {
  ...
  public void presentValueVolatilitySensitivity() {
    ...
    MultiCurrencyAmount pv0 = METHOD_SWPT_NORMAL.presentValue(SWAPTION_1_P_L, MULTICURVE_NEG_NORMAL);
    MultiCurrencyAmount pvS = METHOD_SWPT_NORMAL.presentValue(SWAPTION_1_P_L, multicurveVolShifted);
    double pvvsExpected = (pvS.getAmount(USD).getAmount() - pv0.getAmount(USD).getAmount()) / shiftVol;
