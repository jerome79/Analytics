...
public class SwaptionPhysicalFixedIborBlackMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvMethod = METHOD_BLACK.presentValue(SWAPTION_LONG_REC, BLACK_MULTICURVES);
    ...
    assertEquals("Swaption Black method: present value", pvExpected, pvMethod.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValuePayerReceiverParity() {
    ...
    final MultiCurrencyAmount pvLR = METHOD_BLACK.presentValue(SWAPTION_LONG_REC, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvSP = METHOD_BLACK.presentValue(swaptionShortPayer, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvSwap = swapRec.accept(PVDC, MULTICURVES);
    assertEquals("Swaption Black method: present value", pvSwap.getAmount(EUR).getAmount(), pvLR.getAmount(EUR).getAmount() + pvSP.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_BLACK.presentValue(SWAPTION_LONG_REC, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = SWAPTION_LONG_REC.accept(PVBSC, BLACK_MULTICURVES);
    assertEquals("Swaption Black method: present value", pvCalculator.getAmount(EUR).getAmount(), pvMethod.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueBlackSensitivity() {
    ...
    final MultiCurrencyAmount pvP = METHOD_BLACK.presentValue(SWAPTION_LONG_REC, curvesBlackP);
