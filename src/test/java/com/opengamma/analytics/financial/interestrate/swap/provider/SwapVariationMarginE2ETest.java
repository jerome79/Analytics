...
public class SwapVariationMarginE2ETest {
  ...
  public void noNonBusinessDaySwapUsdTest() {
    ...
    double pvToday = irsToday.accept(PVDC, MULTICURVES_USD2).getAmount(USD).getAmount();
  ...
  public void NonBusinessDaySwapUsdTest() {
    ...
    Swap<? extends Payment, ? extends Payment> irsPrev = IRS_DEFINITION1
        .toDerivative(prevDate, TS_ARRAY_USDLIBOR3M_2X1);
    double pvToday = irsToday.accept(PVDC, MULTICURVES_USD3).getAmount(USD).getAmount();
  ...
  public void fixingBetweenBusinessDaysSwapUsdTest() {
    ...
    double pvTodayFixed = irsFixed.accept(PVDC, MULTICURVES_USD2).getAmount(USD).getAmount();
    double pvToday = irs.accept(PVDC, MULTICURVES_USD2).getAmount(USD).getAmount();
    double pvPrev = irsPrev.accept(PVDC, MULTICURVES_USD1).getAmount(USD).getAmount();
    // Year fraction should be calculated based on day count of ON index
    double pai = -pvPrev * FF_RATE1 *
        FEDFUND.getDayCount().getDayCountFraction(prevDate.toLocalDate(), tradeDate.toLocalDate());
  ...
  public void noNonBusinessDaySwapGbpTest1() {
    ...
    Swap<? extends Payment, ? extends Payment> irsPrev = IRS_DEFINITION4.toDerivative(prevDate,
        TS_ARRAY_USDLIBOR3M_2X4);
    double pvToday = irsToday.accept(PVDC, MULTICURVES_GBP2).getAmount(GBP).getAmount();
  ...
  public void nonBusinessDaySwapGbpTest() {
    ...
    Swap<? extends Payment, ? extends Payment> irsPrev = IRS_DEFINITION4.toDerivative(prevDate,
        TS_ARRAY_USDLIBOR3M_2X4);
    double pvToday = irsToday.accept(PVDC, MULTICURVES_GBP3).getAmount(GBP).getAmount();
