...
public class CouponIborAverageFixingDatesCompoundingFlatSpreadDiscountingMethodTest {
  ...
  public void presentValueFixedTest() {
    ...
    assertEquals("CouponIborAverageFixingDatesCompoundingFlatSpreadDiscountingMethod: present value",
        pvExpected, pvComputed.getAmount(DER1.getCurrency()).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pvWithCalc = DER1.accept(PVDC, MULTICURVES);
    assertEquals("CouponIborAverageFixingDatesCompoundingFlatSpreadDiscountingMethod: present value",
        pvWithCalc.getAmount(DER1.getCurrency()).getAmount(), pvComputed.getAmount(DER1.getCurrency()).getAmount(), EPS * Math.abs(pvExpected));
  }
  ...
  public void presentValueNotFixedTest() {
    ...
    assertEquals("CouponIborAverageFixingDatesCompoundingFlatSpreadDiscountingMethod: present value",
        pvExpected, pvComputed.getAmount(DER2.getCurrency()).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pvWithCalc = PVDC.visitCouponIborAverageFlatCompoundingSpread(DER2, MULTICURVES);
  ...
  public void presentValueNotFixedNoSquareTest() {
    ...
    final MultiCurrencyAmount pvWithCalc = PVDC.visitCouponIborAverageFlatCompoundingSpread(DER3, MULTICURVES);
