...
public class InterestRateFutureOptionMarginTransactionSABRMethodTest {
  ...
  public void presentValueFromOptionPrice() {
    ...
    final MultiCurrencyAmount pv = METHOD_SABR_TRA.presentValueFromPrice(transactionNoPremium, priceQuoted);
    final double pvExpected = (priceQuoted - TRADE_PRICE) * QUANTITY * NOTIONAL * FUTURE_FACTOR;
    assertEquals("Future option: present value from quoted price", pvExpected, pv.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueFromFuturePrice() {
    ...
    final InterestRateFutureOptionMarginTransaction transactionNoPremium = new InterestRateFutureOptionMarginTransaction(OPTION_EDU2, QUANTITY, TRADE_PRICE);
    final MultiCurrencyAmount pv = METHOD_SABR_TRA.presentValueFromFuturePrice(transactionNoPremium, SABR_MULTICURVES, priceFuture);
    ...
    assertEquals("Future option: present value from future price", pvExpected, pv.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValue() {
    ...
    final InterestRateFutureOptionMarginTransaction transactionNoPremium = new InterestRateFutureOptionMarginTransaction(OPTION_EDU2, QUANTITY, TRADE_PRICE);
    final double pvNoPremium = METHOD_SABR_TRA.presentValue(transactionNoPremium, SABR_MULTICURVES).getAmount(EUR).getAmount();
    final double pvNoPremiumExpected = METHOD_SABR_TRA.presentValueFromFuturePrice(transactionNoPremium, SABR_MULTICURVES, priceFuture).getAmount(EUR).getAmount();
  ...
  public void presentValueMethodVsCalculator() {
    ...
    final MultiCurrencyAmount pvNoPremiumMethod = METHOD_SABR_TRA.presentValue(transactionNoPremium, SABR_MULTICURVES);
    final MultiCurrencyAmount pvNoPremiumCalculator = transactionNoPremium.accept(PVSFC, SABR_MULTICURVES);
    assertEquals("Future option: present value: Method vs Calculator", pvNoPremiumMethod.getAmount(EUR).getAmount(), pvNoPremiumCalculator.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueSABRSensitivity() {
    ...
    final double pv = METHOD_SABR_TRA.presentValue(TRANSACTION, SABR_MULTICURVES).getAmount(EUR).getAmount();
    ...
    final double pvAlphaBumped = METHOD_SABR_TRA.presentValue(TRANSACTION, sabrBundleAlphaBumped).getAmount(EUR).getAmount();
    ...
    final double pvRhoBumped = METHOD_SABR_TRA.presentValue(TRANSACTION, sabrBundleRhoBumped).getAmount(EUR).getAmount();
    ...
    final double pvNuBumped = METHOD_SABR_TRA.presentValue(TRANSACTION, sabrBundleNuBumped).getAmount(EUR).getAmount();
