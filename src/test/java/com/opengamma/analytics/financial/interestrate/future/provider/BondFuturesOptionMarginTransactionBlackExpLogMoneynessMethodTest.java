...
public class BondFuturesOptionMarginTransactionBlackExpLogMoneynessMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvComputed1 = METHOD_OPT_TRA.presentValue(CALL_BOBLM4_125_TRA_1, BLACK_BNDFUT_MONEYNESS);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1, pvComputed1.getAmount(BOBLM4_DEFINITION.getCurrency()).getAmount(), TOLERANCE_PV);
    assertTrue("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvComputed1.size() == 1);
    final MultiCurrencyAmount pvCalculator = CALL_BOBLM4_125_TRA_1.accept(PVBFC, BLACK_BNDFUT_MONEYNESS);
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected1, pvCalculator.getAmount(BOBLM4_DEFINITION.getCurrency()).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pvComputed2 = METHOD_OPT_TRA.presentValue(CALL_BOBLM4_125_TRA_2, BLACK_BNDFUT_MONEYNESS);
    ...
    assertEquals("BondFuturesOptionMarginTransactionBlackFlatMethod: present value", pvExpected2, pvComputed2.getAmount(BOBLM4_DEFINITION.getCurrency()).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueBlackSensitivity() {
    ...
    final MultiCurrencyAmount pvP = METHOD_OPT_TRA.presentValue(CALL_BOBLM4_125_TRA_1, blackShiftedPlus);
    final MultiCurrencyAmount pvM = METHOD_OPT_TRA.presentValue(CALL_BOBLM4_125_TRA_1, blackShiftedMinus);
    final double vegaExpected = (pvP.getAmount(CALL_BOBLM4_125_TRA_1.getCurrency()).getAmount() - pvM.getAmount(CALL_BOBLM4_125_TRA_1.getCurrency()).getAmount()) / (2 * shiftVega);
