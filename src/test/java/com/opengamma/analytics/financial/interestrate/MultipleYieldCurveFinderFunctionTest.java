...
public class MultipleYieldCurveFinderFunctionTest {
  ...
  static {
    ...
    for (int i = 0; i < n; i++) {
      ...
      DERIVATIVES.add(new Cash(AUD, 0, t, 1, SIMPLE_RATES[i], t, CURVE_NAME));
  ...
  public void testWrongNodeNumber() {
    ...
    list.add(new Cash(AUD, 0, 1, 1, 0.01, 1, CURVE_NAME));
    list.add(new Cash(AUD, 0, 0.5, 1, 0.01, 0.5, CURVE_NAME));
