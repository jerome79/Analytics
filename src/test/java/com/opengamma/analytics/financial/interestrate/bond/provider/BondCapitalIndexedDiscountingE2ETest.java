...
public class BondCapitalIndexedDiscountingE2ETest {
  ...
  private static final BondCapitalIndexedSecurityDefinition<CouponInflationZeroCouponInterpolationGearingDefinition> TIPS_16_SEC_DEFINITION = BondDataSetsUsd.bondTIPS_20160115(1.0);
  ...
  private static final BondCapitalIndexedTransactionDefinition<CouponInflationZeroCouponInterpolationGearingDefinition> TIPS_16_TRA_DEFINITION = new BondCapitalIndexedTransactionDefinition<>(
      TIPS_16_SEC_DEFINITION, QUANTITY_TIPS_1,
  ...
  public void presentValueBondFixed() {
    ...
    MultiCurrencyAmount pvComputedIs = UST_TRA.accept(PVIssuerC, ISSUER_GOVT);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value bond fixed",
        pvExpected, pvComputedIs.getAmount(USD).getAmount(), TOLERANCE_PV);
    MultiCurrencyAmount pvComputedInIs = UST_TRA.accept(PVInflIssuerC, INFL_ISSUER_GOVT);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value bond fixed",
        pvExpected, pvComputedInIs.getAmount(USD).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValueSwap() {
    double pvExpected = 697518.0714;
    MultiCurrencyAmount pvIn = ZCI_2.accept(PVInflC, INFL);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value ZC",
        pvExpected, pvIn.getAmount(USD).getAmount(), TOLERANCE_PV);
    MultiCurrencyAmount pvInIs = ZCI_2.accept(PVInflIssuerC, INFL_ISSUER_GOVT);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value ZC",
        pvExpected, pvInIs.getAmount(USD).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValueTips() {
    double pvExpected = 471980.9359;
    MultiCurrencyAmount pv1 = TIPS_16_TRA.accept(PVInflIssuerC, INFL_ISSUER_GOVT);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value TIPS",
        pvExpected, pv1.getAmount(USD).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValueTipsSeasonalityCurrent() {
    double pvExpected = 431401.1262;
    MultiCurrencyAmount pv1 = TIPS_16_TRA.accept(PVInflIssuerC, INFL_ISSUER_GOVT_2);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value TIPS",
        pvExpected, pv1.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void bucketeParameterInflationProviderInterfacedPV01Tips() {
    ...
    sensitivity.put(Pair.of(INFL_ISSUER_GOVT.getName(USD), USD), new DoubleMatrix1D(deltaDsc));
    sensitivity.put(Pair.of(INFL_ISSUER_GOVT.getIssuerProvider().getName(TIPS_16_SEC_DEFINITION.getIssuerEntity()), USD),
        new DoubleMatrix1D(deltaGovt));
    sensitivity.put(Pair.of(INFL_ISSUER_GOVT.getName(US_CPI), USD), new DoubleMatrix1D(deltaCpi));
  ...
  public void consistencyPricePvTips() {
    ...
    BondCapitalIndexedTransactionDefinition<CouponInflationZeroCouponInterpolationGearingDefinition> tipsAtmDefinition = new BondCapitalIndexedTransactionDefinition<>(TIPS_16_SEC_DEFINITION,
        QUANTITY_TIPS_1,
    ...
    MultiCurrencyAmount pv1 = tipsAtm.accept(PVInflIssuerC, INFL_ISSUER_GOVT_2);
    assertEquals("BondCapitalIndexedDiscountingE2E: present value TIPS",
        0.0, pv1.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
