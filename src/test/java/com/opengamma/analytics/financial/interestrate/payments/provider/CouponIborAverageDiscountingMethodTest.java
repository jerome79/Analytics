...
public class CouponIborAverageDiscountingMethodTest {
  ...
  private static final double ACCRUAL_FACTOR_1 = DayCountUtils.yearFraction(DAY_COUNT_COUPON, ACCRUAL_START_DATE_1, ACCRUAL_END_DATE_1);
  ...
  private static final double ACCRUAL_FACTOR_2 = DayCountUtils.yearFraction(DAY_COUNT_COUPON, ACCRUAL_START_DATE_2, ACCRUAL_END_DATE_2);
  ...
  public void presentValueMarketDiscount() {
    final MultiCurrencyAmount pvComputed = METHOD_CPN_IBOR__AVERAGE.presentValue(CPN_IBOR__AVERAGE, MULTICURVES);
    ...
    assertEquals("CouponIborDiscountingMarketMethod: present value", pvExpected, pvComputed.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }

  @Test
  public void presentValue() {
    final MultiCurrencyAmount pvComputed = METHOD_CPN_IBOR__AVERAGE.presentValue(CPN_IBOR__AVERAGE, MULTICURVES);
    final MultiCurrencyAmount pvComputed1 = METHOD_CPN_IBOR.presentValue(CPN_IBOR_1, MULTICURVES);
    final MultiCurrencyAmount pvComputed2 = METHOD_CPN_IBOR.presentValue(CPN_IBOR_2, MULTICURVES);
    final double pvExpected = CPN_IBOR__AVERAGE.getPaymentYearFraction() *
        (WEIGHT_1 * pvComputed1.getAmount(EUR).getAmount() / ACCRUAL_FACTOR_1 + WEIGHT_2 * pvComputed2.getAmount(EUR).getAmount() / ACCRUAL_FACTOR_2);
