...
public class SwaptionCashFixedIborSABRExtrapolationRightMethodTest {
  ...
  public void presentValueNoExtra() {
    final MultiCurrencyAmount priceLongPayer = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortPayer = METHOD_EXTRAPOLATION.presentValue(SWAPTION_SHORT_PAYER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiver = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_RECEIVER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortReceiver = METHOD_EXTRAPOLATION.presentValue(SWAPTION_SHORT_RECEIVER, SABR_MULTICURVES);
    ...
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceLongPayerNoExtra.getAmount(EUR).getAmount(), priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceShortPayerNoExtra.getAmount(EUR).getAmount(), priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceLongReceiverNoExtra.getAmount(EUR).getAmount(), priceLongReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike", priceShortReceiverNoExtra.getAmount(EUR).getAmount(), priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike long/short parity", priceLongPayer.getAmount(EUR).getAmount(), -priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: below cut-off strike long/short parity", priceLongReceiver.getAmount(EUR).getAmount(), -priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueExtra() {
    final MultiCurrencyAmount priceLongPayer = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortPayer = METHOD_EXTRAPOLATION.presentValue(SWAPTION_SHORT_PAYER_HIGH, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiver = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_RECEIVER_HIGH, SABR_MULTICURVES);
    ...
    assertEquals("Swaption cash SABR extrapolation: fixed value", priceLongPayerExpected, priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: fixed value", priceLongReceiverExpected, priceLongReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption cash SABR extrapolation: long/short parity", priceLongPayer.getAmount(EUR).getAmount(), -priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueSABRSensitivity() {
    ...
    final double pvLongPayer = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, SABR_MULTICURVES).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerAlphaBumped = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleAlphaBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerRhoBumped = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleRhoBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerNuBumped = METHOD_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleNuBumped).getAmount(EUR).getAmount();
