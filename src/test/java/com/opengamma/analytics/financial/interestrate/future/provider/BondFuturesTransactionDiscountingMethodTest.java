...
public class BondFuturesTransactionDiscountingMethodTest {
  ...
  public void presentValueFromPrice() {
    ...
    final MultiCurrencyAmount pvComputed = METHOD_FUT_TRA_DSC.presentValueFromPrice(BOND_FUTURES_TRA, quotedPrice);
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvComputed = METHOD_FUT_TRA_DSC.presentValue(BOND_FUTURES_TRA, ISSUER_MULTICURVES);
    ...
    final MultiCurrencyAmount presentValueCalculator = BOND_FUTURES_TRA.accept(PVIC, ISSUER_MULTICURVES);
  ...
  public void presentValueFromNetBasis() {
    ...
    final MultiCurrencyAmount pvComputed = METHOD_FUT_TRA_DSC.presentValueFromNetBasis(BOND_FUTURES_TRA, ISSUER_MULTICURVES, netBasisInput);
    final double priceComputed = METHOD_FUT_SEC_DSC.priceFromNetBasis(BOND_FUTURES_SEC, ISSUER_MULTICURVES, netBasisInput);
    final MultiCurrencyAmount pvExpected = METHOD_FUT_TRA_DSC.presentValueFromPrice(BOND_FUTURES_TRA, priceComputed);
    assertEquals("Bond future Discounting Method: present value from net basis", pvExpected.getAmount(USD).getAmount(), pvComputed.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
