...
public class SwaptionPhysicalFixedIborSABRMethodTest {
  ...
  public void testPresentValue() {
    ...
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceSwapPayer.getAmount(EUR).getAmount(), priceLongPayer.getAmount(EUR).getAmount() +
        priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceSwapReceiver.getAmount(EUR).getAmount(), priceLongReceiver.getAmount(EUR).getAmount() +
        priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
