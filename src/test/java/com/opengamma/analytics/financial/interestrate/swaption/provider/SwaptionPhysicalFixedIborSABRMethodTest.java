...
public class SwaptionPhysicalFixedIborSABRMethodTest {
  ...
  public void testPresentValue() {
    // Swaption pricing.
    final MultiCurrencyAmount priceLongPayer = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortPayer = METHOD_SWPT_SABR.presentValue(SWAPTION_SHORT_PAYER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiver = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_RECEIVER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortReceiver = METHOD_SWPT_SABR.presentValue(SWAPTION_SHORT_RECEIVER, SABR_MULTICURVES);
    ...
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", expectedPrice, priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    // Long/Short parity
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceLongPayer.getAmount(EUR).getAmount(), -priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceLongReceiver.getAmount(EUR).getAmount(), -priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    // Payer/Receiver parity
    final MultiCurrencyAmount priceSwapPayer = SWAP_PAYER.accept(PVDC, MULTICURVES);
    final MultiCurrencyAmount priceSwapReceiver = SWAP_RECEIVER.accept(PVDC, MULTICURVES);
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceSwapPayer.getAmount(EUR).getAmount(), priceLongPayer.getAmount(EUR).getAmount() + priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", priceSwapReceiver.getAmount(EUR).getAmount(), priceLongReceiver.getAmount(EUR).getAmount() + priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void testPresentValueConventionArbitrage() {
    ...
    final MultiCurrencyAmount price360 = METHOD_SWPT_SABR.presentValue(swaption360, SABR_MULTICURVES);
    final MultiCurrencyAmount price365 = METHOD_SWPT_SABR.presentValue(swaption365, SABR_MULTICURVES);
    assertEquals("SwaptionPhysicalFixedIborSABRMethod: presentValue", price360.getAmount(EUR).getAmount(), price365.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = PVSSC.visit(SWAPTION_LONG_PAYER, SABR_MULTICURVES);
  ...
  public void presentValueSABRSensitivity() {
    ...
    final double pvLongPayer = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerAlphaBumped = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, sabrBundleAlphaBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerRhoBumped = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, sabrBundleRhoBumped).getAmount(EUR).getAmount();
    ...
    final double pvLongPayerNuBumped = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, sabrBundleNuBumped).getAmount(EUR).getAmount();
  ...
  public void presentValueSABRHullWhiteMonteCarlo() {
    final MultiCurrencyAmount pvSABR = METHOD_SWPT_SABR.presentValue(SWAPTION_LONG_PAYER, SABR_MULTICURVES);
    ...
    final MultiCurrencyAmount pvMC = SWAPTION_LONG_PAYER.accept(pvcSABRHWMC, SABR_MULTICURVES);
    assertEquals("Swaption Physical SABR: Present value using Hull-White by Monte Carlo", pvSABR.getAmount(EUR).getAmount(), pvMC.getAmount(EUR).getAmount(), 2.5E+4);
  }
  ...
  public void performance() {
    ...
    Triple<MultiCurrencyAmount, MultipleCurrencyMulticurveSensitivity, PresentValueSABRSensitivityDataBundle> pvad;
    ...
    final PresentValueSABRHullWhiteMonteCarloCalculator pvcSABRHWMC = PresentValueSABRHullWhiteMonteCarloCalculator.getInstance();
    final MultiCurrencyAmount[] pvMC = new MultiCurrencyAmount[nbTest2];
