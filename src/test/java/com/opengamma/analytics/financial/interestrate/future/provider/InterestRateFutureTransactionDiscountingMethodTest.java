...
public class InterestRateFutureTransactionDiscountingMethodTest {
  ...
  public void parSpreadMarketQuote() {
    ...
    final MultiCurrencyAmount pv0 = METHOD_IRFUT_TRA_DSC.presentValue(futures0, MULTICURVES);
    assertEquals("InterestRateFutureTransactionDiscountingMethod: STIR Futures par spread market quote", pv0.getAmount(EUR).getAmount(), 0, TOLERANCE_PRICE);
  }
