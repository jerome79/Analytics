...
public class CouponIborCompoundingSimpleSpreadDiscountingMethodTest {
  ...
  public void presentValueBeforeFirstFixing() {
    final MultiCurrencyAmount pvComputed = METHOD_COMPOUNDED.presentValue(CPN_BEFORE, MULTICURVES);
    ...
    assertEquals("CouponIborCompoundingSimpleSpreadDiscountingMethod: Present value", pvExpected, pvComputed.getAmount(CAD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    ...
    assertEquals("CouponIborCompoundingSimpleSpreadDiscountingMethod: Present value", pvMethod.getAmount(CAD).getAmount(), pvCalculator.getAmount(CADCDOR3M.getCurrency()).getAmount(), TOLERANCE_PV);
