...
public class CouponIborAveragingDiscountingMethodTest {
  ...
  private static CouponIborAverageIndexDefinition CPN_AVE_DEFINITION = CouponIborAverageIndexDefinition.from(PAYMENT_DATE, ACCRUAL_START_DATE, ACCRUAL_END_DATE, ACCRUAL_YF, NOTIONAL, FIXING_DATE,
      INDEX1, INDEX2, WEIGHT1, WEIGHT2, EUR_CALENDAR, EUR_CALENDAR);
  ...
  public void presentValue() {
    ...
    final MultiCurrencyAmount pvStubCoupon = METHOD.presentValue(CPN_IBOR_AVERAGE, curveSet);
    ...
    Assert.assertEquals(flow, pvStubCoupon.getAmount(Currency.EUR).getAmount());
