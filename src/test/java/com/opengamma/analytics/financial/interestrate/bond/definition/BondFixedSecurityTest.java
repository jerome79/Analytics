...
public class BondFixedSecurityTest {
  ...
  private static final double SETTLEMENT_TIME_1 = DayCountUtils.yearFraction(ACT_ACT, REFERENCE_DATE_1, SPOT_1);
  ...
  private static final double SETTLEMENT_TIME_2 = DayCountUtils.yearFraction(ACT_ACT, REFERENCE_DATE_2, SPOT_2);
