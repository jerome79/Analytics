...
public class CouponInflationZeroCouponMonthlyGearingDiscountingMethodTest {
  ...
  public void presentValueNoNotional() {
    ...
    assertEquals("Zero-coupon inflation: Present value", pvExpected, pv.getAmount(ZERO_COUPON_NO.getCurrency()).getAmount(), TOLERANCE_PV);
  }
  ...
  public void netAmountNoNotional() {
    ...
    assertEquals("Zero-coupon inflation: net amount", pvExpected, pv.getAmount(ZERO_COUPON_NO.getCurrency()).getAmount(), TOLERANCE_PV);
  }
  ...
  public void netAmountMethodVsCalculator() {
    final MultiCurrencyAmount naMethod = METHOD.netAmount(ZERO_COUPON_NO, MARKET.getInflationProvider());
    final MultiCurrencyAmount naCalculator = ZERO_COUPON_NO.accept(NAIC, MARKET.getInflationProvider());
  ...
  public void presentValueWithNotional() {
    ...
    assertEquals("Zero-coupon inflation: Present value", pvExpected, pv.getAmount(ZERO_COUPON_WITH.getCurrency()).getAmount(), TOLERANCE_PV);
  }
  ...
  public void netAmountWithNotional() {
    ...
    assertEquals("Zero-coupon inflation: net amount", pvExpected, pv.getAmount(ZERO_COUPON_WITH.getCurrency()).getAmount(), TOLERANCE_PV);
  }
