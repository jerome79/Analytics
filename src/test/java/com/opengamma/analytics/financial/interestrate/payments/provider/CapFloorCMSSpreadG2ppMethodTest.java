...
public class CapFloorCMSSpreadG2ppMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pv = METHOD_NI.presentValue(CMS_SPREAD, G2PP_MULTICURVES);
    final double pvPreviousRun = 102469.279; // 5Y - 6M - strike 10bp
    assertEquals("CMS spread: G2++ - present value", pvPreviousRun, pv.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
