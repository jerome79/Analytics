...
public class InterestRateFutureOptionMarginHullWhiteMethodTest {
  ...
  public void presentValueStandard() {
    final MultiCurrencyAmount pvComputed = METHOD_OPT_TRA.presentValue(OPT_ERH3_CALL_9900_TRA_1, HW_MULTICURVES);
    ...
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvExpected, pvComputed.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueLongShort() {
    final MultiCurrencyAmount pvLongStd = METHOD_OPT_TRA.presentValue(OPT_ERH3_CALL_9900_TRA_1, HW_MULTICURVES);
    final MultiCurrencyAmount pvShortStd = METHOD_OPT_TRA.presentValue(OPT_ERH3_CALL_9900_TRA_2, HW_MULTICURVES);
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvLongStd.getAmount(EUR).getAmount(), -pvShortStd.getAmount(EUR).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pvLongMid = METHOD_OPT_TRA.presentValue(OPT_ERM4_MID_CALL_9875_TRA_1, HW_MULTICURVES);
    final MultiCurrencyAmount pvShortMid = METHOD_OPT_TRA.presentValue(OPT_ERM4_MID_CALL_9875_TRA_2, HW_MULTICURVES);
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvLongMid.getAmount(EUR).getAmount(), -pvShortMid.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMidCurve() {
    final MultiCurrencyAmount pvComputed = METHOD_OPT_TRA.presentValue(OPT_ERM4_MID_CALL_9875_TRA_1, HW_MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_OPT_TRA.presentValue(OPT_ERH3_CALL_9900_TRA_1, HW_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = OPT_ERH3_CALL_9900_TRA_1.accept(PVHWC, HW_MULTICURVES);
    assertEquals("InterestRateFutureOptionMarginTransactionHullWhiteMethod: present value", pvMethod.getAmount(EUR).getAmount(), pvCalculator.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
