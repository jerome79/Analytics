...
//  private static final CouponONArithmeticAverageSpread FEDFUND_CPN_SPREAD_3M = FEDFUND_CPN_SPREAD_3M_DEF.toDerivative(REFERENCE_DATE);
  ...
  public void presentValueExactVsApprox() {
    ...
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MExact.getAmount(USD).getAmount(),
        pv3MAppro.getAmount(USD).getAmount(),
        TOLERANCE_REL * NOTIONAL * FEDFUND_CPN_3M.getFixingPeriodRemainingAccrualFactor());
    final MultiCurrencyAmount pv1YExact = METHOD_FF_EXACT.presentValue(FEDFUND_CPN_1Y, MULTICURVES);
    final MultiCurrencyAmount pv1YAppro = METHOD_FF_APPRO.presentValue(FEDFUND_CPN_1Y, MULTICURVES);
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv1YExact.getAmount(USD).getAmount(),
        pv1YAppro.getAmount(USD).getAmount(),
        TOLERANCE_REL * NOTIONAL * FEDFUND_CPN_1Y.getFixingPeriodRemainingAccrualFactor());
    final MultiCurrencyAmount pv3MFwdExact = METHOD_FF_EXACT.presentValue(FEDFUND_CPN_3MFWD, MULTICURVES);
    final MultiCurrencyAmount pv3MFwdAppro = METHOD_FF_APPRO.presentValue(FEDFUND_CPN_3MFWD, MULTICURVES);
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MFwdExact.getAmount(USD).getAmount(),
        pv3MFwdAppro.getAmount(USD).getAmount(), TOLERANCE_REL * NOTIONAL * FEDFUND_CPN_3MFWD.getFixingPeriodRemainingAccrualFactor());
    final MultiCurrencyAmount pv3MFwdSpread0Exact =
        METHOD_FF_EXACT_SPREAD.presentValue(FEDFUND_CPN_SPREAD0_3MFWD, MULTICURVES);
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MFwdSpread0Exact.getAmount(USD).getAmount(),
        pv3MFwdExact.getAmount(USD).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pv3MFwdSpread0Appro =
  ...
  public void presentValueSpreadExactVsApprox() {
    ...
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MExact.getAmount(USD).getAmount(), pv3MAppro.getAmount(USD).getAmount(),
        TOLERANCE_REL * NOTIONAL * FEDFUND_CPN_3M.getFixingPeriodRemainingAccrualFactor());
  }
  ...
  public void presentValueApproxMethodVsCalculator() {
    ...
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MMethod.getAmount(USD).getAmount(),
        pv3MCalc.getAmount(USD).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pv3MMethodSpSi = METHOD_AA_SIMPL.presentValue(FEDFUND_CPN_3M_SIMPL, MULTICURVES);
    final MultiCurrencyAmount pv3MCalcSpSi = FEDFUND_CPN_3M_SIMPL.accept(PVDC, MULTICURVES);
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MMethodSpSi.getAmount(USD).getAmount(),
        pv3MCalcSpSi.getAmount(USD).getAmount(), TOLERANCE_PV);
    final MultiCurrencyAmount pv3MSpreadMethod = METHOD_FF_APPRO_SPREAD.presentValue(FEDFUND_CPN_SPREAD_3MFWD, MULTICURVES);
    final MultiCurrencyAmount pv3MSpreadCalc = FEDFUND_CPN_SPREAD_3MFWD.accept(PVDC, MULTICURVES);
    assertEquals("CouponArithmeticAverageONDiscountingMethod: present value", pv3MSpreadMethod.getAmount(USD).getAmount(),
