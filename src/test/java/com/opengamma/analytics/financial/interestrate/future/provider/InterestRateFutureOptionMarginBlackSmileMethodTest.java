...
public class InterestRateFutureOptionMarginBlackSmileMethodTest {
  ...
  public void presentValue() {
    ...
    final MultiCurrencyAmount presentValue1Computed = METHOD_TRANSACTION_OPTION_BLACK.presentValue(TRANSACTION_1, BLACK_MULTICURVES);
    ...
    final MultiCurrencyAmount presentValue2Computed = METHOD_TRANSACTION_OPTION_BLACK.presentValue(TRANSACTION_2, BLACK_MULTICURVES);
    ...
    final MultiCurrencyAmount presentValue1Calculator = TRANSACTION_1.accept(PVBFC, BLACK_MULTICURVES);
