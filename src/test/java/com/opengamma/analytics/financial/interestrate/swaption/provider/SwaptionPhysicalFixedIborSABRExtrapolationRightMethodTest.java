...
public class SwaptionPhysicalFixedIborSABRExtrapolationRightMethodTest {
  ...
  public void presentValueNoExtra() {
    ...
    final MultiCurrencyAmount priceLongReceiver = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_RECEIVER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortReceiver = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_SHORT_RECEIVER, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongPayerNoExtra = SWAPTION_LONG_PAYER.accept(PVSSC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortPayerNoExtra = SWAPTION_SHORT_PAYER.accept(PVSSC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiverNoExtra = SWAPTION_LONG_RECEIVER.accept(PVSSC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortReceiverNoExtra = SWAPTION_SHORT_RECEIVER.accept(PVSSC, SABR_MULTICURVES);
    assertEquals("Swaption SABR extrapolation: below cut-off strike", priceLongPayerNoExtra.getAmount(EUR).getAmount(), priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: below cut-off strike", priceShortPayerNoExtra.getAmount(EUR).getAmount(), priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: below cut-off strike", priceLongReceiverNoExtra.getAmount(EUR).getAmount(), priceLongReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: below cut-off strike", priceShortReceiverNoExtra.getAmount(EUR).getAmount(), priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: below cut-off strike long/short parity", priceLongPayer.getAmount(EUR).getAmount(), -priceShortPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: below cut-off strike long/short parity", priceLongReceiver.getAmount(EUR).getAmount(), -priceShortReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueLimit() {
    ...
    final MultiCurrencyAmount priceLongPayer = METHOD_SABR_EXTRAPOLATION.presentValue(swaptionLongPayerHighStrike, SABR_MULTICURVES);
    final MultiCurrencyAmount priceShortPayer = METHOD_SABR_EXTRAPOLATION.presentValue(swaptionShortPayerHighStrike, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiver = METHOD_SABR_EXTRAPOLATION.presentValue(swaptionLongReceiverHighStrike, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongPayerSABR = swaptionLongPayerHighStrike.accept(PVSSXC, SABR_MULTICURVES);
    final MultiCurrencyAmount priceLongReceiverSABR = swaptionLongReceiverHighStrike.accept(PVSSXC, SABR_MULTICURVES);
    assertEquals("Swaption SABR extrapolation: extrapolation limit", priceLongPayerSABR.getAmount(EUR).getAmount(), priceLongPayer.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Swaption SABR extrapolation: extrapolation limit", priceLongReceiverSABR.getAmount(EUR).getAmount(), priceLongReceiver.getAmount(EUR).getAmount(), TOLERANCE_PV);
  ...
  public void presentValueExtra() {
    ...
    final MultiCurrencyAmount priceLongReceiver = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_RECEIVER_HIGH, SABR_MULTICURVES);
    final MultiCurrencyAmount pricePayer = SWAP_PAYER_HIGH.accept(PVDC, MULTICURVES);
  ...
  public void presentValueSABRSensitivity() {
    ...
    final MultiCurrencyAmount pvLongPayer = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, SABR_MULTICURVES);
    ...
    final MultiCurrencyAmount pvLongPayerAlphaBumped = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleAlphaBumped);
    final double expectedAlphaSensi = (pvLongPayerAlphaBumped.getAmount(EUR).getAmount() - pvLongPayer.getAmount(EUR).getAmount()) / shift;
    ...
    final MultiCurrencyAmount pvLongPayerBetaBumped = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleBetaBumped);
    final double expectedBetaSensi = (pvLongPayerBetaBumped.getAmount(EUR).getAmount() - pvLongPayer.getAmount(EUR).getAmount()) / shift;
    ...
    final MultiCurrencyAmount pvLongPayerRhoBumped = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleRhoBumped);
    final double expectedRhoSensi = (pvLongPayerRhoBumped.getAmount(EUR).getAmount() - pvLongPayer.getAmount(EUR).getAmount()) / shift;
    ...
    final MultiCurrencyAmount pvLongPayerNuBumped = METHOD_SABR_EXTRAPOLATION.presentValue(SWAPTION_LONG_PAYER_HIGH, sabrBundleNuBumped);
    final double expectedNuSensi = (pvLongPayerNuBumped.getAmount(EUR).getAmount() - pvLongPayer.getAmount(EUR).getAmount()) / shift;
