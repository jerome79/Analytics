...
public class CouponIborGearingDiscountingMarketMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pv = METHOD.presentValue(COUPON, PROVIDER);
    ...
    assertEquals("Coupon Ibor Gearing: Present value by discounting", pvExpected, pv.getAmount(EUR).getAmount(), 1.0E-2);
  }

  @Test
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD.presentValue(COUPON, PROVIDER);
    final MultiCurrencyAmount pvCalculator = COUPON.accept(PVDC, PROVIDER);
