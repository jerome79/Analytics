...
public class ForexOptionVanillaBlackFlatMethodTest {
  ...
  public void presentValue() {
    ...
    final MultiCurrencyAmount priceComputed = METHOD_BLACK_FLAT.presentValue(CALL_LONG, BLACK_MULTICURVES);
  ...
  public void presentValuePutCallParity() {
    final MultiCurrencyAmount pvCall = METHOD_BLACK_FLAT.presentValue(CALL_LONG, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvPut = METHOD_BLACK_FLAT.presentValue(PUT_SHORT, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvForward = FX.accept(PVDC, MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_BLACK_FLAT.presentValue(CALL_LONG, BLACK_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = CALL_LONG.accept(PVFBFC, BLACK_MULTICURVES);
    assertThat(pvCalculator.getAmount(USD)).isEqualTo(pvMethod.getAmount(USD), offset(TOLERANCE_PV));
  ...
  public void currencyExposureVsPresentValue() {
    final MultiCurrencyAmount pv = METHOD_BLACK_FLAT.presentValue(CALL_LONG, BLACK_MULTICURVES);
    final MultiCurrencyAmount ce = METHOD_BLACK_FLAT.currencyExposure(CALL_LONG, BLACK_MULTICURVES);
    assertEquals(
  ...
  public void currencyExposurePutCallParity() {
    final MultiCurrencyAmount currencyExposureCall = METHOD_BLACK_FLAT.currencyExposure(CALL_LONG, BLACK_MULTICURVES);
    final MultiCurrencyAmount currencyExposurePut = METHOD_BLACK_FLAT.currencyExposure(PUT_SHORT, BLACK_MULTICURVES);
    final MultiCurrencyAmount currencyExposureForward = FX.accept(CEDC, MULTICURVES);
    assertThat(currencyExposureCall.getAmount(EUR).plus(currencyExposurePut.getAmount(EUR)))
        .isEqualTo(currencyExposureForward.getAmount(EUR), offset(TOLERANCE_PV));
    assertThat(currencyExposureCall.getAmount(USD).plus(currencyExposurePut.getAmount(USD)).getAmount())
        .isEqualTo(currencyExposureForward.getAmount(USD).getAmount(), offset(TOLERANCE_PV));
