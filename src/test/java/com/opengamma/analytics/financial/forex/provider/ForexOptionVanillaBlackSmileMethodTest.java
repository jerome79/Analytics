...
public class ForexOptionVanillaBlackSmileMethodTest {
  ...
  private static final FxMatrix FX_MATRIX_M = FxMatrix.builder().addRate(EUR, USD, SPOT - SHIFT).build();
  private static final FxMatrix FX_MATRIX_P = FxMatrix.builder().addRate(EUR, USD, SPOT + SHIFT).build();
  ...
  private static final Offset<Double> TOL_PV = offset(TOLERANCE_PV);
  ...
  public void persentValueAtGridPoint() {
    ...
    final MultiCurrencyAmount priceComputed = METHOD_OPTION.presentValue(forexOption, SMILE_MULTICURVES);
    assertEquals("Forex vanilla option: present value", priceExpected, priceComputed.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueCallPut() {
    ...
    final MultiCurrencyAmount pvCallEURUSD = METHOD_OPTION.presentValue(callEURUSD, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvPutUSDEUR = METHOD_OPTION.presentValue(putUSDEUR, SMILE_MULTICURVES);
    assertEquals("Forex vanilla option: present value Method vs Calculator", pvCallEURUSD.getAmount(USD).getAmount() / SPOT, pvPutUSDEUR.getAmount(EUR).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueMethodVsCalculator() {
    ...
    final ForexOptionVanillaDefinition forexOptionDefinition = new ForexOptionVanillaDefinition(forexUnderlyingDefinition, expDate, isCall, isLong);
    final ForexOptionVanilla forexOption = forexOptionDefinition.toDerivative(REFERENCE_DATE);
    final MultiCurrencyAmount pvMethod = METHOD_OPTION.presentValue(forexOption, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = forexOption.accept(PVFBC, SMILE_MULTICURVES);
    assertEquals("Forex vanilla option: present value Method vs Calculator", pvMethod.getAmount(USD).getAmount(), pvCalculator.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void presentValueLongShort() {
    ...
    final MultiCurrencyAmount pvShort = METHOD_OPTION.presentValue(forexOptionShort, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvLong = METHOD_OPTION.presentValue(FOREX_CALL_OPTION, SMILE_MULTICURVES);
    assertThat(pvShort.getAmount(USD)).isEqualTo(pvLong.getAmount(USD).negated(), TOL_PV);

    final MultiCurrencyAmount ceShort = METHOD_OPTION.currencyExposure(forexOptionShort, SMILE_MULTICURVES);
    final MultiCurrencyAmount ceLong = METHOD_OPTION.currencyExposure(FOREX_CALL_OPTION, SMILE_MULTICURVES);
    assertThat(ceShort.getAmount(USD)).isEqualTo(ceLong.getAmount(USD).negated(), TOL_PV);
    assertThat(ceShort.getAmount(EUR)).isEqualTo(ceLong.getAmount(EUR).negated(), TOL_PV);
  }
  ...
  public void currencyExposure() {
    ...
    final MultiCurrencyAmount priceComputedCall = METHOD_OPTION.presentValue(forexOptionCall, SMILE_MULTICURVES);
    final MultiCurrencyAmount priceComputedPut = METHOD_OPTION.presentValue(forexOptionPut, SMILE_MULTICURVES);
    final MultiCurrencyAmount currencyExposureCallComputed = METHOD_OPTION.currencyExposure(forexOptionCall, SMILE_MULTICURVES);
    assertEquals("Forex vanilla option: currency exposure foreign - call", deltaSpotCall * notional, currencyExposureCallComputed.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Forex vanilla option: currency exposure domestic - call", -deltaSpotCall * notional * SPOT + priceComputedCall.getAmount(USD).getAmount(),
        currencyExposureCallComputed.getAmount(USD).getAmount(), 1E-2);
    final MultiCurrencyAmount currencyExposurePutComputed = METHOD_OPTION.currencyExposure(forexOptionPut, SMILE_MULTICURVES);
    assertEquals("Forex vanilla option: currency exposure foreign- put", deltaSpotPut * notional, currencyExposurePutComputed.getAmount(EUR).getAmount(), TOLERANCE_PV);
    assertEquals("Forex vanilla option: currency exposure domestic - put", -deltaSpotPut * notional * SPOT + priceComputedPut.getAmount(USD).getAmount(),
        currencyExposurePutComputed.getAmount(USD).getAmount(), 1E-2);
  }
  ...
  public void currencyExposureVsPresentValue() {
    final MultiCurrencyAmount pv = METHOD_OPTION.presentValue(FOREX_CALL_OPTION, SMILE_MULTICURVES);
    final MultiCurrencyAmount ce = METHOD_OPTION.currencyExposure(FOREX_CALL_OPTION, SMILE_MULTICURVES);
    assertEquals(
  ...
  public void currencyExposureCallPut() {
    ...
    final ForexOptionVanilla callEURUSD = callEURUSDDefinition.toDerivative(REFERENCE_DATE);
    final ForexOptionVanilla putUSDEUR = putUSDEURDefinition.toDerivative(REFERENCE_DATE);
    final MultiCurrencyAmount pvCallEURUSD = METHOD_OPTION.currencyExposure(callEURUSD, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvPutUSDEUR = METHOD_OPTION.currencyExposure(putUSDEUR, SMILE_MULTICURVES);
    assertThat(pvPutUSDEUR.getAmount(EUR)).isEqualTo(pvCallEURUSD.getAmount(EUR), TOL_PV);
    assertThat(pvPutUSDEUR.getAmount(USD)).isEqualTo(pvCallEURUSD.getAmount(USD), TOL_PV);
  }
  ...
  public void currencyExposurePutCallParity() {
    ...
    final MultiCurrencyAmount currencyExposureCall = METHOD_OPTION.currencyExposure(forexOptionCall, SMILE_MULTICURVES);
    final MultiCurrencyAmount currencyExposurePut = METHOD_OPTION.currencyExposure(forexOptionPut, SMILE_MULTICURVES);
    final MultiCurrencyAmount currencyExposureForward = METHOD_DISC.currencyExposure(forexForward, MULTICURVES);

    assertThat(currencyExposureCall.getAmount(EUR).minus(currencyExposurePut.getAmount(EUR)))
        .isEqualTo(currencyExposureForward.getAmount(EUR), TOL_PV);

    assertThat(currencyExposureCall.getAmount(USD).minus(currencyExposurePut.getAmount(USD)))
        .isEqualTo(currencyExposureForward.getAmount(USD), TOL_PV);
  }
  ...
  public void currencyExposureMethodVsCalculator() {
    ...
    final ForexOptionVanillaDefinition forexOptionDefinition = new ForexOptionVanillaDefinition(forexUnderlyingDefinition, expDate, isCall, isLong);
    final ForexOptionVanilla forexOption = forexOptionDefinition.toDerivative(REFERENCE_DATE);
    final MultiCurrencyAmount ceMethod = METHOD_OPTION.currencyExposure(forexOption, SMILE_MULTICURVES);
    final MultiCurrencyAmount ceCalculator = forexOption.accept(CEFBC, SMILE_MULTICURVES);

    assertThat(ceCalculator.getAmount(EUR)).isEqualTo(ceCalculator.getAmount(EUR), TOL_PV);

    assertThat(ceCalculator.getAmount(USD)).isEqualTo(ceCalculator.getAmount(USD), TOL_PV);
  }
  ...
  public void deltaRelativeDirect() {
    ...
    final ForexOptionVanillaDefinition forexOptionDefinition = new ForexOptionVanillaDefinition(forexUnderlyingDefinition, expDate, isCall, isLong);
    final ForexOptionVanilla forexOption = forexOptionDefinition.toDerivative(REFERENCE_DATE);
    final MultiCurrencyAmount ce = METHOD_OPTION.currencyExposure(forexOption, SMILE_MULTICURVES);
    final double delta = METHOD_OPTION.deltaRelative(forexOption, SMILE_MULTICURVES, true);
    assertEquals("Forex: relative delta", ce.getAmount(EUR).getAmount(), delta, TOLERANCE_RELATIVE);
    final MultiCurrencyAmount pvM = METHOD_OPTION.presentValue(forexOption, SMILE_M_MULTICURVES);
    final MultiCurrencyAmount pvP = METHOD_OPTION.presentValue(forexOption, SMILE_P_MULTICURVES);
    final double deltaFlat = METHOD_OPTION.deltaRelative(forexOption, SMILE_FLAT_MULTICURVES, true);
    assertEquals("Forex: relative delta", (pvP.getAmount(USD).getAmount() - pvM.getAmount(USD).getAmount()) / (2 * SHIFT), deltaFlat, TOLERANCE_RELATIVE);
  }
  ...
  public void deltaRelativeReverse() {
    ...
    assertEquals("Forex: relative gamma", (pvP.getAmount(EUR).getAmount() - pvM.getAmount(EUR).getAmount()) / (2 * SHIFT), delta, TOLERANCE_RELATIVE);
  }
  ...
  public void deltaRelativeSpotDirect() {
    ...
    assertEquals(
        ...
        (pvP.getAmount(USD).getAmount() - pvM.getAmount(USD).getAmount()) / (2 * SHIFT) * FX_MATRIX.getRate(EUR, USD),
        deltaFlat,
        TOLERANCE_RELATIVE);
  }
  ...
  public void deltaRelativeSpotReverse() {
    ...
    assertEquals(
        "Forex: relative gamma",
        (pvP.getAmount(EUR).getAmount() - pvM.getAmount(EUR).getAmount()) / (2 * SHIFT / SPOT),
        delta,
        TOLERANCE_RELATIVE);
  }
  ...
  public void gammaRelativeDirect() {
    ...
    final ForexOptionVanillaDefinition forexOptionDefinition = new ForexOptionVanillaDefinition(forexUnderlyingDefinition, expDate, isCall, isLong);
    final ForexOptionVanilla forexOption = forexOptionDefinition.toDerivative(REFERENCE_DATE);
    final MultiCurrencyAmount pv = METHOD_OPTION.presentValue(forexOption, SMILE_FLAT_MULTICURVES);
    final MultiCurrencyAmount pvM = METHOD_OPTION.presentValue(forexOption, SMILE_M_MULTICURVES);
    final MultiCurrencyAmount pvP = METHOD_OPTION.presentValue(forexOption, SMILE_P_MULTICURVES);
    ...
    assertEquals(
        "Forex: relative gamma",
        1.0,
        (pvP.getAmount(USD).getAmount() + pvM.getAmount(USD).getAmount() - 2 * pv.getAmount(USD).getAmount()) / (SHIFT * SHIFT) / gamma,
        2.0E-4);
  }
  ...
  public void gammaRelativeReverse() {
    ...
    assertEquals("Forex: relative gamma",
        1.0,
        (pvP.getAmount(EUR).getAmount() + pvM.getAmount(EUR).getAmount() - 2 * pv.getAmount(EUR).getAmount()) / (SHIFT * SHIFT) / gamma,
        1.0E-4);
  }
