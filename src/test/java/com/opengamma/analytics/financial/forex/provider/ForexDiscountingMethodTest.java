...
public class ForexDiscountingMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pv = METHOD_FX.presentValue(FX, MULTICURVES);
    final MultiCurrencyAmount ca1 = METHOD_PAY.presentValue(PAY_1, MULTICURVES);
    final MultiCurrencyAmount ca2 = METHOD_PAY.presentValue(PAY_2, MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_FX.presentValue(FX, MULTICURVES);
    final MultiCurrencyAmount pvCalculator = FX.accept(PVDC, MULTICURVES);
  ...
  public void presentValueReverse() {
    ...
    final MultiCurrencyAmount pv = METHOD_FX.presentValue(FX, MULTICURVES);
    final MultiCurrencyAmount pvReverse = METHOD_FX.presentValue(fxReverse, MULTICURVES);
    assertEquals("Forex present value: Reverse description", pv.getAmount(CUR_1).getAmount(), pvReverse.getAmount(CUR_1).getAmount(), TOLERANCE_PV);
    assertEquals("Forex present value: Reverse description", pv.getAmount(CUR_2).getAmount(), pvReverse.getAmount(CUR_2).getAmount(), TOLERANCE_PV);
  }
  ...
  public void currencyExposure() {
    final MultiCurrencyAmount exposureMethod = METHOD_FX.currencyExposure(FX, MULTICURVES);
    final MultiCurrencyAmount pv = METHOD_FX.presentValue(FX, MULTICURVES);
    assertEquals("Currency exposure", pv, exposureMethod);
    final MultiCurrencyAmount exposureCalculator = FX.accept(CEDC, MULTICURVES);
  ...
  public void parSpread() {
    ...
    final MultiCurrencyAmount pv0 = fx0.accept(PVDC, MULTICURVES);
  ...
  public void forexTodayPaymentBeforePayment() {
    ...
    assertEquals("TodayPaymentCalculator: forex", 0.0, cash.getAmount(fx.getCurrency1()).getAmount(), TOLERANCE_PV);
    assertEquals("TodayPaymentCalculator: forex", 0.0, cash.getAmount(fx.getCurrency2()).getAmount(), TOLERANCE_PV);
  ...
  public void forexTodayPaymentOnPayment() {
    ...
    final MultiCurrencyAmount cash = fx.accept(TPC);
    assertEquals("TodayPaymentCalculator: forex", FX_DEFINITION.getPaymentCurrency1().getReferenceAmount(), cash.getAmount(fx.getCurrency1()).getAmount(), TOLERANCE_PV);
    assertEquals("TodayPaymentCalculator: forex", FX_DEFINITION.getPaymentCurrency2().getReferenceAmount(), cash.getAmount(fx.getCurrency2()).getAmount(), TOLERANCE_PV);
    assertEquals("TodayPaymentCalculator: forex", 2, cash.size());
  }
