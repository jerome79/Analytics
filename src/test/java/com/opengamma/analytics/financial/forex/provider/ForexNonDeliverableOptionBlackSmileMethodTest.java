...
public class ForexNonDeliverableOptionBlackSmileMethodTest {
  ...
  public void presentValue() {
    final MultiCurrencyAmount pvNDO = METHOD_NDO.presentValue(NDO, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvFXO = METHOD_FXO.presentValue(FOREX_OPT, SMILE_MULTICURVES);
  ...
  public void presentValueMethodVsCalculator() {
    final MultiCurrencyAmount pvMethod = METHOD_NDO.presentValue(NDO, SMILE_MULTICURVES);
    final MultiCurrencyAmount pvCalculator = NDO.accept(PVFBC, SMILE_MULTICURVES);
  ...
  public void currencyExposureVsPresentValue() {
    final MultiCurrencyAmount pv = METHOD_NDO.presentValue(NDO, SMILE_MULTICURVES);
    final MultiCurrencyAmount ce = METHOD_NDO.currencyExposure(NDO, SMILE_MULTICURVES);
    final double usdKrw = MULTICURVES.getFxRate(USD, KRW);
    assertEquals("Forex vanilla option: currency exposure vs present value",
        ce.getAmount(USD).getAmount() + ce.getAmount(KRW).getAmount() / usdKrw, pv.getAmount(USD).getAmount(), TOLERANCE_PV);
  }
  ...
  public void currencyExposureMethodVsCalculator() {
    final MultiCurrencyAmount ceMethod = METHOD_NDO.currencyExposure(NDO, SMILE_MULTICURVES);
    final MultiCurrencyAmount ceCalculator = NDO.accept(CEFBC, SMILE_MULTICURVES);
