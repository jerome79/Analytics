...
public class SwaptionPhysicalFixedIborDefinitionTest {
  ...
  public void testToDerivative() {
    ...
    SwaptionPhysicalFixedIbor convertedSwaption = SWAPTION.toDerivative(REFERENCE_DATE);
  ...
  public void equalHash() {
    ...
    SwaptionPhysicalFixedIborDefinition other = SwaptionPhysicalFixedIborDefinition.from(EXPIRY_DATE, SWAP, true, IS_LONG);
    ...
    SwaptionPhysicalFixedIborDefinition modifiedSwaption =
        SwaptionPhysicalFixedIborDefinition.from(EXPIRY_DATE, SWAP, true, !IS_LONG);
    ...
    final SwapFixedIborDefinition otherSwap = SwapFixedIborDefinition.from(
        SETTLEMENT_DATE, cmsIndex, 2 * NOTIONAL, RATE, FIXED_IS_PAYER, CALENDAR);
