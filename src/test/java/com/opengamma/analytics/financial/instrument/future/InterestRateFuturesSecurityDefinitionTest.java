...
public class InterestRateFuturesSecurityDefinitionTest {
  ...
  public void getter() {
    ...
    assertEquals(DayCountUtils.yearFraction(IBOR_INDEX.getDayCount(), SPOT_LAST_TRADING_DATE, FIXING_END_DATE), ERU2_DEFINITION.getFixingPeriodAccrualFactor());
  ...
  public void toDerivative() {
    ...
    final double FIXING_ACCRUAL = DayCountUtils.yearFraction(IBOR_INDEX.getDayCount(), SPOT_LAST_TRADING_DATE, FIXING_END_DATE);
