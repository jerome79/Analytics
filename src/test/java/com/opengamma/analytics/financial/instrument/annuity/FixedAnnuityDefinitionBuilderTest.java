...
public class FixedAnnuityDefinitionBuilderTest {
  ...
  public void ConsistencyGeneratorTest() {
    ...
    double ref = swapGnr.accept(pvCalculator, mCurvesOIS).getAmount(USD).getAmount();
    assertEquals(ref, swapBld.accept(pvCalculator, mCurvesOIS).getAmount(USD).getAmount(), Math.abs(ref) * 1.0e-10);
  }
