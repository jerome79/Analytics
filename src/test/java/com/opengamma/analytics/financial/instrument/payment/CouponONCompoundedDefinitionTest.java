...
public class CouponONCompoundedDefinitionTest {
  ...
  private static final double EUR_PAYMENT_YEAR_FRACTION = DayCountUtils.yearFraction(EUR_DAY_COUNT, START_ACCRUAL_DATE, EUR_END_ACCRUAL_DATE, EUR_CALENDAR);
  private static final double NOTIONAL = 100000000;
  private static final double EUR_FIXING_YEAR_FRACTION = DayCountUtils.yearFraction(EUR_DAY_COUNT, START_ACCRUAL_DATE, EUR_END_ACCRUAL_DATE, EUR_CALENDAR);
  ...
  public void toDerivativeNoFixing() {
    ...
    final double paymentTime = DayCountUtils.yearFraction(EUR_DAY_COUNT, TRADE_DATE, EUR_PAYMENT_DATE, EUR_CALENDAR);
