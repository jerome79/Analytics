...
public class FloatingPayCashFlowVisitorTest {
  ...
  public void testIborDeposit() {
    final Map<LocalDate, MultiCurrencyAmount> payment = PAY_IBOR_DEPOSIT.accept(VISITOR);
  ...
  public void testIborCoupon() {
    Map<LocalDate, MultiCurrencyAmount> payment = PAY_IBOR_COUPON.accept(VISITOR);
    assertEquals(1, payment.size());
  ...
  public void testIborIborSwap() {
    Map<LocalDate, MultiCurrencyAmount> payments = new TreeMap<>(PAY_SPREAD_IBOR_IBOR_SWAP.accept(VISITOR));
