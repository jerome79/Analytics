...
public class DeltaGammaCovarianceMatrixFisherKurtosisCalculatorTest {
  ...
  public void testGammaMatrixSize() {
    ParametricVaRDataBundle delta = new ParametricVaRDataBundle(DELTA_VECTOR, COVARIANCE_MATRIX, 1);
    ParametricVaRDataBundle gamma = new ParametricVaRDataBundle(
        new DoubleMatrix2D(new double[][] {new double[] {1, 2, 3}, new double[] {4, 5, 6}, new double[] {7, 8, 9}}),
        new DoubleMatrix2D(new double[][] {new double[] {1, 2, 3}, new double[] {4, 5, 6}, new double[] {7, 8, 9}}),
        2);
  ...
  public void test() {
    ParametricVaRDataBundle delta = new ParametricVaRDataBundle(DELTA_VECTOR, COVARIANCE_MATRIX, 1);
    ParametricVaRDataBundle gamma = new ParametricVaRDataBundle(GAMMA_MATRIX, COVARIANCE_MATRIX, 1);
    Map<Integer, ParametricVaRDataBundle> m = new HashMap<>();
    m.put(1, delta);
    m.put(2, gamma);
