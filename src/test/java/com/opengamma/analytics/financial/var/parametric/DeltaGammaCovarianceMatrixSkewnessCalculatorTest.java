...
public class DeltaGammaCovarianceMatrixSkewnessCalculatorTest {
  ...
  public void testGammaMatrixSize() {
    ...
    ParametricVaRDataBundle gammaData = new ParametricVaRDataBundle(
  ...
  public void testNoGamma() {
    ...
    ParametricVaRDataBundle gammaData = new ParametricVaRDataBundle(
        new DoubleMatrix2D(new double[0][0]), new DoubleMatrix2D(new double[0][0]), 2);
    m.put(2, gammaData);
    assertEquals(F.evaluate(m), 0, 0);
  }
  ...
  public void test() {
    ParametricVaRDataBundle deltaData = new ParametricVaRDataBundle(DELTA_VECTOR, COVARIANCE_MATRIX, 1);
    ParametricVaRDataBundle gammaData = new ParametricVaRDataBundle(GAMMA_MATRIX, COVARIANCE_MATRIX, 1);
    Map<Integer, ParametricVaRDataBundle> m = new HashMap<>();
    m.put(1, deltaData);
    m.put(2, gammaData);
