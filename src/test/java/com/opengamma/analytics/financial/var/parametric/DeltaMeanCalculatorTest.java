...
public class DeltaMeanCalculatorTest {
  ...
  private static final DeltaMeanCalculator F = new DeltaMeanCalculator();
  ...
  public void testEmptyValueDeltaVector() {
    ParametricVaRDataBundle data = new ParametricVaRDataBundle(null, null, EMPTY_VECTOR, EMPTY_MATRIX, 1);
