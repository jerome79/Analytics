...
public class CDSIndexE2ETest extends ISDABaseTest {
  ...
  private static final ISDACompliantCreditCurve[] CREDIT_CURVES = CDSIndexPrvider.buildCreditCurves(TRADE_DATE,
      CDSIndexPrvider.CDX_NA_HY_20140213_PAR_SPREADS, RECOVERY_RATES, CDSIndexPrvider.CDS_TENORS, ISDA_USD_20140213);
  ...
  private static final CDSAnalytic[] CDX = FACTORY.makeCDX(TRADE_DATE, CDSIndexPrvider.INDEX_TENORS);
