...
public abstract class ISDAModelDatasets {
  ...
  public static ISDA_Results[] getExample1() {
    ...
    ArgChecker.isTrue(nSets == today.length, "today");
    ArgChecker.isTrue(nSets == curveInstrumentsStartDate.length, "curveInstrumentsStartDate");
    ArgChecker.isTrue(nSets == q.length, "q");
    ArgChecker.isTrue(nCurvePoints == q[0].length, "q");
    ArgChecker.isTrue(nSets == cdsStartDate.length, "cdsStartDate");
    ArgChecker.isTrue(nSets == cdsEndDate.length, "cdsEndDate");
    ArgChecker.isTrue(nSets == spreadBP.length, "spreadBP");
    ArgChecker.isTrue(nSets == premLeg.length, "premLeg");
    ArgChecker.isTrue(nSets == protectionLeg.length, "protectionLeg");
    ArgChecker.isTrue(nSets == defaultAcc.length, "defaultAcc");
    ArgChecker.isTrue(nSets == accruedPrem.length, "accruedPrem");
    ArgChecker.isTrue(nSets == accruedDays.length, "accruedDays");
