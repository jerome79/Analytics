...
public class CDXNAHYTest extends ISDABaseTest {
  ...
  private static final ISDACompliantCreditCurve[] CREDIT_CURVES = CDSIndexPrvider.getCDX_NA_HY_20140213_CreditCurves();
  private static final double[] RECOVERY_RATES = CDSIndexPrvider.CDX_NA_HY_20140213_RECOVERY_RATES;
  ...
  private static double[] PRICES = CDSIndexPrvider.CDX_NA_HY_20140213_PRICES;
  ...
  private static final CDSAnalytic[] PILLAR_CDX = FACTORY.makeCDX(TRADE_DATE, CDSIndexPrvider.INDEX_TENORS);
