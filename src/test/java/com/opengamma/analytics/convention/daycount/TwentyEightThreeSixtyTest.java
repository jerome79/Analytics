...
public class TwentyEightThreeSixtyTest extends DayCountTestCase {
  ...
  public void test() {
    ...
    assertEquals(28. / 360, DC.yearFraction(d1, d3), 0);
    assertEquals(54. / 360, DC.yearFraction(d1, d4), 0);
    assertEquals(1 + 28. / 360, DC.yearFraction(d1, d5), 0);
    assertEquals(1 + 54. / 360, DC.yearFraction(d1, d6), 0);
    assertEquals(28. / 360, DC.yearFraction(d7, d2), 0);
    assertEquals(30. / 360, DC.yearFraction(d7, d3), 0);
    assertEquals(56. / 360, DC.yearFraction(d7, d4), 0);
    assertEquals(1 + 30. / 360, DC.yearFraction(d7, d5), 0);
    assertEquals(1 + 56. / 360, DC.yearFraction(d7, d6), 0);
    assertEquals(26. / 360, DC.yearFraction(d1, d8), 0);
    assertEquals(28. / 360, DC.yearFraction(d7, d8), 0);
    assertEquals(54. / 360, DC.yearFraction(d1, d9), 0);
    assertEquals(56. / 360, DC.yearFraction(d7, d9), 0);
    assertEquals(1 + 54. / 360, DC.yearFraction(d1, d10), 0);
    assertEquals(1 + 56. / 360, DC.yearFraction(d7, d10), 0);
    assertEquals(140. / 360, DC.yearFraction(d10, d11), 0);
  }
}
