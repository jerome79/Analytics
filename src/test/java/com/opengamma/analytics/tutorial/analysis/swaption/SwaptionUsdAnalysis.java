...
public class SwaptionUsdAnalysis {
  ...
  public void swaptionStandard() {
    ...
    // Present value
    MultiCurrencyAmount pvIrs1Std = IRS_R_1.accept(PVDC, MULTICURVE_STD);
    MultiCurrencyAmount pvSwpt1StdSabr = SWPT_R_L_1.accept(PVSSC, MULTICURVE_STD_SABR);
    MultiCurrencyAmount pvSwpt1StdNorm = SWPT_R_L_1.accept(PVNSC, MULTICURVE_STD_NORMAL);
    // Bucketed PV01
  ...
  public void swaptionNegativeStrike() {
    ...
    // Present value
    MultiCurrencyAmount pvIrs2Neg = IRS_R_2.accept(PVDC, MULTICURVE_NEG);
    MultiCurrencyAmount pvSwpt2NegNorm = SWPT_R_L_2.accept(PVNSC, MULTICURVE_NEG_NORMAL);
    // Bucketed PV01
