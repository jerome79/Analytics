...
public class SwapUsdAnalysis {
  ...
  public void presentValue() {
    ...
    MultiCurrencyAmount pvSwap1Std = IRS_1.accept(PVDC, MULTICURVE_STD);
    assertTrue("SwapRiskUsdAnalysis: present value", pvFixed.getAmount(USD).getAmount() * pvIbor.getAmount(USD).getAmount() < 0);
    assertEquals("SwapRiskUsdAnalysis: present value", pvSwap1Std.getAmount(USD).getAmount(), pvFixed.getAmount(USD).getAmount() + pvIbor.getAmount(USD).getAmount(), TOLERANCE_PV);
    MultiCurrencyAmount pvSwap1Fut = IRS_1.accept(PVDC, MULTICURVE_FUT);
    MultiCurrencyAmount pvSwap1Imm = IRS_1.accept(PVDC, MULTICURVE_IMM);
    assertEquals("SwapRiskUsdAnalysis: present value", pvSwap1Fut.getAmount(USD).getAmount(), pvSwap1Imm.getAmount(USD).getAmount(), TOLERANCE_PV_2);
    MultiCurrencyAmount pvSwap1Std2 = IRS_1.accept(PVDC, MULTICURVE_STD_2);
    assertEquals("SwapRiskUsdAnalysis: present value", pvSwap1Fut.getAmount(USD).getAmount(), pvSwap1Std2.getAmount(USD).getAmount(), TOLERANCE_PV_2);
    MultiCurrencyAmount pvSwap1Ffs2 = IRS_1.accept(PVDC, MULTICURVE_FFS_2);
